...
def run_optimizer():
    ...
    bds = np.array([
        # habitat parameters
        [0.1,0.3],[0.1,0.3],[0.7,0.9],[0.0003,0.0009],[0.003,0.009],[0.1,1],[0.1,1],[0.1,1],[0.1,1],[0.1,1],[0.1,1],[0.1,1],
        # roe deer parameters
        [0.05,0.25],[0.4,1],[0.1,1],[0.1,1],[0.1,1],[0.1,1],
        # fallow deer parameters
        [0.2,0.35],[0.7,1],[0.1,1],[0.1,1],[0.1,1],[0.1,1],
        # red deer parameters
        [0.15,0.35],[0.5,1],[0.1,1],[0.1,1],[0.1,1],[0.1,1],
