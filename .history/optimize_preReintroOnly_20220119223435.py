...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.075,0.15],[0.09,0.15],[0.071,0.072],[0.0015,0.006],[0.004,0.08],
        # habitat competition
        [0.015,0.025], # mature scrub
        [0.22,0.24],[0.2,0.21], # grass
        [0.25,0.85],[0.25,0.4], # saplings
        [0.2,0.4],[0.25,0.85], # young scrub  
        # roe deer parameters
        [0.17,0.22],[0.12,0.2],[0.12,0.2],[0.12,0.2],[0.075,0.15],[0.075,0.15]
    ])
