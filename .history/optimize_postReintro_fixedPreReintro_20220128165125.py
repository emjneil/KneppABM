...
def run_optimizer():
    ...
    bds = np.array([
        ...
        # red deer parameters
        [0.33,0.45],[0.45,0.5],[0.55,0.7],[0.55,0.7],[0.075,0.1],[0.075,0.1],
        # exmoor pony parameters
        [0.4,0.5],[0.3,0.6],[0.3,0.6],[0.05,0.1],[0.05,0.1],
        # cattle parameters
        [0.15,0.3],[0.25,0.35],[0.25,0.5],[0.25,0.5],[0.025,0.1],[0.025,0.1],
        # # pig parameters
        [0.01,0.2],[0.05,0.25],[0.4,0.75],[0.4,0.75],[0.05,0.15],[0.05,0.15]
    ])
