...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.01,0.05],[0.015,0.05],[0.075,0.1],[0.0025,0.006],[0.0085,0.02],
        [0.015,0.025], # mature scrub competition
        [0.05,0.075],[0.05,0.075], # grass
        [0.035,0.05],[0.025,0.05], # saplings
        [0.025,0.05],[0.035,0.05], # young scrub  
        # roe deer parameters
        [0.15,0.23],[0.5,0.75],[0.35,1],[0.35,1],[0.1,0.25],[0.1,0.25]
    ])

#  The best solution found:
#  [0.01521626 0.04256503 0.09636859 0.00268925 0.01330464 0.01883599
#  0.05280727 0.07358347 0.02588823 0.0392308  0.04240752 0.03589125
#  0.18257617 0.60436609 0.46863453 0.89875075 0.13919574 0.23940169]
