...
def run_optimizer():
    ...
    bds = [
        ...
        (0.015,0.02),(0.035,0.045),(0.075,0.08),(0.002,0.003),(0.01,0.025),
        (0.015,0.02), # mature scrub competition
        (0.085,0.09),(0.085,0.09), # grass
        (0.03,0.05),(0.02,0.04), # saplings
        (0.02,0.04),(0.03,0.05), # young scrub  
        ...
        # red deer parameters
        (0.37,0.42),(0.65,0.7),(0.75,0.8),(0.75,0.8),(0.1,0.16),(0.1,0.16),
