...
# Who's eating what
    ...
    {'Time': final_results['Time'], 'Saplings grown up': final_results['Saplings grown up'], 'Saplings Outcompeted by Trees': final_results['Saplings Outcompeted by Trees'], 'Saplings Outcompeted by Scrub': final_results['Saplings Outcompeted by Scrub'], "Saplings eaten by roe deer": final_results['Saplings eaten by roe deer'],
    "Saplings eaten by Fallow deer": final_results['Saplings eaten by Fallow deer'],
    "Saplings eaten by Exmoor pony": final_results['Saplings eaten by Exmoor pony'], 
    "Saplings eaten by longhorn cattle": final_results['Saplings eaten by longhorn cattle'], 
    "Saplings eaten by red deer": final_results['Saplings eaten by red deer'], 
    "Saplings eaten by pigs": final_results['Saplings eaten by pigs']})
