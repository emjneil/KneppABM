...
def run_optimizer():
    ...
    bds = [
        ...
        (0.015,0.016),(0.055,0.056),(0.084,0.085),(0.0021,0.0022),(0.011,0.012),
        (0.0087,0.0094), # mature scrub competition
        (0.17,0.175),(0.17,0.175), # grass
        (0.065,0.07),(0.021,0.025), # saplings
        (0.065,0.07),(0.068,0.07), # young scrub  
        # roe deer parameters
        (0.18,0.2),(0.91,0.92),(0.86,0.94),(0.86,0.94),(0.13,0.14),(0.11,0.12),
        # fallow deer parameters
        (0.3,0.31),(0.91,0.93),(0.89,0.93),(0.86,0.93),(0.1,0.12),(0.08,0.11),
        # red deer parameters
        (0.35,0.37),(0.91,0.93),(0.89,0.93),(0.86,0.93),(0.1,0.12),(0.08,0.11),
        # exmoor pony parameters
        (0.9,0.92),(0.88,0.92),(0.86,0.92),(0.07,0.12),(0.07,0.1),
        # cattle parameters
        (0.19,0.22),(0.89,0.91),(0.88,0.92),(0.86,0.92),(0.07,0.1),(0.06,0.1),
        # pig parameters
