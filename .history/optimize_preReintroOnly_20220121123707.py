...
def graph_results():
 ...
 # stacked_competition = np.tile([ "Eaten Grass", "Eaten Trees", "Eaten Mature Scrub", "Eaten Saplings", "Eaten Young Scrub"], 51) 
    ...
    'Grass Outcompeted by Scrub': outcompeted_grass_byScrub_tiled, 'Young Scrub Outcompeted By Scrub': outcompeted_youngScrub_byScrub_tiled, 'Sapling Outcompeted by Scrub": outcompeted_sapling_byScrub})
