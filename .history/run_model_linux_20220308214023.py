...
def run_all_models():
    ...
    (filtered_Feb2016["Tamworth pigs"] <= 17) & (filtered_Feb2016["Tamworth pigs"] >= 1)]
    ...
    (filtered_March2016["Tamworth pigs"] <= 32) & (filtered_March2016["Tamworth pigs"] >= 12)]
    ...
    (filtered_April2016["Tamworth pigs"] <= 32) & (filtered_April2016["Tamworth pigs"] >= 12)]
    ...
    (filtered_May2016["Tamworth pigs"] <= 32) & (filtered_May2016["Tamworth pigs"] >= 12)]
    ...
    (filtered_June2016["Tamworth pigs"] <= 32) & (filtered_June2016["Tamworth pigs"] >= 12)]
    ...
    (filtered_July2016["Tamworth pigs"] <= 32) & (filtered_July2016["Tamworth pigs"] >= 12)]
    ...
    (filtered_Aug2016["Tamworth pigs"] <= 32) & (filtered_Aug2016["Tamworth pigs"] >= 12)]
    ...
    # # (filtered_Sept2016["Tamworth pigs"] <= 32) & (filtered_Sept2016["Tamworth pigs"] >= 12)]
    ...
    # # (filtered_Oct2016["Tamworth pigs"] <= 32) & (filtered_Oct2016["Tamworth pigs"] >= 12)]
    ...
    # # (filtered_Nov2016["Tamworth pigs"] <= 28) & (filtered_Nov2016["Tamworth pigs"] >= 8)]
    ...
    # # (filtered_Dec2016["Tamworth pigs"] <= 21) & (filtered_Dec2016["Tamworth pigs"] >= 1)]
    ...
    # # (filtered_Jan2017["Tamworth pigs"] <= 26) & (filtered_Jan2017["Tamworth pigs"] >= 6)]
