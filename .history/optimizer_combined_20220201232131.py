...
def run_optimizer():
    ...
    bds = np.array([
        ...
        # roe deer parameters
        [0.17,0.25],[0.7,0.85],[0.7,0.85],[0.7,0.85],[0.1,0.2],[0.1,0.2],

        # fallow deer parameters
        [0.35,0.45],[0.6,0.8],[0.6,0.8],[0.6,0.8],[0.14,0.2],[0.14,0.2],
        # red deer parameters
        [0.28,0.4],[0.55,0.75],[0.55,0.75],[0.55,0.75],[0.1,0.17],[0.1,0.17],
        # exmoor pony parameters
        [0.5,0.7],[0.5,0.7],[0.5,0.7],[0.075,0.15],[0.075,0.15],
        # cattle parameters
        [0.15,0.25],[0.4,0.7],[0.4,0.7],[0.4,0.7],[0.05,0.15],[0.05,0.15],
        # # pig parameters
        [0.05,0.25],[0.1,0.25],[0.65,0.85],[0.65,0.85],[0.05,0.2],[0.05,0.2]
    ])

#  [0.01502485 0.03353585 0.07924582 0.00304796 0.02393424 0.01665647
#  0.08929689 0.08697161 0.04608027 0.03421335 0.04374156 0.03913417
#  0.21187866 0.81813319 0.81860047 0.74942119 0.14698333 0.16544093
#  0.42662249 0.7730078  0.60606365 0.64501771 0.15003335 0.18594763
#  0.30437487 0.60235273 0.62847657 0.67217138 0.16353587 0.14136219
#  0.55565902 0.63469384 0.50910224 0.11152671 0.11761664 0.21491663
#  0.52756555 0.61704659 0.57769878 0.05851599 0.10883026 0.16729108
#  0.14802033 0.60225575 0.83213752 0.11178446 0.14297575]
