...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.35,0.45],[0.4,0.6],[0.5,0.75],[0.5,0.75],[0.08,0.2],[0.08,0.2],
        # red deer parameters
        [0.3,0.4],[0.45,0.6],[0.45,0.65],[0.45,0.65],[0.075,0.15],[0.075,0.15],
        # exmoor pony parameters
        [0.25,0.9],[0.45,1],[0.45,1],[0.05,0.25],[0.05,0.25],
        # cattle parameters
        [0.15,0.4],[0.25,0.9],[0.35,1],[0.35,1],[0.05,0.25],[0.05,0.25],
        # # pig parameters
        [0.05,0.5],[0.05,0.75],[0.55,1],[0.55,1],[0.01,0.25],[0.01,0.25]
    ])
