...
def run_optimizer():
    ...
    bds = [
        ...
        (0.0031,0.0032),(0.0031,0.0032),(0.0135,0.014),(0.0023,0.0024),(0.0086,0.0087),
        (0.0014,0.0015), # mature scrub competition
        (0.094,0.095),(0.093,0.095), # grass
        (0.083,0.085),(0.026,0.03), # saplings
        (0.083,0.087),(0.08,0.085), # young scrub  
        # roe deer parameters
        (0.17,0.22),(0.92,0.94),(0.92,0.94),(0.92,0.94),(0.09,0.1),(0.075,0.09),
        # fallow deer parameters
        (0.305,0.31),(0.88,0.91),(0.89,0.92),(0.89,0.92),(0.08,0.09),(0.06,0.08),
        # red deer parameters
        (0.33,0.38),(0.88,0.91),(0.88,0.92),(0.88,0.92),(0.07,0.09),(0.05,0.08),
        # exmoor pony parameters
        (0.87,0.9),(0.87,0.9),(0.87,0.9),(0.05,0.08),(0.05,0.075),
        # cattle parameters
        (0.18,0.21),(0.86,0.9),(0.86,0.9),(0.86,0.9),(0.05,0.08),(0.05,0.075),
        # pig parameters
        (0.15,0.22),(0.8,0.85),(0.9,0.94),(0.9,0.94),(0.05,0.1),(0.05,0.09)]
...
#   fun: 534.9492117671718
#  message: 'Maximum number of iterations has been exceeded.'
#     nfev: 423
#      nit: 2
#  success: False
#        x: array([0.01904011, 0.05846216, 0.08409305, 0.00211964, 0.01124551,
