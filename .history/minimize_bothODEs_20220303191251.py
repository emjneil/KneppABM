...
def run_optimizer():
    ...
    bds = [
        ...
        (0.38,0.45),(0.85,0.95),(0.85,0.93),(0.85,0.93),(0.05,0.2),(0.05,0.2),
        # red deer parameters
        (0.35,0.4),(0.85,0.95),(0.85,0.93),(0.85,0.93),(0.075,0.2),(0.075,0.2),
    ...
    res = minimize(objectiveFunction, initial_guess, method='Nelder-Mead', bounds=bds, options={'maxiter': 250})
