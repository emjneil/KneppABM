...
class habitatAgent (Agent):
    ...
    def step(self):
        ...
        # chance of tree (100 yrs) or mature scrub (50 yrs, hawthorne = 250; blackthorne 100; blackberry = 40; gorse = 25) dying
        old_trees = np.random.binomial(n=self.edibles["trees"], p=0.008)
        old_scrub = np.random.binomial(n=self.edibles["scrub"], p=0.001)
