...
def run_optimizer():
    ...
    bds = [
        ...
        # roe deer parameters
        (0.18,0.2),(0.9,0.93),(0.87,0.95),(0.87,0.95),(0.13,0.16),(0.12,0.15),
        # fallow deer parameters
        (0.33,0.35),(0.9,0.93),(0.89,0.93),(0.85,0.93),(0.12,0.15),(0.12,0.14),
        # red deer parameters
        (0.37,0.39),(0.9,0.93),(0.89,0.93),(0.85,0.93),(0.12,0.15),(0.12,0.14),
        # exmoor pony parameters
        (0.85,0.9),(0.87,0.92),(0.85,0.92),(0.12,0.14),(0.11,0.13),
        # cattle parameters
        (0.18,0.21),(0.87,0.92),(0.85,0.92),(0.82,0.88),(0.12,0.14),(0.1,0.12),
        # pig parameters
        (0.25,0.3),(0.75,0.8),(0.9,0.95),(0.9,0.95),(0.11,0.16),(0.11,0.16)]
