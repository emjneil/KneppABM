...
def graph_runs():
    ...
    g = sns.FacetGrid(final_df_numbers, col="Ecosystem Element", hue = "runType", palette = colors, col_wrap=4, sharey = False)
    ...
    g = sns.FacetGrid(final_df_numbers, col="Ecosystem Element", palette = colors, col_wrap=4, sharey = False)
