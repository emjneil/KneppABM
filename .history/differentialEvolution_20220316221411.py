...
def run_optimizer():
    ...
    bds = [
        ...
        # roe deer parameters
        (0.16,0.19),(0.93,0.95),(0.91,0.95),(0.91,0.95),(0.12,0.14),(0.1,0.11),
        # fallow deer parameters
        (0.31,0.32),(0.92,0.93),(0.9,0.93),(0.9,0.93),(0.1,0.12),(0.085,0.1),
        # red deer parameters
        (0.355,0.365),(0.91,0.93),(0.9,0.93),(0.9,0.93),(0.1,0.12),(0.085,0.1),
        # exmoor pony parameters
        (0.89,0.92),(0.89,0.92),(0.89,0.92),(0.08,0.12),(0.075,0.085),
        # cattle parameters
        (0.185,0.195),(0.89,0.92),(0.89,0.92),(0.89,0.92),(0.08,0.12),(0.075,0.085),
        # pig parameters
        (0.29,0.31),(0.86,0.88),(0.9,0.95),(0.9,0.95),(0.1,0.13),(0.06,0.1)]
