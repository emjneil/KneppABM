...
def run_optimizer():
    ...
    bds = [
        ...
        (0.013,0.017),(0.04,0.045),(0.073,0.076),(0.003,0.0035),(0.013,0.016),
        (0.01,0.016), # mature scrub competition
        (0.085,0.087),(0.085,0.087), # grass
        (0.045,0.05),(0.033,0.036), # saplings
        (0.033,0.05),(0.033,0.05), # young scrub  

0.18138512, 0.59043987, 0.70348958, 0.74483019,
#        0.10452791, 0.10536622])

        # roe deer parameters
        (0.17,0.21),(0.75,0.8),(0.8,0.83),(0.8,0.83),(0.14,0.17),(0.14,0.17),
        # fallow deer parameters
        (0.4,0.47),(0.7,0.73),(0.75,0.78),(0.75,0.78),(0.1,0.16),(0.1,0.16),
        # red deer parameters

        (0.4,0.47),(0.68,0.7),(0.75,0.78),(0.75,0.78),(0.1,0.16),(0.1,0.16),
        # exmoor pony parameters
        (0.63,0.68),(0.73,0.75),(0.73,0.75),(0.1,0.15),(0.1,0.15),
        # cattle parameters
        (0.22,0.24),(0.62,0.65),(0.72,0.75),(0.72,0.75),(0.1,0.14),(0.1,0.14),
        # # pig parameters
        (0.15,0.2),(0.5,0.6),(0.75,0.83),(0.75,0.83),(0.1,0.14),(0.1,0.14)]
