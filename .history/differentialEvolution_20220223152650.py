...
def run_optimizer():
    ...
    bds = [
        ...
        (0.01,0.012),(0.038,0.043),(0.075,0.076),(0.0025,0.003),(0.014,0.017),
        (0.013,0.017), # mature scrub competition
        (0.17,0.18),(0.17,0.18), # grass
        (0.04,0.06),(0.025,0.03), # saplings
        (0.03,0.06),(0.04,0.06), # young scrub  
        # roe deer parameters
        (0.17,0.19),(0.9,0.91),(0.9,0.91),(0.9,0.91),(0.13,0.15),(0.13,0.15),
        # fallow deer parameters
        (0.25,0.35),(0.85,0.9),(0.85,0.9),(0.85,0.9),(0.13,0.14),(0.13,0.14),
        # red deer parameters
        (0.38,0.41),(0.87,0.9),(0.87,0.9),(0.87,0.9),(0.13,0.14),(0.13,0.14),
        # exmoor pony parameters
        (0.83,0.88),(0.83,0.9),(0.83,0.9),(0.13,0.14),(0.13,0.14),
        # cattle parameters
        (0.17,0.22),(0.83,0.85),(0.83,0.85),(0.83,0.85),(0.12,0.13),(0.12,0.13),
        # pig parameters
        (0.18,0.4),(0.7,0.8),(0.87,0.95),(0.87,0.95),(0.11,0.15),(0.11,0.15)]
