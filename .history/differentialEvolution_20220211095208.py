...
def run_optimizer():
    ...
    bds = [
        ...
        (0.01,0.015),(0.04,0.044),(0.075,0.08),(0.0023,0.0025),(0.013,0.016),
        (0.015,0.02), # mature scrub competition
        (0.085,0.09),(0.085,0.09), # grass
        (0.045,0.05),(0.02,0.025), # saplings
        (0.02,0.025),(0.045,0.05), # young scrub  

        # roe deer parameters
        (0.17,0.21),(0.75,0.8),(0.8,0.83),(0.8,0.83),(0.14,0.17),(0.14,0.17),
        # fallow deer parameters
        (0.37,0.43),(0.7,0.75),(0.75,0.8),(0.75,0.8),(0.1,0.16),(0.1,0.16),
        # red deer parameters
        (0.37,0.42),(0.68,0.73),(0.75,0.8),(0.75,0.8),(0.1,0.16),(0.1,0.16),
        # exmoor pony parameters
        (0.63,0.68),(0.7,0.75),(0.7,0.75),(0.1,0.15),(0.1,0.15),
        # cattle parameters
        (0.2,0.24),(0.6,0.65),(0.7,0.75),(0.7,0.75),(0.1,0.14),(0.1,0.14),
        # # pig parameters
        (0.15,0.3),(0.5,0.6),(0.7,0.8),(0.7,0.8),(0.1,0.16),(0.1,0.16)]
