...
def run_all_models():
    ...
    for _ in range(number_simulations):
        ...
        # Red deer
        redDeer_reproduce = random.uniform(0.11656884-(0.11656884*perc_aboveBelow), 0.11656884+(0.11656884*perc_aboveBelow))
        0.39482522
        redDeer_gain_from_grass = random.uniform(0.11656884-(0.11656884*perc_aboveBelow), 0.11656884+(0.11656884*perc_aboveBelow))
         0.92850426
        redDeer_gain_from_Trees = random.uniform(0.11656884-(0.11656884*perc_aboveBelow), 0.11656884+(0.11656884*perc_aboveBelow))
        0.92358395
        redDeer_gain_from_Scrub = random.uniform(0.11656884-(0.11656884*perc_aboveBelow), 0.11656884+(0.11656884*perc_aboveBelow))
        0.91620809
        redDeer_gain_from_Saplings = random.uniform(0.11656884-(0.11656884*perc_aboveBelow), 0.11656884+(0.11656884*perc_aboveBelow))
        0.11779972
        redDeer_gain_from_YoungScrub = random.uniform(0.11656884-(0.11656884*perc_aboveBelow), 0.11656884+(0.11656884*perc_aboveBelow))
        0.09440902
        # Exmoor ponies
