...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.25,0.45],[0.45,0.75],[0.75,0.8],[0.75,0.8],[0.08,0.17],[0.08,0.17],
        # red deer parameters
        [0.25,0.45],[0.45,0.75],[0.7,0.8],[0.7,0.8],[0.075,0.15],[0.075,0.15],
        # exmoor pony parameters
        [0.4,0.7],[0.55,0.8],[0.55,0.8],[0.05,0.14],[0.05,0.14],
        # cattle parameters
        [0.15,0.3],[0.25,0.7],[0.55,0.75],[0.55,0.75],[0.05,0.14],[0.05,0.14],
        # # pig parameters
        [0.1,0.75],[0.1,0.6],[0.7,0.8],[0.7,0.8],[0.075,0.14],[0.075,0.14]
    ])
