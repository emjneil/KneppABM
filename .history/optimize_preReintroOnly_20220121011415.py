...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.07,0.071],[0.08,0.081],[0.1,0.13],[0.0015,0.0016],[0.01,0.011],
        # habitat competition
        [0.016,0.017], # mature scrub
        [0.65,0.67],[0.65,0.66], # grassZ
        [0.7,0.75],[0.34,0.35], # saplings
        [0.34,0.35],[0.7,0.75], # young scrub  
        # roe deer parameters
        [0.15,0.2],[0.1,0.2],[0.12,0.15],[0.12,0.15],[0.075,0.15],[0.075,0.15]
    ])
