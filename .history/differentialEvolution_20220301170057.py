...
def run_optimizer():
    ...
    bds = [
        ...
        # roe deer parameters
        (0.18,0.2),(0.93,0.95),(0.91,0.93),(0.91,0.93),(0.14,0.2),(0.12,0.17),
        # fallow deer parameters
        (0.36,0.41),(0.89,0.94),(0.89,0.93),(0.89,0.93),(0.13,0.18),(0.1,0.15),
        # red deer parameters
        (0.38,0.405),(0.89,0.94),(0.89,0.93),(0.89,0.93),(0.13,0.18),(0.1,0.15),
        # exmoor pony parameters
        (0.9,0.93),(0.88,0.92),(0.88,0.92),(0.12,0.17),(0.1,0.14),
        # cattle parameters
        (0.19,0.22),(0.9,0.93),(0.88,0.92),(0.88,0.92),(0.12,0.17),(0.1,0.14),
        # pig parameters
        (0.3,0.45),(0.8,0.83),(0.93,0.94),(0.93,0.94),(0.13,0.2),(0.1,0.16)]
