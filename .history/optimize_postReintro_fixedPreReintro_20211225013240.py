...
def run_optimizer():
    ...
    bds = np.array([
        ...
        # # red deer parameters
        [0.05,0.25],[0.025,0.1],[0.025,0.15],[0.025,0.15],[0.0005,0.01],[0.0005,0.01]
...
def graph_results():
    ...
    redDeer_reproduce = output_parameters["variable"][0] 
    redDeer_gain_from_grass = output_parameters["variable"][1] 
    redDeer_gain_from_Trees =output_parameters["variable"][2] 
    redDeer_gain_from_Scrub = output_parameters["variable"][3] 
    redDeer_gain_from_Saplings = output_parameters["variable"][4] 
