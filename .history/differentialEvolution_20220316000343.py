...
def run_optimizer():
    ...
    bds = [
        ...
        (0.0025,0.004),(0.0025,0.004),(0.0135,0.014),(0.0023,0.0024),(0.0086,0.0087),
        (0.0015,0.003), # mature scrub competition
        (0.094,0.095),(0.093,0.094), # grass
        (0.0045,0.01),(0.0025,0.0075), # saplings
        (0.0045,0.01),(0.0045,0.01), # young scrub  
        # roe deer parameters
        (0.18,0.19),(0.93,0.94),(0.91,0.92),(0.91,0.92),(0.q,0.14),(0.075,0.11),
