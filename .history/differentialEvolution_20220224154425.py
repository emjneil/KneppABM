...
def run_optimizer():
    ...
    bds = [
        ...
        (0.011,0.025),(0.038,0.042),(0.075,0.076),(0.0025,0.003),(0.015,0.016),
        (0.015,0.018), # mature scrub competition
        (0.17,0.18),(0.17,0.18), # grass
        (0.04,0.06),(0.02,0.03), # saplings
        (0.03,0.05),(0.04,0.06), # young scrub  
        # roe deer parameters
        (0.18,0.19),(0.9,0.93),(0.9,0.91),(0.9,0.91),(0.075,0.17),(0.12,0.17),
        # fallow deer parameters
        (0.3,0.35),(0.88,0.91),(0.85,0.9),(0.85,0.9),(0.05,0.15),(0.1,0.15),
        # red deer parameters
        (0.39,0.41),(0.88,0.91),(0.87,0.9),(0.87,0.9),(0.05,0.15),(0.1,0.15),
        # exmoor pony parameters
        (0.87,0.88),(0.86,0.9),(0.86,0.88),(0.05,0.14),(0.1,0.14),
        # cattle parameters
        (0.17,0.19),(0.86,0.9),(0.85,0.87),(0.85,0.87),(0.05,0.14),(0.1,0.14),
        # pig parameters
        (0.25,0.35),(0.75,0.85),(0.9,0.91),(0.9,0.91),(0.05,0.16),(0.1,0.16)]
