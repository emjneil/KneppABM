...
def run_optimizer():
    ...
    bds = np.array([
        ...
        # roe deer parameters
        [0.17,0.21],[0.5,1],[0.75,1],[0.75,1],[0.1,0.5],[0.1,0.5],
        # fallow deer parameters
        [0.35,0.5],[0.45,1],[0.65,1],[0.65,1],[0.08,0.5],[0.08,0.5],
        # red deer parameters
        [0.2,0.5],[0.45,1],[0.55,1],[0.55,1],[0.075,0.5],[0.075,0.5],
        # exmoor pony parameters
        [0.25,0.9],[0.45,1],[0.45,1],[0.05,0.5],[0.05,0.5],
        # cattle parameters
        [0.15,0.4],[0.25,0.9],[0.35,1],[0.35,1],[0.05,0.5],[0.05,0.5],
        # # pig parameters
        [0.05,0.5],[0.05,0.75],[0.55,1],[0.55,1],[0.01,0.5],[0.01,0.5]
    ])
