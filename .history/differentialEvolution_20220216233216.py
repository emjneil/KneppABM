...
def run_optimizer():
    ...
    bds = [
        ...
        (0.012,0.015),(0.02,0.046),(0.075,0.076),(0.0025,0.004),(0.01,0.025),
        (0.011,0.015), # mature scrub competition
        (0.17,0.2),(0.17,0.2), # grass
        (0.075,0.14),(0.02,0.14), # saplings
        (0.05,0.14),(0.075,0.14), # young scrub  

        # roe deer parameters
        (0.18,0.21),(0.8,0.85),(0.82,0.85),(0.82,0.85),(0.12,0.15),(0.12,0.15),
        # fallow deer parameters
        (0.33,0.42),(0.75,0.82),(0.75,0.82),(0.75,0.82),(0.09,0.13),(0.09,0.13),
        # red deer parameters
        (0.33,0.42),(0.75,0.82),(0.75,0.82),(0.75,0.82),(0.09,0.13),(0.09,0.13),
        # exmoor pony parameters
        (0.7,0.8),(0.7,0.8),(0.7,0.8),(0.075,0.12),(0.075,0.12),
        # cattle parameters
        (0.18,0.25),(0.7,0.78),(0.72,0.77),(0.72,0.77),(0.075,0.12),(0.075,0.12),
        # # pig parameters
        (0.17,0.25),(0.6,0.7),(0.8,0.85),(0.8,0.85),(0.075,0.15),(0.075,0.15)]
