...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.05,0.1],[0.075,0.1],[0.01,0.025],[0.001,0.005],[0.005,0.01],
        # habitat competition
        [0.025,0.05],[0.05,0.15],[0.05,0.15],[0.01,0.05],[0.0008,0.01],[0.009,0.01],[0.01,0.025],     
        # roe deer parameters
        [0.15,0.25],[0.05,0.25],[0.05,0.25],[0.05,0.25],[0.003,0.007],[0.003,0.93]
    ])
