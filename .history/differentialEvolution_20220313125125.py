...
def run_optimizer():
    ...
    bds = [
        ...
        # roe deer parameters
        (0.19,0.20),(0.93,0.94),(0.92,0.94),(0.92,0.94),(0.11,0.13),(0.07,0.09),
        # fallow deer parameters
        (0.31,0.32),(0.9,0.92),(0.9,0.92),(0.9,0.92),(0.09,0.12),(0.06,0.08),
        # red deer parameters
        (0.37,0.39),(0.9,0.92),(0.9,0.92),(0.9,0.92),(0.09,0.11),(0.06,0.08),
        # exmoor pony parameters
        (0.89,0.9),(0.89,0.91),(0.89,0.9),(0.075,0.1),(0.05,0.08),
        # cattle parameters
