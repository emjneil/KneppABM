...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.25,0.65],[0.45,0.65],[0.45,0.65],[0.05,0.2],[0.05,0.2],
        # cattle parameters
        [0,0.5],[0.25,0.65],[0.35,0.6],[0.35,0.6],[0.05,0.2],[0.05,0.2],
        # # pig parameters
        [0,0.5],[0.05,0.25],[0.4,0.75],[0.4,0.75],[0.01,0.25],[0.01,0.25]
    ])
