...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.12,0.14],[0.33,0.4],[0.25,0.27],
        # [0.0035,0.005],[0.005,0.01],
        # habitat competition
        [0.001,0.004],[0.85,0.9],[0.85,0.9],[0.95,1],[0.01,0.1],[0.3,0.4],[0.75,0.95],     
        # roe deer parameters
        [0.18,0.22],[0.15,0.22],[0.18,0.25],[0.18,0.25],[0.0075,0.015],[0.0075,0.015],
        # starting conditions for saplings and young scrub     
        [0.01,0.05],[0.025,0.05]
    ])
...
#  The best solution found:
#  [0.12539721 0.37624831 0.25479349 0.00167335 0.88900223 0.88438471
#  0.97436912 0.11691872 0.35550943 0.90051343 0.19528506 0.20337032
#  0.20275195 0.21650262 0.01031862 0.01061995 0.02017959 0.03564753]
