...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.1,0.2],[0.1,0.2],[0.03,0.1],[0.0015,0.006],[0.004,0.08],
        # habitat competition
        [0.01,0.1], # mature scrub
        [0.1,0.13],[0.01,0.1], # grass
        [0.15,0.3],[0.01,0.2], # saplings
        [0.1,0.3],[0.1,0.3], # young scrub  
        # roe deer parameters
        [0.1,0.25],[0.1,0.5],[0.1,0.5],[0.1,0.5],[0.025,0.25],[0.025,0.25]
    ])
...
#  0.10453567 0.08311892 01.07952609 0.01281723 0.04427407 0.07235335
