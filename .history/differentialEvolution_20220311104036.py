...
def run_optimizer():
    ...
    bds = [
        ...
        (0.3,0.31),(0.9,0.93),(0.8,0.93),(0.8,0.93),(0.01,0.12),(0.01,0.12),
        # red deer parameters
        (0.35,0.4),(0.9,0.93),(0.8,0.93),(0.8,0.93),(0.01,0.12),(0.01,0.12),
        # exmoor pony parameters
        (0.9,0.92),(0.8,0.9),(0.8,0.9),(0.01,0.1),(0.01,0.1),
        # cattle parameters
        (0.19,0.21),(0.89,0.9),(0.8,0.9),(0.8,0.9),(0.01,0.1),(0.01,0.1),
        # pig parameters
        (0.25,0.28),(0.8,0.82),(0.8,0.9),(0.8,0.9),(0.01,0.12),(0.01,0.1)]
