...
def run_optimizer():
    ...
    bds = [
        ...
        # red deer parameters
        (0.4,0.41),(0.9,0.92),(0.89,0.92),(0.89,0.92),(0.09,0.1),(0.07,0.08),
        # exmoor pony parameters
        (0.88,0.9),(0.89,0.91),(0.89,0.9),(0.075,0.09),(0.065,0.075),
        # cattle parameters
        (0.18,0.19),(0.88,0.9),(0.88,0.9),(0.88,0.9),(0.07,0.09),(0.06,0.07),
        # pig parameters
