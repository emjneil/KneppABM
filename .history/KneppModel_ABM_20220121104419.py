...
class KneppModel(Model):
    ...
    def __init__(self,             
        ...
        self.datacollector = DataCollector(
                        ...
                        "Saplings that grew up": lambda m: self.count_habitat_death(m, "saplings"),
                        "Young scrub that grew up": lambda m: self.count_habitat_death(m, "youngScrub"),    
                        }
                        )
    ...
    def count_habitat_death(self, model, breed, eaten_thing):
