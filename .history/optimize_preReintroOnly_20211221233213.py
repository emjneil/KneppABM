...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.1,0.12],[0.25,0.35],[0.25,0.27],
        # [0.0035,0.005],[0.005,0.01],
        # habitat competition
        [0.001,0.004],[0.85,0.9],[0.85,0.9],[0.98,1],[0.01,0.05],[0.25,0.4],[0.75,0.95],     
        # roe deer parameters
        [0.18,0.21],[0.1,0.2],[0.18,0.25],[0.18,0.25],[0.0075,0.015],[0.0075,0.015],
        # starting conditions for saplings and young scrub     
        [0.01,0.025],[0.025,0.1]
    ])
...
#  The best solution found:
#  [0.11908275 0.30426549 0.2671579  0.00227492 0.86604944 0.88495464
#  0.99647786 0.01264589 0.37001823 0.79315233 0.18090959 0.16454568
#  0.18418564 0.22818002 0.01385664 0.01280653 0.01087157 0.04277407]
