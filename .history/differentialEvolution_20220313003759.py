...
def run_optimizer():
    ...
    bds = [
        ...
        (0.0033,0.0034),(0.0033,0.0034),(0.0135,0.014),(0.0023,0.0024),(0.0086,0.0087),
        (0.0014,0.0015), # mature scrub competition
        (0.094,0.095),(0.093,0.094), # grass
        (0.084,0.086),(0.016,0.023), # saplings
        (0.084,0.086),(0.084,0.086), # young scrub  
        # roe deer parameters
        (0.19,0.20),(0.93,0.94),(0.92,0.94),(0.92,0.94),(0.11,0.13),(0.08,0.09),
        # fallow deer parameters
        (0.31,0.32),(0.9,0.92),(0.9,0.92),(0.9,0.92),(0.09,0.12),(0.07,0.08),
        # red deer parameters
        (0.39,0.41),(0.9,0.92),(0.9,0.92),(0.9,0.92),(0.09,0.11),(0.07,0.08),
        # exmoor pony parameters
        (0.89,0.9),(0.89,0.91),(0.89,0.9),(0.075,0.1),(0.065,0.08),
        # cattle parameters
        (0.18,0.19),(0.88,0.9),(0.88,0.9),(0.88,0.9),(0.07,0.1),(0.06,0.08),
        # pig parameters
        (0.2,0.22),(0.81,0.87),(0.92,0.94),(0.92,0.94),(0.08,0.13),(0.065,0.1)]
