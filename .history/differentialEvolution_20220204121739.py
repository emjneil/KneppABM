...
def run_optimizer():
    ...
    optimization = differential_evolution(objectiveFunction, bounds = bds, popsize = 1, maxiter = 1)

    with open('/Users/emilyneil/Desktop/KneppABM/outputs/pre_reintro/differentialEvolution_outputs.txt', 'w') as f:
        print('Differential Evolution Outputs:', optimization.output_dict, file=f)
    print(optimization)
