...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.015,0.02],[0.02,0.055],[0.075,0.077],[0.0022,0.003],[0.01,0.03],
        [0.012,0.02], # mature scrub competition
        [0.15,0.2],[0.15,0.2], # grass
        [0.04,0.09],[0.005,0.07], # saplings
        [0.02,0.07],[0.04,0.09], # young scrub  
        # roe deer parameters
        [0.18,0.21],[0.8,1],[0.8,1],[0.8,1],[0.1,0.15],[0.07,0.15]
    ])
