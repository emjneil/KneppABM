...
def run_optimizer():
    ...
    bds = [
        ...
        # roe deer parameters
        (0.18,0.2),(0.8,0.82),(0.82,0.83),(0.82,0.83),(0.13,0.14),(0.13,0.14),
        # fallow deer parameters
        (0.33,0.42),(0.75,0.8),(0.8,0.82),(0.8,0.82),(0.1,0.13),(0.1,0.13),
        # red deer parameters
        (0.33,0.42),(0.75,0.8),(0.79,0.82),(0.79,0.82),(0.1,0.13),(0.1,0.13),
        # exmoor pony parameters
        (0.73,0.75),(0.77,0.79),(0.77,0.79),(0.12,0.13),(0.12,0.13),
        # cattle parameters
        (0.19,0.21),(0.73,0.74),(0.76,0.79),(0.76,0.79),(0.09,0.12),(0.09,0.12),
        # # pig parameters
        (0.17,0.25),(0.6,0.7),(0.8,0.85),(0.8,0.85),(0.1,0.13),(0.1,0.13)]
