...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.09,0.1],[0.1,0.25],[0.01,0.05],[0.0025,0.005],[0.005,0.01],
        # habitat competition
        [0.01,0.05],[0.075,0.15],[0.075,0.15],[0,0.05],[0.01,0.025],[0.01,0.025],[0.025,0.05],     
        # roe deer parameters
        [0.1,0.25],[0.1,0.75],[0.1,0.75],[0.1,0.75],[0.005,0.05],[0.005,0.05]
    ])
