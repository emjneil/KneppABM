...
def run_optimizer():
    ...
    bds = [
        ...
        (0.015,0.019),(0.055,0.06),(0.084,0.085),(0.0021,0.0022),(0.009,0.013),
        (0.0087,0.009), # mature scrub competition
        (0.17,0.175),(0.17,0.175), # grass
        (0.05,0.07),(0.021,0.04), # saplings
        (0.05,0.07),(0.05,0.07), # young scrub  
        # roe deer parameters
        (0.18,0.2),(0.9,0.95),(0.85,0.95),(0.85,0.95),(0.13,0.14),(0.12,0.13),
        # fallow deer parameters
        (0.36,0.39),(0.9,0.93),(0.85,0.93),(0.85,0.93),(0.05,0.12),(0.05,0.11),
        # red deer parameters
        (0.38,0.4),(0.9,0.93),(0.85,0.93),(0.85,0.93),(0.05,0.12),(0.05,0.11),
        # exmoor pony parameters
        (0.9,0.92),(0.86,0.92),(0.86,0.92),(0.05,0.12),(0.05,0.11),
        # cattle parameters
        (0.18,0.2),(0.89,0.9),(0.86,0.92),(0.86,0.92),(0.05,0.12),(0.05,0.11),
        # pig parameters
        (0.25,0.3),(0.8,0.86),(0.85,0.92),(0.85,0.92),(0.075,0.12),(0.075,0.13)]
