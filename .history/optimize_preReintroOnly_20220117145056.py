...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.045,0.055],[0.085,0.087],[0.1,0.12],[0.0015,0.002],[0.005,0.0075],
        # habitat competition
        [0.024,0.026], # mature scrub
        [0.15,0.16],[0.13,0.14], # grass
        [0.22,0.25],[0.09,0.15], # saplings
        [0.09,0.15],[0.22,0.25], # young scrub  
        # roe deer parameters
        [0.15,0.25],[0.05,0.15],[0.05,0.15],[0.05,0.15],[0.075,0.15],[0.075,0.15]
    ])
