    ...
    def __init__(self,             
        ...
        for cell, condit, in zip(self.grid.coord_iter(), condition):
            ...
            if my_condition == 'grassland': # more than 50% grassland, no more than 10 mature trees/shrubs
                ...
                scrub_here = random.randint(100, 1520)
                ...
                trees_here = random.randint(0, 4)
                saplings_here = 0
                scrub_here = random.randint(0, 9)
                youngscrub_here = 0
