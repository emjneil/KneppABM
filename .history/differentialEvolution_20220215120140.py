...
def run_optimizer():
    ...
    bds = [
        ...
        (0.015,0.025),(0.035,0.05),(0.075,0.078),(0.0023,0.0035),(0.0095,0.02),
        (0.015,0.02), # mature scrub competition
        (0.17,0.2),(0.17,0.2), # grass
        (0.04,0.09),(0.01,0.02), # saplings
        (0.03,0.045),(0.04,0.09), # young scrub  

        # roe deer parameters
        (0.18,0.21),(0.8,0.9),(0.8,0.9),(0.8,0.9),(0.1,0.2),(0.1,0.2),
        # fallow deer parameters
        (0.33,0.42),(0.7,0.85),(0.75,0.8),(0.75,0.8),(0.075,0.16),(0.075,0.16),
        # red deer parameters
        (0.33,0.42),(0.68,0.85),(0.75,0.8),(0.75,0.8),(0.075,0.15),(0.075,0.15),
        # exmoor pony parameters
        (0.63,0.75),(0.73,0.78),(0.73,0.78),(0.05,0.14),(0.05,0.14),
        # cattle parameters
        (0.18,0.25),(0.65,0.72),(0.72,0.76),(0.72,0.76),(0.05,0.13),(0.05,0.13),
        # # pig parameters
        (0.17,0.25),(0.5,0.65),(0.75,0.85),(0.75,0.85),(0.05,0.18),(0.05,0.18)]
