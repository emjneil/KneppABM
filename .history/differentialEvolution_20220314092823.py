...
def run_optimizer():
    ...
    bds = [
        ...
        (0.0031,0.0033),(0.003,0.0033),(0.0135,0.014),(0.0023,0.0024),(0.0086,0.0087),
        (0.0035,0.004), # mature scrub competition
        (0.094,0.15),(0.093,0.15), # grass
        (0.088,0.15),(0.015,0.017), # saplings
        (0.077,0.1),(0.088,0.15), # young scrub  
        # roe deer parameters
        (0.18,0.20),(0.91,0.92),(0.91,0.92),(0.91,0.92),(0.1,0.12),(0.085,0.095),
        # fallow deer parameters
        (0.31,0.32),(0.89,0.91),(0.89,0.91),(0.89,0.91),(0.1,0.13),(0.075,0.085),
        # red deer parameters
        (0.37,0.38),(0.89,0.91),(0.89,0.91),(0.89,0.91),(0.09,0.13),(0.075,0.085),
        # exmoor pony parameters
        (0.88,0.9),(0.88,0.9),(0.88,0.9),(0.085,0.12),(0.065,0.085),
        # cattle parameters
        (0.18,0.19),(0.88,0.91),(0.88,0.9),(0.88,0.9),(0.085,0.12),(0.06,0.085),
        # pig parameters
        (0.2,0.3),(0.85,0.9),(0.9,0.92),(0.9,0.92),(0.085,0.13),(0.075,0.095)]
    ...
    #  x: array([0.00267458, 0.00268128, 0.01380946, 0.00234228, 0.00866653,
    #    0.00141173, 0.09415368, 0.09387414, 0.09959082, 0.01767995,
    #    0.08561979, 0.09422554, 0.18508192, 0.91416745, 0.91721629,
    #    0.9131085 , 0.10948559, 0.09265176, 0.31769788, 0.90947608,
    #    0.89822514, 0.89600626, 0.11053564, 0.090643  , 0.37414718,
    #    0.89376022, 0.90069219, 0.90874799, 0.10333851, 0.08324426,
    #    0.89979674, 0.89020069, 0.88721345, 0.10726872, 0.07785663,
    #    0.18173772, 0.89892476, 0.89296807, 0.88483589, 0.11313974,
    #    0.06833823, 0.28313716, 0.87103145, 0.90148952, 0.90606495,
    #    0.10343679, 0.05954685])
