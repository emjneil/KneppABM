...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.01,0.1],[0.1,1],[0,1],
        # habitat competition
        [0.003,0.1], # mature scrub
        [0.1,0.25],[0.01,0.25], # grass
        [0,0.5],[0,0.25], # saplings
        [0,0.25],[0,0.5], # young scrub  
        # roe deer parameters
        [0.15,0.25],[0.1,0.2],[0.075,0.2],[0.075,0.2 ],[0.0075,0.05],[0.0075,0.05]
    ])
...
#  The best solution found:                                                                           
#  [0.04460737 0.04959274 0.48021409 0.0034488  0.23401036 0.20650685
#  0.13430352 0.01401002 0.16161867 0.02650541 0.19326869 0.10952908
#  0.20775369 0.14578705 0.01388049 0.05454452]
...
#  78.0
    ...
    optimization =  ga(function = objectiveFunction, dimension = 16, variable_type = 'real',variable_boundaries= bds, algorithm_parameters = algorithm_param, function_timeout=6000)
    optimization.run()
...
def graph_results():
    ...
    max_start_saplings = 0.25
    max_start_youngScrub = 0.25
