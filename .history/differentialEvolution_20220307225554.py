...
def run_optimizer():
    ...
    bds = [
        ...
        (0.018,0.022),(0.055,0.06),(0.084,0.085),(0.0021,0.0022),(0.01,0.012),
        (0.008,0.01), # mature scrub competition
        (0.17,0.175),(0.17,0.175), # grass
        (0.054,0.06),(0.02,0.023), # saplings
        (0.058,0.06),(0.068,0.07), # young scrub  
        # roe deer parameters
        (0.18,0.2),(0.9,0.95),(0.85,0.95),(0.85,0.95),(0.1,0.15),(0.1,0.15),
        # fallow deer parameters
        (0.37,0.41),(0.9,0.93),(0.85,0.93),(0.85,0.93),(0.075,0.13),(0.075,0.13),
        # red deer parameters
        (0.38,0.4),(0.9,0.93),(0.85,0.93),(0.85,0.93),(0.075,0.1),(0.075,0.1),
        ...
        # pig parameters
        (0.25,0.32),(0.8,0.86),(0.85,0.92),(0.85,0.92),(0.075,0.13),(0.075,0.13)]
