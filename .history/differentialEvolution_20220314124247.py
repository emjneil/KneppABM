...
def run_optimizer():
    ...
    bds = [
        ...
        (0.0025,0.0035),(0.0025,0.0035),(0.0135,0.014),(0.0023,0.0024),(0.0086,0.0087),
        (0.0025,0.003), # mature scrub competition
        (0.094,0.1),(0.093,0.1), # grass
        (0.08,0.09),(0.015,0.025), # saplings
        (0.07,0.09),(0.08,0.09), # young scrub  
        # roe deer parameters
        (0.18,0.20),(0.91,0.92),(0.91,0.92),(0.91,0.92),(0.1,0.12),(0.08,0.1),
        # fallow deer parameters
        (0.31,0.32),(0.89,0.91),(0.89,0.91),(0.89,0.91),(0.09,0.11),(0.075,0.085),
        # red deer parameters
        (0.37,0.38),(0.89,0.91),(0.89,0.91),(0.89,0.91),(0.09,0.11),(0.075,0.085),
        # exmoor pony parameters
        (0.88,0.9),(0.88,0.9),(0.88,0.9),(0.085,0.11),(0.065,0.085),
        # cattle parameters
        (0.18,0.19),(0.88,0.91),(0.88,0.9),(0.88,0.9),(0.085,0.1),(0.06,0.085),
        # pig parameters
        (0.2,0.3),(0.85,0.9),(0.9,0.92),(0.9,0.92),(0.085,0.12),(0.075,0.095)]
