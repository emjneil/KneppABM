...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.015,0.03],[0.06,0.07],[0.075,0.077],[0.002,0.006],[0.008,0.02],
        [0.015,0.02], # mature scrub competition
        [0.085,0.09],[0.085,0.09], # grass
        [0.025,0.09],[0.025,0.09], # saplings
        [0.025,0.09],[0.025,0.09], # young scrub  
        # roe deer parameters
        [0.18,0.21],[0.5,0.75],[0.75,1],[0.75,1],[0.01,0.2],[0.01,0.2]
    ])
...
def graph_results():
    ...
    "Grass Outcompeted by Trees", "Grass Outcompeted by Scrub", "Grass eaten by Exmoor pony", "Grass eaten by Fallow deer", "Grass eaten by longhorn cattle", "Grass eaten by red deer", "Grass eaten by pigs", 
     ...
     "Scrub eaten by red deer", "Trees eaten by pigs", "Trees eaten by Exmoor pony", "Trees eaten by Fallow deer", "Trees eaten by longhorn cattle",  "Trees eaten by red deer", "Trees eaten by pigs", "Boars", "Sow", "Piglet"], axis=1).values.flatten()        
    # species list. this should be +1 the number of simulations
