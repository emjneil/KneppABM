...
def run_optimizer():
    ...
    bds = [
        ...
        # roe deer parameters
        (0.18,0.19),(0.93,0.94),(0.93,0.94),(0.93,0.94),(0.2,0.21),(0.14,0.16),
        # fallow deer parameters
        (0.31,0.32),(0.92,0.93),(0.92,0.93),(0.92,0.93),(0.18,0.2),(0.12,0.14),
        # red deer parameters
        (0.34,0.354),(0.92,0.93),(0.92,0.93),(0.92,0.93),(0.18,0.2),(0.12,0.14),
        # exmoor pony parameters
        (0.91,0.92),(0.91,0.92),(0.91,0.92),(0.16,0.19),(0.11,0.12),
        # cattle parameters
        (0.195,0.21),(0.91,0.92),(0.89,0.92),(0.92,0.93),(0.162,0.19),(0.1,0.12),
        # pig parameters
        (0.29,0.31),(0.86,0.88),(0.93,0.95),(0.93,0.95),(0.18,0.21),(0.12,0.14)]
