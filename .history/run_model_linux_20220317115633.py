...
def run_all_models():
    ...
    if final_results[final_results['run_number'].isin(accepted_preReintro['run_number'])]:
        final_results[final_results['run_number',"passed filters"] +=1 
    ...
    # keep track of how many filters are passed
    if final_results[final_results['run_number'].isin(accepted_April2015['run_number'])]:
