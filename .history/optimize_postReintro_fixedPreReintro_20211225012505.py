...
def objectiveFunction(x):
    ...
    redDeer_reproduce = x[0]
    redDeer_gain_from_grass = x[1]
    redDeer_gain_from_Trees =x[2]
    redDeer_gain_from_Scrub = x[3]
    redDeer_gain_from_Saplings = x[4]
    redDeer_gain_from_YoungScrub = x[5]
    pigs_reproduce = 0
    ...
    cows_reproduce =x[6] 
    cows_gain_from_grass = x[7] 
    cows_gain_from_Trees = x[8] 
    cows_gain_from_Scrub = x[9] 
    cows_gain_from_Saplings = x[10] 
    cows_gain_from_YoungScrub = x[11] 
    ...
    if filtered_result < 10000:
        ...
        with pd.option_context('display.max_columns',None):
            ...
            print(just_nodes1[["Longhorn cattle", "Red deer"]])
            print(just_nodes2[["Longhorn cattle", "Red deer"]])
            print(just_nodes3[["Longhorn cattle", "Red deer"]])
...
def run_optimizer():
    ...
    bds = np.array([
        ...
        # # red deer parameters
        [0.05,0.3],[0.025,0.1],[0.025,0.15],[0.025,0.15],[0.0005,0.01],[0.0005,0.01],
...
#  7.0
    ...
    optimization =  ga(function = objectiveFunction, dimension = 12, variable_type = 'real',variable_boundaries= bds, algorithm_parameters = algorithm_param, function_timeout=6000)
    optimization.run()
...
def graph_results():
    ...
    cows_reproduce = output_parameters["variable"][0]
    cows_gain_from_grass = output_parameters["variable"][1]
    cows_gain_from_Trees = output_parameters["variable"][2]
    cows_gain_from_Scrub =output_parameters["variable"][3]
    cows_gain_from_Saplings = output_parameters["variable"][4] 
    cows_gain_from_YoungScrub = output_parameters["variable"][5] 
    ...
    redDeer_reproduce = output_parameters["variable"][5] 
    redDeer_gain_from_grass = output_parameters["variable"][5] 
    redDeer_gain_from_Trees =output_parameters["variable"][5] 
    redDeer_gain_from_Scrub = output_parameters["variable"][5] 
    redDeer_gain_from_Saplings = output_parameters["variable"][5] 
    redDeer_gain_from_YoungScrub =output_parameters["variable"][5] 
