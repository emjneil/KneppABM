...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.12,0.125],[0.13,0.14],[0.03,0.045],[0.0035,0.005],[0.0065,0.008],
        # habitat competition
        [0.0005,0.0007],[0.125,0.15],[0.07,0.09],[0.42,0.45],[0.015,0.02],[0.03,0.04],[0.12,0.13],     
        # roe deer parameters
        [0.15,0.21],[0.05,0.1],[0.05,0.2],[0.05,0.2],[0.007,0.013],[0.007,0.013],
