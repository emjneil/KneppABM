...
def run_optimizer():
    ...
    bds = [
        ...
        (0.01,0.012),(0.039,0.041),(0.084,0.085),(0.0027,0.0028),(0.014,0.0145),
        ...
        # roe deer parameters
        (0.18,0.2),(0.93,0.95),(0.91,0.93),(0.91,0.93),(0.13,0.16),(0.13,0.16),
        # fallow deer parameters
        (0.36,0.42),(0.89,0.94),(0.89,0.93),(0.89,0.93),(0.11,0.15),(0.11,0.15),
        # red deer parameters
        (0.38,0.405),(0.89,0.94),(0.89,0.93),(0.89,0.93),(0.11,0.15),(0.11,0.15),
        # exmoor pony parameters
        (0.9,0.93),(0.88,0.92),(0.88,0.92),(0.11,0.14),(0.11,0.14),
        # cattle parameters
        (0.19,0.22),(0.9,0.93),(0.88,0.92),(0.88,0.92),(0.11,0.14),(0.11,0.14),
        # pig parameters
        (0.3,0.45),(0.8,0.83),(0.93,0.94),(0.93,0.94),(0.13,0.16),(0.13,0.16)]
