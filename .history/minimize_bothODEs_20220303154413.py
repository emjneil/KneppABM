...
def run_optimizer():
    ...
    bds = [
        ...
        # red deer parameters
        (0.38,0.41),(0.8,0.95),(0.8,0.93),(0.8,0.93),(0.075,0.2),(0.075,0.2),
        # exmoor pony parameters
        (0.8,0.95),(0.85,0.9),(0.85,0.9),(0.05,0.2),(0.05,0.2),
        # cattle parameters
        (0.17,0.21),(0.8,0.95),(0.85,0.9),(0.85,0.9),(0.05,0.15),(0.05,0.2),
        # pig parameters
