...
def graph_runs():
    ...
    accepted_shape_counterfactual_numbers = np.repeat(counterfactual['accepted?'], 10)
    accepted_shape = pd.concat([accepted_shape_numbers, accepted_shape_counterfactual_numbers], axis=0)
    with pd.option_context('display.max_columns',None):
        print(accepted_shape_numbers)
