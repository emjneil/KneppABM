...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.035,0.055],[0.055,0.07],[0.071,0.072],[0.002,0.004],[0.005,0.04],
        # habitat competition
        [0.015,0.025], # mature scrub
        [0.22,0.24],[0.2,0.21], # grass
        [0.15,0.25],[0.05,0.25], # saplings
        [0.05,0.25],[0.15,0.25], # young scrub  
        # roe deer parameters
        [0.17,0.22],[0.1,0.2],[0.1,0.2],[0.1,0.2],[0.075,0.15],[0.075,0.15]
    ])
