...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.1,0.12],[0.25,0.3],[0.25,0.27],
        # [0.0035,0.005],[0.005,0.01],
        # habitat competition
        [0.001,0.004],[0.85,0.9],[0.85,0.9],[0.98,1],[0.01,0.05],[0.25,0.3],[0.75,0.95],     
        # roe deer parameters
        [0.18,0.22],[0.1,0.18],[0.18,0.22],[0.18,0.22],[0.0075,0.015],[0.0075,0.015],
