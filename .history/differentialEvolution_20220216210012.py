...
def run_optimizer():
    ...
    bds = [
        ...
        (0.012,0.015),(0.042,0.046),(0.075,0.076),(0.0025,0.003),(0.011,0.014),
        (0.011,0.015), # mature scrub competition
        (0.17,0.2),(0.17,0.2), # grass
        (0.1,0.14),(0.075,0.14), # saplings
        (0.075,0.14),(0.1,0.14), # young scrub  

        # roe deer parameters
        (0.18,0.21),(0.8,0.85),(0.82,0.85),(0.82,0.85),(0.12,0.15),(0.12,0.15),
        # fallow deer parameters
        (0.33,0.42),(0.75,0.82),(0.75,0.82),(0.75,0.82),(0.1,0.13),(0.1,0.13),
        # red deer parameters
        (0.33,0.42),(0.68,0.85),(0.75,0.82),(0.75,0.82),(0.1,0.13),(0.1,0.13),
        # exmoor pony parameters
        (0.63,0.75),(0.73,0.78),(0.73,0.78),(0.09,0.12),(0.09,0.12),
        # cattle parameters
        (0.18,0.25),(0.65,0.72),(0.72,0.76),(0.72,0.76),(0.075,0.12),(0.075,0.12),
        # # pig parameters
        (0.17,0.25),(0.5,0.65),(0.8,0.85),(0.8,0.85),(0.075,0.15),(0.075,0.15)]
