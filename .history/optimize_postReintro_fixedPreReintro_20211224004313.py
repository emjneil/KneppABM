...
def objectiveFunction(x):
    ...
    cows_reproduce =x[0] 
    cows_gain_from_grass = x[1] 
    cows_gain_from_Trees = x[2] 
    cows_gain_from_Scrub = x[3] 
    cows_gain_from_Saplings = x[4] 
    cows_gain_from_YoungScrub = x[5] 
...
def run_optimizer():
    ...
    bds = np.array([
        ...
        # # cattle parameters
             ...
             [0.0295666  0.11953513 0.08802506 0.0013708  0.0060032 ]

        [0.05,0.3],[0.01,0.1],[0.01,0.08],[0.01,0.08],[0.00075,0.0025],[0.00075,0.0025],
        # # pig parameters
