...
def run_optimizer():
    ...
    bds = [
        ...
        (0.01,0.012),(0.038,0.039),(0.084,0.085),(0.0027,0.0028),(0.017,0.018),
        ...
        # roe deer parameters
        (0.18,0.2),(0.87,0.91),(0.87,0.93),(0.87,0.93),(0.13,0.14),(0.1,0.13),
        # fallow deer parameters
        (0.33,0.35),(0.85,0.91),(0.85,0.92),(0.85,0.92),(0.12,0.13),(0.1,0.13),
        # red deer parameters
        (0.37,0.38),(0.85,0.95),(0.85,0.92),(0.85,0.92),(0.12,0.13),(0.1,0.13),
        # exmoor pony parameters
        (0.8,0.95),(0.82,0.9),(0.82,0.88),(0.1,0.12),(0.1,0.13),
        # cattle parameters
        (0.18,0.22),(0.8,0.9),(0.82,0.9),(0.82,0.88),(0.09,0.12),(0.1,0.12),
        # pig parameters
        (0.25,0.3),(0.75,0.8),(0.9,0.92),(0.9,0.92),(0.1,0.13),(0.1,0.13)]
    ...
    initial_guess = [
        ...
        0.93      , 0.13315906, 0.13      , 0.34146044, 0.90594704,
