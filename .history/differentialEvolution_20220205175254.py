...
def run_optimizer():
    ...
    bds = [
        ...
        # roe deer parameters
        (0.18,0.22),(0.75,0.8),(0.8,0.83),(0.8,0.83),(0.15,0.5),(0.15,0.5),
        # fallow deer parameters
        (0.3,0.45),(0.7,0.75),(0.75,0.8),(0.75,0.8),(0.1,0.4),(0.1,0.4),
        # red deer parameters
        (0.3,0.45),(0.65,0.7),(0.75,0.8),(0.75,0.8),(0.1,0.4),(0.1,0.4),
        # exmoor pony parameters
        (0.6,0.7),(0.7,0.75),(0.7,0.75),(0.1,0.3),(0.1,0.3),
        # cattle parameters
        (0.15,0.3),(0.6,0.65),(0.7,0.75),(0.7,0.75),(0.1,0.3),(0.1,0.3),
        # # pig parameters
        (0.15,0.35),(0.5,0.6),(0.7,0.8),(0.7,0.8),(0.1,0.4),(0.1,0.4)]
