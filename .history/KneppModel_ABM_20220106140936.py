...
class KneppModel(Model):
    ...
    def remove_pig(self, herbivore, count_non_boar, count_boar):
        to_remove = self.schedule.agents_by_breed[herbivore].items() if herbivore.boar == False
        to_remove_boars = self.schedule.agents_by_breed[herbivore].items() if herbivore.boar == True
