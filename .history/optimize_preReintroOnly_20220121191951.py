...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.02,0.075],[0.025,0.075],[0.075,0.1],[0.002,0.004],[0.005,0.05],
        [0.01,0.025], # mature scrub competition
        [0.04,0.06],[0.035,0.06], # grass
        [0.035,0.06],[0.035,0.06], # saplings
        [0.035,0.06],[0.035,0.06], # young scrub  
        # roe deer parameters
        [0.15,0.21],[0.3,0.5],[0.3,0.5],[0.3,0.5],[0.2,0.35],[0.2,0.35]
    ])
