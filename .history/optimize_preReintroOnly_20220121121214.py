...
def graph_results():
    ...
    stacked_competition = final_results.drop(['Time', "Bare ground","Grassland", "Woodland", "Thorny Scrub", "Roe deer", "Exmoor pony", "Fallow deer", "Longhorn cattle", "Red deer", "Tamworth pigs", "Grass", "Trees", "Mature Scrub", "Saplings", "Young Scrub", "Bare Areas"], axis=1).values.flatten()
    "Grown saplings", "Grown young scrub", "Outcompeted Grass", "Outcompeted Mature Scrub", "Outcompeted Saplings", "Outcompeted Young Scrub", "Outcompeted Grass-Scrub", "Outcompeted Young Scrub-Scrub", "Outcompeted Saplings-Scrub", "Eaten Grass", "Eaten Trees", "Eaten Mature Scrub", "Eaten Saplings", "Eaten Young Scrub"], axis=1).values.flatten()    
    ...
    # stacked_list = np.tile(["Grown saplings", "Grown young scrub", "Outcompeted Grass", "Outcompeted Mature Scrub", "Outcompeted Saplings", "Outcompeted Young Scrub", "Outcompeted Grass-Scrub", "Outcompeted Young Scrub-Scrub", "Outcompeted Saplings-Scrub", "Eaten Grass", "Eaten Trees", "Eaten Mature Scrub", "Eaten Saplings", "Eaten Young Scrub"], 51)
    
    # stacked_indices = np.repeat(final_results['Time'], 15)

    final_df_stacked = pd.DataFrame(
    {'Time': stacked_time, 'Ecosystem Element': stacked_eco_element, 'Abundance': stacked_habitats})
    # 'Grown Saplings': "Grown saplings", 'Time': stacked_indices})
