...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.075,0.15],[0.1,0.17],[0.15,0.35],[0.0015,0.006],[0.004,0.08],
        # habitat competition
        [0.01,0.075], # mature scrub
        [0.15,0.25],[0.1,0.15], # grass
        [0.4,0.5],[0.075,0.15], # saplings
        [0.075,0.15],[0.4,0.5], # young scrub  
        # roe deer parameters
        [0.15,0.25],[0.1,0.25],[0.1,0.25],[0.1,0.25],[0.025,0.15],[0.025,0.15]
    ])
