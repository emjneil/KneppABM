...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.3,0.4],[0.45,0.55],[0.5,0.75],[0.5,0.75],[0.08,0.12],[0.08,0.12],
        # red deer parameters
        ...
        # # pig parameters
        [0,0.3],[0.01,0.3],[0.2,0.7],[0.2,0.7],[0.025,0.15],[0.025,0.15]
    ])
...
# Who's eating what
    ...
    amount_killed = final_results.drop(['Time', "Bare ground", "Grassland", "Woodland", "Thorny Scrub", "Roe deer", "Exmoor pony", "Fallow deer", "Longhorn cattle", "Red deer", "Tamworth pigs", "Bare Areas", "Grass", "Trees","Mature Scrub", "Saplings", "Young Scrub", "Young scrub grown up", "Young Scrub Outcompeted by Trees", "Young Scrub Outcompeted by Scrub", "Young Scrub eaten by roe deer", "Young Scrub eaten by Exmoor pony", "Young Scrub eaten by Fallow deer", "Young Scrub eaten by longhorn cattle", "Young Scrub eaten by red deer", "Young Scrub eaten by pigs", "Grass Outcompeted by Trees", "Grass Outcompeted by Scrub", "Grass eaten by roe deer",  "Grass eaten by Exmoor pony", "Grass eaten by Fallow deer", "Grass eaten by longhorn cattle", "Grass eaten by red deer", "Grass eaten by pigs",
     ...
     "Trees eaten by roe deer", "Trees eaten by Exmoor pony", "Trees eaten by Fallow deer", "Trees eaten by longhorn cattle",  "Trees eaten by red deer", "Trees eaten by pigs"], axis=1).values.flatten()        
    stacked_time = np.repeat(final_results['Time'], 9)
    sapling_df = pd.DataFrame(
    {'Time': stacked_time, 'Death By': death_by, 'Amount Died': amount_killed})

    sns.set()

    df_pivot = sapling_df.pivot_table(df, index='Time', columns='Death By', values='Amount Died', aggfunc='sum')
    df_pivot.plot.bar(stacked=True)

    sapling_df.set_index('Time').plot(kind='bar', stacked=True)
