...
def objectiveFunction(x):
    ...
    ponies_gain_from_grass =  0.24
    ponies_gain_from_Trees = 0.12
    ponies_gain_from_Scrub = 0.11
    ponies_gain_from_Saplings = 0.0085 
    ponies_gain_from_YoungScrub = 0.012
    cows_reproduce =x[12] 
    cows_gain_from_grass = x[13] 
    cows_gain_from_Trees = x[14] 
    cows_gain_from_Scrub = x[15] 
    cows_gain_from_Saplings = x[16] 
    cows_gain_from_YoungScrub = x[17] 
    pigs_reproduce =x[18] 
    pigs_gain_from_grass = x[19] 
    pigs_gain_from_Saplings = x[20] 
    pigs_gain_from_YoungScrub = x[21] 
...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.1,0.25],[0.001,0.25],[0,0.15],[0,0.15],[0,0.01],[0,0.02],
        # red deer parameters
        [0.05,0.25],[0.001,0.25],[0,0.15],[0,0.15],[0,0.01],[0,0.02],
        # exmoor pony parameters
        # [0.001,0.25],[0,0.15],[0,0.15],[0,0.01],[0,0.02],
        # cattle parameters
        [0.05,0.25],[0.001,0.25],[0,0.15],[0,0.15],[0,0.01],[0,0.02],
        # pig parameters
        [0.01,0.5],[0.0001,0.25],[0,0.01],[0,0.02]
    ])
