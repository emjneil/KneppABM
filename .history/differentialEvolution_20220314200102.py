...
def run_optimizer():
    ...
    bds = [
        ...
        (0.002,0.0045),(0.002,0.0045),(0.0135,0.014),(0.0023,0.0024),(0.0086,0.0087),
        (0.00065,0.002), # mature scrub competition
        (0.094,0.095),(0.093,0.094), # grass
        (0.025,0.1),(0.01,0.025), # saplings
        (0.025,0.1),(0.025,0.1), # young scrub  
        # roe deer parameters
        (0.18,0.20),(0.91,0.92),(0.91,0.92),(0.91,0.92),(0.09,0.18),(0.075,0.15),
        # fallow deer parameters
        (0.31,0.32),(0.89,0.91),(0.89,0.91),(0.89,0.91),(0.075,0.15),(0.05,0.12),
        # red deer parameters
        (0.35,0.37),(0.89,0.91),(0.89,0.91),(0.89,0.91),(0.075,0.15),(0.05,0.12),
        # exmoor pony parameters
        (0.88,0.9),(0.88,0.9),(0.88,0.9),(0.075,0.11),(0.025,0.13),
        # cattle parameters
        (0.18,0.19),(0.88,0.91),(0.88,0.9),(0.88,0.9),(0.075,0.13),(0.025,0.11),
        # pig parameters
        (0.2,0.3),(0.85,0.9),(0.9,0.92),(0.9,0.92),(0.075,0.18),(0.025,0.15)]
