...
def run_optimizer():
    ...
    bds = [
        ...
        (0.015,0.025),(0.03,0.035),(0.084,0.085),(0.0027,0.0029),(0.015,0.03),
        (0.015,0.017), # mature scrub competition
        (0.17,0.175),(0.17,0.175), # grass
        (0.045,0.065),(0.025,0.05), # saplings
        (0.045,0.065),(0.045,0.065), # young scrub  
        # roe deer parameters
    ...
    initial_guess = [
        ...
        0.02     , 0.032     , 0.08479093, 0.0027    , 0.025     ,
