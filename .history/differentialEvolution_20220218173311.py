...
def run_optimizer():
    ...
    bds = [
        ...
        (0.014,0.016),(0.043,0.044),(0.075,0.076),(0.0025,0.0035),(0.013,0.015),
        (0.011,0.014), # mature scrub competition
        (0.17,0.2),(0.17,0.2), # grass
        (0.045,0.049),(0.033,0.036), # saplings
        (0.04,0.048),(0.03,0.048), # young scrub  
        # roe deer parameters
...
def graph_results():
    ...
    axes[10].set_title("Young Scrub")
    axes[11].set_title("Bare ground")
    g_rc_long.fig.suptitle('Reality check: No Herbivores')
    plt.tight_layout()
