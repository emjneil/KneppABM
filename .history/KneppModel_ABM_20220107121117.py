...
class KneppModel(Model):
    ...
    def __init__(self,             
        ...
        self.datacollector = DataCollector(
                        ...
                        "Sapling deaths from competition": lambda m: self.count_deaths(m, "tree and scrub competition"),
                        "Sapling deaths from roe deer": lambda m: self.count_deaths(m, "eaten by roe"),
                        "Scrub deaths from competition": lambda m: self.count_deaths(m, "tree and scrub competition"),
                        "Scrub deaths from roe deer": lambda m: self.count_deaths(m, "eaten by roe")
                        }
                        )
    ...
    def count_deaths(self, model, habitat_thing):
