...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.001,0.01],[0.01,0.05],[0.02,0.025],[0.0025,0.005],[0.005,0.01],
        # habitat competition
        [0.05,0.06],[0.025,0.1],[0.025,0.1],[0,0.0001],[0,0.0005],[0,0.0005],[0,0.0005],     
        # roe deer parameters
        [0.1,0.25],[0.025,0.1],[0.025,0.1],[0.025,0.1],[0.01,0.1],[0.01,0.1]
    ])
