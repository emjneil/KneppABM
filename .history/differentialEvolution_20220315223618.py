...
def run_optimizer():
    ...
    bds = [
        ...
        (0.0037,0.004),(0.0032,0.004),(0.0135,0.014),(0.0023,0.0024),(0.0086,0.0087),
        ...
        # roe deer parameters
        (0.17,0.20),(0.93,0.95),(0.91,0.94),(0.91,0.94),(0.12,0.14),(0.11,0.13),
        # fallow deer parameters
        (0.315,0.32),(0.92,0.93),(0.89,0.91),(0.89,0.91),(0.1,0.13),(0.09,0.12),
        # red deer parameters
        (0.36,0.37),(0.92,0.93),(0.89,0.91),(0.89,0.91),(0.11,0.13),(0.08,0.11),
        # exmoor pony parameters
        (0.9,0.91),(0.89,0.9),(0.88,0.9),(0.1,0.12),(0.065,0.09),
        # cattle parameters
        (0.185,0.19),(0.88,0.9),(0.88,0.9),(0.89,0.91),(0.09,0.12),(0.065,0.09),
        # pig parameters
        (0.17,0.27),(0.86,0.88),(0.9,0.92),(0.9,0.92),(0.1,0.14),(0.075,0.13)]
