...
def objectiveFunction(x):
    ...
    print((list(results.loc[results['Time'] == 1, 'Saplings'])[0]))
    print(round(max_start_saplings*3000*initial_woodland))
    if (list(results.loc[results['Time'] == 1, 'Saplings'])[0]) > round(max_start_saplings*3000*initial_woodland) and (list(results.loc[results['Time'] == 1, 'Young Scrub'])[0]) > round(max_start_youngScrub*3000*initial_scrubland):
        filtered_result = (
            # pre-reintro model
        ...
        filtered_result = (
        (((list(results.loc[results['Time'] == 5, 'Saplings'])[0])-round(max_start_saplings*3500*initial_woodland))**2) +
        (((list(results.loc[results['Time'] == 5, 'Young Scrub'])[0])-round(max_start_youngScrub*3500*initial_scrubland))**2))
