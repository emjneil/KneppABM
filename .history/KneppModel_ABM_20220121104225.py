...
class KneppModel(Model):
    ...
    def __init__(self,             
        ...
        self.datacollector = DataCollector(
                        ...
                        "Eaten Grass": lambda m: self.count_eaten(m, roeDeer_agent, count_eaten, "grass"),
                        "Eaten Trees": lambda m: self.count_eaten(m, roeDeer_agent, count_eaten, "trees"),
                        "Eaten Mature Scrub": lambda m: self.count_eaten(m, roeDeer_agent, count_eaten, "scrub"),
                        "Eaten Saplings": lambda m: self.count_eaten(m, roeDeer_agent, count_eaten, "saplings"),
                        "Eaten Young Scrub": lambda m: self.count_eaten(m, roeDeer_agent,count_eaten,  "youngScrub"), 
                        # competition
