...
def run_optimizer():
    ...
    bds = [
        ...
        (0.01,0.012),(0.038,0.041),(0.084,0.085),(0.0027,0.0028),(0.016,0.018),
        (0.01,0.015), # mature scrub competition
        (0.17,0.175),(0.17,0.175), # grass
        (0.05,0.056),(0.025,0.027), # saplings
        (0.04,0.046),(0.05,0.056), # young scrub  
        # roe deer parameters
        (0.18,0.2),(0.9,0.93),(0.87,0.95),(0.87,0.95),(0.14,0.16),(0.14,0.16),
        # fallow deer parameters
        (0.33,0.35),(0.9,0.93),(0.89,0.93),(0.85,0.93),(0.12,0.15),(0.12,0.15),
        # red deer parameters
        (0.35,0.38),(0.9,0.93),(0.89,0.93),(0.85,0.93),(0.12,0.15),(0.12,0.15),
        # exmoor pony parameters
        (0.85,0.9),(0.87,0.92),(0.85,0.92),(0.12,0.15),(0.11,0.15),
        # cattle parameters
        (0.18,0.21),(0.87,0.92),(0.85,0.92),(0.82,0.88),(0.12,0.15),(0.1,0.15),
        # pig parameters
        (0.25,0.3),(0.75,0.8),(0.9,0.95),(0.9,0.95),(0.11,0.15),(0.11,0.15)]
