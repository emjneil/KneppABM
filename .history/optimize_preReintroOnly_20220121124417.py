...
def graph_results():
    ...
    youngScrub_eatenByDeer_tiled =np.repeat(youngScrub_eatenByDeer, 6)
     ...
     # stacked_competition = np.tile(["Eaten Saplings", "Eaten Young Scrub"], 51) 
    ...
    'Trees Eaten by Roe Deer': trees_eatenByDeer_tiled, 'Scrub Eaten by Roe Deer': scrub_eatenByDeer_tiled, 'Saplings Eaten By Roe Deer': saplings_eatenByDeer_tiled, 
    })
