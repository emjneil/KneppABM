...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.25,0.45],[0.45,0.55],[0.65,0.75],[0.65,0.75],[0.08,0.25],[0.08,0.25],
        # red deer parameters
        [0.25,0.45],[0.45,0.5],[0.55,0.7],[0.55,0.7],[0.075,0.25],[0.075,0.25],
        # exmoor pony parameters
        [0.4,0.5],[0.45,0.65],[0.45,0.65],[0.05,0.2],[0.05,0.2],
        # cattle parameters
