...
def objectiveFunction(x):
    ...
    max_start_saplings = 0.5
    max_start_youngScrub = 0.5
...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.017,0.05],[0.015,0.05],[0.075,0.1],[0.002,0.004],[0.005,0.05],
        [0.015,0.02], # mature scrub competition
        [0.025,0.05],[0.025,0.05], # grass
        [0.045,0.06],[0.03,0.05], # saplings
        [0.03,0.05],[0.045,0.06], # young scrub  
        # roe deer parameters
        [0.15,0.21],[0.5,0.75],[0.35,1],[0.35,1],[0.1,0.25],[0.1,0.25]
    ])
