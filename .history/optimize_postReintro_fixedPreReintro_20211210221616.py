...
def objectiveFunction(x):
    ...
    chance_reproduceSapling = 0.17
    chance_reproduceYoungScrub = 0.28
    chance_regrowGrass = 0.034
    chance_saplingBecomingTree = 0.0048
    chance_youngScrubMatures = 0.0058
    chance_scrubOutcompetedByTree = 0.00096
    chance_grassOutcompetedByTree = 0.06
    chance_grassOutcompetedByScrub = 0.061
    chance_saplingOutcompetedByTree = 0.16
    chance_saplingOutcompetedByScrub = 0.12
    chance_youngScrubOutcompetedByScrub = 0.16
    chance_youngScrubOutcompetedByTree = 0.22
    # initial values
    initial_roeDeer = 0.08
    initial_grassland = 0.8
    initial_woodland = 0.15
    initial_scrubland = 0.05
    roeDeer_reproduce = 0.24
    roeDeer_gain_from_grass = 0.24
    roeDeer_gain_from_Trees = 0.15
    roeDeer_gain_from_Scrub = 0.16
    roeDeer_gain_from_Saplings = 0.011
    roeDeer_gain_from_YoungScrub = 0.021
    ...
    pigs_reproduce =x[23] 
    pigs_gain_from_grass = x[24] 
    pigs_gain_from_Saplings = x[25] 
    pigs_gain_from_YoungScrub = x[26] 
    max_start_saplings = 0.073
    max_start_youngScrub = 0.067
    ...
    model = KneppModel(
        ...
        width = 50, height = 36, max_time = 50, reintroduction = True, 
...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0,0.25],[0,0.25],[0,0.15],[0,0.15],[0,0.01],[0,0.02],
        # red deer parameters
        [0,0.25],[0,0.25],[0,0.15],[0,0.15],[0,0.01],[0,0.02],
        # exmoor pony parameters
        [0,0.25],[0,0.15],[0,0.15],[0,0.01],[0,0.02],
        # cattle parameters
        [0,0.25],[0,0.25],[0,0.15],[0,0.15],[0,0.01],[0,0.02],
        # pig parameters
        [0,0.25],[0,0.25],[0,0.01],[0,0.02]
    ])
...
#  0.21625509 0.07191859 0.08724847 0.00426801 0.00372351 0.11283141
#  0.14737943 0.13018309 0.10919425 0.00791606 0.01619882 0.03549491
#  0.02399074 0.00905413 0.00165407]
...
#  36926.0
    ...
    optimization =  ga(function = objectiveFunction, dimension = 27, variable_type = 'real',variable_boundaries= bds, algorithm_parameters = algorithm_param, function_timeout=6000)
    optimization.run()
...
def graph_results():
    ...
    fallowDeer_reproduce = 0.24
    fallowDeer_gain_from_grass = 0.067
    fallowDeer_gain_from_Trees = 0.0087
    fallowDeer_gain_from_Scrub = 0.11
    fallowDeer_gain_from_Saplings = 0.007
    fallowDeer_gain_from_YoungScrub = 0.0088
    redDeer_reproduce = 0.11
    redDeer_gain_from_grass = 0.05
    redDeer_gain_from_Trees = 0.06
    redDeer_gain_from_Scrub = 0.11
    redDeer_gain_from_Saplings = 0.0058
    redDeer_gain_from_YoungScrub = 0.001
    ponies_gain_from_grass = 0.22
    ponies_gain_from_Trees = 0.07
    ponies_gain_from_Scrub = 0.087
    ponies_gain_from_Saplings = 0.004
    ponies_gain_from_YoungScrub = 0.0037
    cows_reproduce = 0.11
    cows_gain_from_grass = 0.15
    cows_gain_from_Trees = 0.13
    cows_gain_from_Scrub = 0.11
    cows_gain_from_Saplings = 0.0079
    cows_gain_from_YoungScrub = 0.016
    pigs_reproduce = 0.035
    pigs_gain_from_grass = 0.024
    pigs_gain_from_Saplings = 0.0091
    pigs_gain_from_YoungScrub = 0.0017
    ...
    # pigs_gain_from_Saplings = output_parameters["variable"][25] 
    # pigs_gain_from_YoungScrub = output_parameters["variable"][26] 
    max_start_saplings = 0.073
    max_start_youngScrub = 0.067
    ...
    model = KneppModel(
        ...
        pigs_reproduce, pigs_gain_from_grass, pigs_gain_from_Saplings, pigs_gain_from_YoungScrub, 
        max_start_saplings, max_start_youngScrub,
        width = 50, height = 36, max_time = 185, reintroduction = True, 
        RC1_noFood = False, RC2_noTreesScrub = False, RC3_noTrees = False, RC4_noScrub = False)
    model.run_model()
    ...
    print(len(y_values),  len(species_list), len(indices))
    ...
    f.axes[0].vlines(x=184,ymin=20,ymax=40, color='r')
