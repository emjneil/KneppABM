...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.1,0.12],[0.13,0.15],[0.21,0.26],
        # habitat competition
        [0.001,0.004],[0.5,0.75],[0.5,0.75],[0.98,1],[0.01,0.15],[0.15,0.3],[0.75,0.95],     
        # roe deer parameters
        [0.15,0.23],[0.1,0.25],[0.05,0.15],[0.05,0.15],[0.0075,0.013],[0.0075,0.013],
