...
def run_optimizer():
    ...
    # # roe deer parameters
    # (0.17,0.21),(0.9,0.95),(0.9,0.95),(0.9,0.95),(0.1,0.3),(0.1,0.3),
    ...
    bds = [
        # habitat repro & growth
        (0.0075,0.05),(0.035,0.05),(0.075,0.076),(0.0025,0.003),(0.014,0.017),
        (0.013,0.017), # mature scrub competition
        (0.17,0.18),(0.17,0.18), # grass
        (0.03,0.075),(0.01,0.075), # saplings
        (0.04,0.075),(0.03,0.075), # young scrub  
        # roe deer parameters
        (0.18,0.2),(0.8,0.82),(0.82,0.83),(0.82,0.83),(0.14,0.16),(0.14,0.16),
        # fallow deer parameters
        (0.25,0.4),(0.79,0.81),(0.81,0.82),(0.81,0.82),(0.13,0.15),(0.13,0.15),
        # red deer parameters
        (0.25,0.4),(0.78,0.8),(0.8,0.82),(0.8,0.82),(0.12,0.15),(0.12,0.15),
        # exmoor pony parameters
