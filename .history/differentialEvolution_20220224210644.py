...
def run_optimizer():
    ...
    bds = [
        ...
        # roe deer parameters
        (0.18,0.21),(0.93,0.94),(0.93,0.94),(0.92,0.94),(0.14,0.15),(0.14,0.15),
        # fallow deer parameters
        (0.3,0.35),(0.91,0.93),(0.91,0.93),(0.91,0.93),(0.13,0.14),(0.13,0.14),
        # red deer parameters
        (0.39,0.41),(0.88,0.92),(0.88,0.93),(0.88,0.93),(0.12,0.14),(0.12,0.14),
        # exmoor pony parameters
        (0.87,0.91),(0.87,0.92),(0.87,0.92),(0.11,0.14),(0.11,0.14),
        # cattle parameters
        (0.18,0.21),(0.86,0.91),(0.87,0.92),(0.87,0.92),(0.11,0.14),(0.11,0.14),
        # pig parameters
        (0.15,0.35),(0.75,0.85),(0.9,0.91),(0.9,0.91),(0.12,0.15),(0.12,0.15)]
