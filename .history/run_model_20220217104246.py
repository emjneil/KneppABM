...
def run_all_models():
    ...
    for _ in range(number_simulations):
        ...
        pigs_gain_from_Scrub = random.uniform((output_parameters[44]-(output_parameters[44]*perc_aboveBelow)), (output_parameters["variable"][44]+(output_parameters["variable"][44]*perc_aboveBelow)))
