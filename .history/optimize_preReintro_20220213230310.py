...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.01,0.02],[0.045,0.055],[0.075,0.077],[0.0022,0.003],[0.01,0.03],
        [0.01,0.02], # mature scrub competition
        [0.1,0.15],[0.1,0.15], # grass
        [0.02,0.06],[0.001,0.05], # saplings
        [0.01,0.06],[0.02,0.06], # young scrub  
        # roe deer parameters
        [0.18,0.21],[0.8,1],[0.8,1],[0.8,1],[0.1,0.2],[0.07,0.2]
    ])
