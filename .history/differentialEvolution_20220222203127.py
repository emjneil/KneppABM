...
def run_optimizer():
    ...
    # roe deer parameters
    (0.17,0.22),(0.9,0.95),(0.9,0.95),(0.9,0.95),(0.1,0.3),(0.1,0.3),
    # fallow deer parameters
    (0.25,0.4),(0.8,0.9),(0.8,0.9),(0.8,0.9),(0.1,0.25),(0.1,0.25),
    # red deer parameters
    (0.35,0.41),(0.85,0.9),(0.85,0.9),(0.85,0.9),(0.1,0.23),(0.1,0.23),
