...
def run_optimizer():
    ...
    bds = np.array([
        ...
        # # pig parameters
        [0.01,0.25],[0.001,0.025],[0,0.005],[0,0.005]
    ])
...
def graph_results():
    ...
    pigs_reproduce = output_parameters["variable"][6] 
    pigs_gain_from_grass = output_parameters["variable"][7] 
    pigs_gain_from_Saplings = output_parameters["variable"][8] 
    pigs_gain_from_YoungScrub = output_parameters["variable"][9] 
