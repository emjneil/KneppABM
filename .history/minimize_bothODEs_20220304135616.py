...
def run_optimizer():
    ...
    bds = [
        ...
        (0.01,0.012),(0.039,0.042),(0.084,0.085),(0.0027,0.0028),(0.014,0.016),
        (0.01,0.013), # mature scrub competition
        (0.17,0.175),(0.17,0.175), # grass
        (0.055,0.065),(0.025,0.03), # saplings
        (0.04,0.05),(0.055,0.065), # young scrub  
        # roe deer parameters
        (0.18,0.2),(0.9,0.91),(0.92,0.93),(0.92,0.93),(0.13,0.16),(0.1,0.12),
        # fallow deer parameters
        (0.33,0.35),(0.85,0.91),(0.85,0.92),(0.85,0.92),(0.1,0.15),(0.09,0.13),
        # red deer parameters
        (0.37,0.38),(0.85,0.95),(0.85,0.92),(0.85,0.92),(0.1,0.15),(0.09,0.13),
        # exmoor pony parameters
        (0.8,0.95),(0.88,0.9),(0.82,0.9),(0.09,0.14),(0.09,0.12),
        # cattle parameters
        (0.18,0.22),(0.85,0.9),(0.88,0.9),(0.83,0.88),(0.09,0.14),(0.09,0.12),
        # pig parameters
        (0.25,0.3),(0.75,0.8),(0.9,0.92),(0.9,0.92),(0.1,0.16),(0.1,0.13)]
