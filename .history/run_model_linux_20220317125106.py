...
def run_all_models():
    ...
    my_time = final_results.loc[row['Time'] == 50]
    for index, row in final_results.iterrows():
        print(my_time)
        if (my_time["Roe deer"] <= 40) & (my_time["Roe deer"] >= 6) & (my_time["Grassland"] <= 90) & (my_time["Grassland"] >= 49) & (my_time["Woodland"] <= 27) & (my_time["Woodland"] >= 7) & (my_time["Thorny Scrub"] <= 21) & (my_time["Thorny Scrub"] >= 1):
