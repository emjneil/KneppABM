...
def run_optimizer():
    ...
    bds = [
        ...
        (0.35,0.38),(0.85,0.95),(0.85,0.93),(0.85,0.93),(0.05,0.2),(0.05,0.15),
        # red deer parameters
        (0.38,0.4),(0.85,0.95),(0.85,0.93),(0.85,0.93),(0.075,0.2),(0.075,0.15),
        # exmoor pony parameters
        (0.8,0.95),(0.88,0.9),(0.82,0.9),(0.05,0.2),(0.05,0.15),
        # cattle parameters
        (0.18,0.21),(0.85,0.9),(0.88,0.9),(0.83,0.88),(0.05,0.15),(0.05,0.13),
        # pig parameters
    ...
    initial_guess = [
        ...
        0.0110192 , 0.04146006, 0.08444886, 0.00271833, 0.01431701,
        0.00802486, 0.17455056, 0.17416137, 0.05230062, 0.02442212,
        0.04609248, 0.05495397, 0.18512665, 0.89131889, 0.91011232,
        0.88805432, 0.14079996, 0.11430998, 0.38      , 0.91594172,
        0.8828897 , 0.9093383 , 0.13366001, 0.105226  , 0.3909539 ,
        0.91042842, 0.93      , 0.85904398, 0.1727195 , 0.08726744,
        0.90417514, 0.9       , 0.9       , 0.15395046, 0.16068597,
        0.2       , 0.86224128, 0.89101624, 0.8650655 , 0.10129296,
        0.16060253, 0.28163726, 0.82401375, 0.8551154 , 0.86212852,
        0.15391112, 0.14655678]
