...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.1,0.25],[0.01,0.25],[0,0.15],[0,0.15],[0,0.01],[0,0.02],
        # red deer parameters
        [0.05,0.25],[0.01,0.25],[0,0.15],[0,0.15],[0,0.01],[0,0.02],
        # exmoor pony parameters
        [0,0.25],[0.01,0.15],[0,0.15],[0,0.01],[0,0.02],
        # cattle parameters
        [0.05,0.25],[0.01,0.25],[0,0.15],[0,0.15],[0,0.01],[0,0.02],
        # pig parameters
        [0.01,0.5],[0,0.25],[0,0.01],[0,0.02]
    ])
