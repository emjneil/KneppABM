...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.12,0.129],[0.13,0.15],[0.025,0.05],[0.0025,0.005],[0.007,0.008],
        # habitat competition
        [0.0006,0.0007],[0.13,0.15],[0.07,0.09],[0.42,0.45],[0.015,0.02],[0.025,0.04],[0.12,0.13],     
        # roe deer parameters
        [0.15,0.21],[0.05,0.15],[0.05,0.25],[0.05,0.25],[0.005,0.012],[0.005,0.012],
        # starting conditions for saplings and young scrub     
        [0.05,0.075],[0.12,0.15]
    ])
...
#  The best solution found:                                                                           
#  [0.12202525 0.13567969 0.03977399 0.00368711 0.00678392 0.00051215
#  0.12784934 0.05537663 0.41751768 0.02061051 0.03425637 0.12220485
#  0.20341354 0.08865425 0.06574835 0.03707716 0.00658037 0.01398528
#  0.05111695 0.13021174]
