...
def graph_results():
    ...
    grown_saplings_tiled = np.repeat(grown_saplings, 51)
    print(grown_saplings_tiled)
    ...
    {'Time': stacked_time, 'Ecosystem Element': stacked_eco_element, 'Abundance': stacked_habitats, 'Grown saplings': grown_saplings_tiled})
