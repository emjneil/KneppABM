...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.07,0.072],[0.079,0.082],[0.1,0.13],[0.0015,0.0016],[0.015,0.017],
        # habitat competition
        [0.016,0.019], # mature scrub
        [0.65,0.7],[0.65,0.7], # grassZ
        [0.25,0.75],[0.25,0.5], # saplings
        [0.25,0.5],[0.25,0.75], # young scrub  
        # roe deer parameters
        [0.17,0.21],[0.1,0.2],[0.12,0.15],[0.12,0.15],[0.075,0.15],[0.075,0.15]
    ])
