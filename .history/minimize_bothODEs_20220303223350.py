...
def run_optimizer():
    ...
    bds = [
        ...
        (0.35,0.38),(0.85,0.95),(0.85,0.93),(0.85,0.93),(0.05,0.2),(0.05,0.13),
        # red deer parameters
        (0.35,0.4),(0.85,0.95),(0.85,0.93),(0.85,0.93),(0.075,0.2),(0.075,0.13),
        # exmoor pony parameters
        (0.8,0.95),(0.88,0.9),(0.82,0.9),(0.05,0.2),(0.05,0.12),
        # cattle parameters
