...
class KneppModel(Model):
    ...
    def __init__(self,             
        ...
        self.datacollector = DataCollector(
                        ...
                        # competition
                        "Outcompeted Grass": lambda m: self.count_outcompeted(m, "grass"),
                        "Outcompeted Mature Scrub": lambda m: self.count_outcompeted(m, "scrub"),
                        "Outcompeted Saplings": lambda m: self.count_outcompeted(m, "saplings"),
                        "Outcompeted Young Scrub": lambda m: self.count_outcompeted(m, "youngScrub"), 

habs_outcompeted
                        # death by growing up (saplings, young scrub)
                        "Grown saplings": lambda m: self.count_habitat_death(m, "saplings"),
                        "Grown young scrub": lambda m: self.count_habitat_death(m, "youngScrub"),    
                        }
                        )
    ...
    def count_habitat_death(self, model, habitat_type):
