...
def run_optimizer():
    ...
    bds = [
        ...
        (0.01,0.012),(0.036,0.041),(0.084,0.085),(0.0027,0.0028),(0.016,0.02),
        ...
        # roe deer parameters
        (0.18,0.2),(0.9,0.93),(0.87,0.95),(0.87,0.95),(0.14,0.16),(0.12,0.14),
        # fallow deer parameters
        (0.33,0.35),(0.9,0.93),(0.89,0.93),(0.85,0.93),(0.12,0.15),(0.11,0.15),
        # red deer parameters
        (0.34,0.37),(0.9,0.93),(0.89,0.93),(0.85,0.93),(0.12,0.15),(0.11,0.15),
        # exmoor pony parameters
        (0.85,0.9),(0.87,0.92),(0.85,0.92),(0.12,0.15),(0.1,0.15),
        # cattle parameters
