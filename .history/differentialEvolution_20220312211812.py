...
def run_optimizer():
    ...
    bds = [
        ...
        (0.0031,0.0032),(0.0031,0.0033),(0.0135,0.014),(0.0023,0.0024),(0.0086,0.0087),
        (0.0014,0.0015), # mature scrub competition
        (0.094,0.095),(0.093,0.094), # grass
        (0.084,0.085),(0.023,0.025), # saplings
        (0.082,0.085),(0.084,0.085), # young scrub  
        # roe deer parameters
        ...
        (0.88,0.9),(0.88,0.9),(0.88,0.9),(0.06,0.09),(0.05,0.08),
        # cattle parameters
        (0.19,0.21),(0.87,0.9),(0.87,0.9),(0.87,0.9),(0.06,0.09),(0.05,0.07),
        # pig parameters
