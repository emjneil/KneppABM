...
def run_optimizer():
    ...
    bds = [
        ...
        (0.0032,0.0033),(0.0032,0.0033),(0.0135,0.014),(0.0023,0.0024),(0.0086,0.0087),
        ...
        # roe deer parameters
        (0.19,0.20),(0.93,0.94),(0.92,0.94),(0.92,0.94),(0.12,0.15),(0.05,0.1),
        # fallow deer parameters
        (0.31,0.32),(0.9,0.92),(0.9,0.92),(0.9,0.92),(0.1,0.13),(0.025,0.1),
        # red deer parameters
        (0.36,0.38),(0.9,0.92),(0.9,0.92),(0.9,0.92),(0.095,0.13),(0.025,0.1),
        # exmoor pony parameters
        (0.89,0.9),(0.89,0.91),(0.89,0.9),(0.085,0.12),(0.025,0.1),
        # cattle parameters
        (0.18,0.19),(0.88,0.9),(0.88,0.9),(0.88,0.9),(0.085,0.12),(0.025,0.1),
        # pig parameters
        (0.2,0.3),(0.83,0.87),(0.92,0.94),(0.92,0.94),(0.085,0.15),(0.025,0.1)]
