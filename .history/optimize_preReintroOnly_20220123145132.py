...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.015,0.02],[0.03,0.035],[0.075,0.077],[0.002,0.006],[0.01,0.02],
        [0.015,0.02], # mature scrub competition
        [0.085,0.09],[0.085,0.09], # grass
        [0.025,0.04],[0.025,0.04], # saplings
        [0.025,0.04],[0.025,0.04], # young scrub  
        # roe deer parameters
        [0.18,0.21],[0.5,0.75],[0.75,1],[0.75,1],[0.1,0.15],[0.1,0.15]
    ])

#  The best solution found:
#  [0.01309159 0.0312162  0.07606925 0.00260179 0.01732225 0.01100386
#  0.05360777 0.05496074 0.0273673  0.01782108 0.03361789 0.02830028
#  0.20593571 0.58150251 0.84789767 0.82184092 0.10006926 0.18700832]
