...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.075,0.11],[0.13,0.14],[0.03,0.045],[0.0035,0.005],[0.0065,0.008],
        # habitat competition
        [0.0005,0.001],[0.1,0.15],[0.07,0.09],[0.3,0.4],[0.02,0.025],[0.03,0.035],[0.12,0.13],     
        # roe deer parameters
        [0.15,0.20],[0.08,0.1],[0.025,0.25],[0.025,0.25],[0.005,0.025],[0.005,0.025],
        # starting conditions for saplings and young scrub     
        [0.025,0.075],[0.12,0.15]
    ])
