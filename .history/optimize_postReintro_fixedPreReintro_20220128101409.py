...
# Who's eating what
    ...
    death_by = np.tile(["Saplings Outcompeted by Trees", "Saplings Outcompeted by Scrub", "Saplings eaten by roe deer", "Saplings eaten by Exmoor pony", "Saplings eaten by Fallow deer", "Saplings eaten by longhorn cattle", "Saplings eaten by red deer",  "Saplings eaten by pigs"], 185)
    sapling_df = pd.DataFrame(
    {'Time': final_results['Time'], 'Saplings grown up': final_results['Saplings grown up'], 'Saplings grown up': final_results['Saplings grown up']})
