...
def run_optimizer():
    ...
    bds = [
        ...
        # roe deer parameters
        (0.18,0.19),(0.93,0.94),(0.91,0.92),(0.91,0.92),(0.075,0.1),(0.075,0.1),
        # fallow deer parameters
        (0.3,0.32),(0.92,0.93),(0.89,0.91),(0.89,0.91),(0.05,0.1),(0.05,0.075),
        # red deer parameters
        (0.35,0.37),(0.92,0.93),(0.89,0.91),(0.89,0.91),(0.05,0.1),(0.05,0.075),
        # exmoor pony parameters
        (0.9,0.91),(0.89,0.9),(0.88,0.9),(0.025,0.1),(0.025,0.075),
        # cattle parameters
