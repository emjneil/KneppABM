...
class KneppModel(Model):
    ...
    def __init__(self,             
        ...
        self.datacollector = DataCollector(
                        ...
                        "Young Scrub eaten by roe deer": lambda m: self.count_eaten(m, roeDeer_agent, "grass"),
                        "Young Scrub eaten by Exmoor pony": lambda m: self.count_eaten(m, exmoorPony, "grass"),
                        "Young Scrub eaten by Fallow deer": lambda m: self.count_eaten(m, fallowDeer, "grass"),
                        "Young Scrub eaten by longhorn cattle": lambda m: self.count_eaten(m, longhornCattle, "grass"),
                        "Young Scrub eaten by red deer": lambda m: self.count_eaten(m, redDeer, "grass"),
                        "Young Scrub eaten by pigs": lambda m: self.count_eaten(m, tamworthPigs, "grass"),
