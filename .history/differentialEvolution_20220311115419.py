...
def run_optimizer():
    ...
    bds = [
        ...
        (0.001,0.0075),(0.001,0.0075),(0.084,0.085),(0.0018,0.0045),(0.004,0.015),
        (0.0005,0.005), # mature scrub competition
        (0.17,0.2),(0.17,0.2), # grass
        (0.05,0.1),(0.01,0.075), # saplings
        (0.05,0.075),(0.05,0.1), # young scrub  
        # roe deer parameters
        (0.15,0.25),(0.85,0.94),(0.89,0.94),(0.89,0.94),(0.05,0.12),(0.05,0.12),
        # fallow deer parameters
        (0.3,0.31),(0.85,0.93),(0.8,0.93),(0.8,0.93),(0.025,0.11),(0.025,0.11),
        # red deer parameters
        (0.35,0.4),(0.85,0.93),(0.8,0.93),(0.8,0.93),(0.025,0.11),(0.025,0.11),
        # exmoor pony parameters
        (0.85,0.92),(0.8,0.9),(0.8,0.9),(0.01,0.1),(0.01,0.1),
        # cattle parameters
        (0.19,0.21),(0.85,0.9),(0.8,0.9),(0.8,0.9),(0.01,0.1),(0.01,0.1),
        # pig parameters
        (0.25,0.28),(0.75,0.82),(0.8,0.9),(0.8,0.9),(0.01,0.12),(0.01,0.1)]
