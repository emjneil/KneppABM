...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.05,0.06],[0.075,0.15],[0.025,0.05],[0.0025,0.005],[0.005,0.008],
        # habitat competition
        [0.0005,0.001],[0.05,0.075],[0.075,0.15],[0.05,0.15],[0.05,0.15],[0.05,0.15],[0.05,0.15],     
        # roe deer parameters
        [0.17,0.22],[0.1,0.25],[0.1,0.2],[0.1,0.2],[0.005,0.025],[0.005,0.025],
...
#  The best solution found:                                                                           
#  [0.08283883 0.13698037 0.04245443 0.00378435 0.00793384 0.00083853
#  0.06751125 0.06594869 0.12111045 0.09903051 0.0936203  0.13381695
