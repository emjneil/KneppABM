...
def run_optimizer():
    ...
    bds = np.array([
        ...
        # roe deer parameters
        [0.17,0.21],[0.5,1],[0.75,1],[0.75,1],[0.1,0.25],[0.1,0.25],
        # fallow deer parameters
        [0,0.5],[0.45,1],[0.65,1],[0.65,1],[0.08,0.25],[0.08,0.25],
        # red deer parameters
        [0,0.5],[0.45,1],[0.55,1],[0.55,1],[0.075,0.25],[0.075,0.25],
        # exmoor pony parameters
        [0.25,0.9],[0.45,1],[0.45,1],[0.05,0.25],[0.05,0.25],
        # cattle parameters
        [0,0.5],[0.25,0.9],[0.35,1],[0.35,1],[0.05,0.25],[0.05,0.25],
        # # pig parameters
