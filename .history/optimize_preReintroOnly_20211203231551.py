...
def run_optimizer():
    ...
    bds = np.array([
        # habitat parameters
        [0,0.01],[0,0.01],[0.01,0.1],[0.0005,0.005],[0.001,0.1],[0.02,0.035],[0.025,0.035],[0.025,0.035],[0.01,0.025],[0.01,0.025],[0.01,0.025],[0.01,0.025],     
        # roe deer parameters
        [0.1,0.25],[0.1,0.25],[0.1,0.25],[0.1,0.25],[0,0.01],[0,0.01]
    ])
