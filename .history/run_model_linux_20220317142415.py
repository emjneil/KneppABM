...
def run_all_models():
    ...
    best_results = np.where(final_results['run_number'].isin(accepted_runs),final_results['passed_filters']+1,final_results['passed_filters']) 
    
    final_results['passed_filters'].nlargest(n=2)
    print(best_results)
