...
def run_optimizer():
    ...
    bds = [
        ...
        (0.065,0.2),(0.023,0.2), # saplings
        (0.065,0.2),(0.068,0.2), # young scrub  
        # roe deer parameters
        (0.15,0.3),(0.85,0.94),(0.85,0.94),(0.85,0.94),(0.025,0.14),(0.025,0.12),
        # fallow deer parameters
        (0.3,0.31),(0.9,0.93),(0.89,0.93),(0.86,0.93),(0.01,0.12),(0.01,0.12),
        # red deer parameters
        (0.35,0.4),(0.9,0.93),(0.89,0.93),(0.86,0.93),(0.01,0.12),(0.01,0.12),
        # exmoor pony parameters
        (0.9,0.92),(0.88,0.9),(0.86,0.9),(0.01,0.1),(0.01,0.1),
        # cattle parameters
        (0.19,0.21),(0.89,0.9),(0.88,0.9),(0.86,0.9),(0.01,0.1),(0.01,0.1),
        # pig parameters
        (0.25,0.28),(0.8,0.82),(0.87,0.9),(0.87,0.9),(0.01,0.12),(0.01,0.1)]
