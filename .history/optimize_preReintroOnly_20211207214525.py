...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.02,0.026],[0.075,0.1],[0.02,0.025],[0.0025,0.005],[0.005,0.01],
        # habitat competition
        [0,0.03],[0.05,0.15],[0.025,0.15],[0,0.01],[0,0.001],[0,0.007],[0,0.01],     
        # roe deer parameters
        [0.15,0.25],[0.25,0.5],[0.1,0.5],[0.1,0.5],[0.0025,0.01],[0.0025,0.01]
    ])
