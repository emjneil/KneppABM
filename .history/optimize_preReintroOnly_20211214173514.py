...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.15,0.2],[0.25,0.3],[0.025,0.05],[0.0025,0.005],[0.005,0.008],
        # habitat competition
        [0.0005,0.001],[0.025,0.075],[0.025,0.075],[0.1,0.2],[0.1,0.2],[0.1,0.2],[0.1,0.23],     
        # roe deer parameters
        [0.05,0.25],[0.05,0.25],[0.05,0.25],[0.05,0.25],[0.005,0.025],[0.005,0.025],
