...
def run_optimizer():
    ...
    bds = [
        ...
        (0.055,0.065),(0.025,0.035), # saplings
        (0.045,0.055),(0.055,0.065), # young scrub  
        # roe deer parameters
        (0.18,0.2),(0.87,0.91),(0.87,0.93),(0.87,0.93),(0.14,0.16),(0.11,0.13),
    ...
    initial_guess = [
        ...
        0.90226048, 0.92      , 0.13      , 0.12      , 0.38      ,
        0.90152721, 0.91226621, 0.92      , 0.13      , 0.13      ,
        0.88853249, 0.9       , 0.88      , 0.12      , 0.11319775,
        0.2       , 0.88304486, 0.9       , 0.88      , 0.10273356,
        0.1155    , 0.25023499, 0.78447304, 0.92      , 0.92      ,
        0.11980129, 0.11824327]

    
    res = minimize(objectiveFunction, initial_guess, method='Nelder-Mead', bounds=bds, options={'maxiter': 30})
