...
def run_optimizer():
    ...
    bds = [
        ...
        (0.06,0.075),(0.02,0.04), # saplings
        (0.04,0.06),(0.06,0.075), # young scrub  
        # roe deer parameters
        (0.18,0.2),(0.9,0.91),(0.92,0.93),(0.92,0.93),(0.13,0.14),(0.11,0.14),
        # fallow deer parameters
        (0.34,0.38),(0.85,0.91),(0.85,0.92),(0.85,0.92),(0.1,0.13),(0.09,0.13),
        # red deer parameters
        (0.34,0.38),(0.85,0.95),(0.85,0.92),(0.85,0.92),(0.1,0.13),(0.09,0.13),
        # exmoor pony parameters
        (0.8,0.95),(0.88,0.9),(0.82,0.9),(0.075,0.13),(0.075,0.13),
        # cattle parameters
        (0.18,0.2),(0.85,0.9),(0.88,0.9),(0.83,0.88),(0.075,0.11),(0.075,0.11),
        # pig parameters
        (0.25,0.32),(0.7,0.86),(0.8,0.92),(0.8,0.92),(0.075,0.12),(0.075,0.12)]

    
    initial_guess = [
        # habitats reproduction 
        0.012315  , 0.03907547, 0.08479093, 0.0027    , 0.0155342 ,
        0.01      , 0.175     , 0.17477425, 0.05534157, 0.02575999,
        0.0455012 , 0.05158724, 0.18281812, 0.91      , 0.93      ,
        0.93      , 0.13315906, 0.14940544, 0.34146044, 0.90594704,
        0.90226048, 0.92      , 0.13      , 0.11667841, 0.38      ,
        0.90152721, 0.91226621, 0.92      , 0.13      , 0.13      ,
        0.88853249, 0.9       , 0.9       , 0.13      , 0.11319775,
        0.2       , 0.88304486, 0.9       , 0.88      , 0.10022786,
        0.13      , 0.25023499, 0.78447304, 0.92      , 0.92      ,
