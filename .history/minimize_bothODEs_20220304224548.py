...
def run_optimizer():
    ...
    bds = [
        ...
        # roe deer parameters
        (0.18,0.2),(0.87,0.91),(0.87,0.93),(0.87,0.93),(0.14,0.16),(0.13,0.16),
        # fallow deer parameters
        (0.33,0.35),(0.85,0.91),(0.85,0.92),(0.85,0.92),(0.12,0.14),(0.12,0.14),
        # red deer parameters
        (0.37,0.39),(0.85,0.95),(0.85,0.92),(0.85,0.92),(0.12,0.14),(0.12,0.14),
        # exmoor pony parameters
        (0.8,0.95),(0.82,0.9),(0.82,0.88),(0.11,0.14),(0.11,0.14),
        # cattle parameters
        (0.18,0.22),(0.8,0.9),(0.82,0.9),(0.82,0.88),(0.1,0.13),(0.1,0.13),
        # pig parameters
        (0.25,0.3),(0.75,0.8),(0.9,0.92),(0.9,0.92),(0.11,0.16),(0.11,0.16)]

    
    initial_guess = [
        # habitats reproduction 
        0.012     , 0.039     , 0.08479093, 0.0027    , 0.017     ,
        0.01      , 0.175     , 0.17477425, 0.06      , 0.02575999,
        0.0455012 , 0.06      , 0.18281812, 0.91      , 0.93      ,
        0.93      , 0.13315906, 0.13      , 0.35      , 0.90594704,
