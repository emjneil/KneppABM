...
def run_optimizer():
    ...
    bds = [
        ...
        # roe deer parameters
        (0.19,0.20),(0.93,0.94),(0.92,0.94),(0.92,0.94),(0.11,0.12),(0.08,0.1),
        # fallow deer parameters
        (0.31,0.32),(0.9,0.92),(0.9,0.92),(0.9,0.92),(0.09,0.11),(0.07,0.09),
        # red deer parameters
        (0.37,0.39),(0.9,0.92),(0.89,0.92),(0.89,0.92),(0.085,0.1),(0.07,0.08),
        # exmoor pony parameters
        (0.88,0.9),(0.88,0.91),(0.88,0.9),(0.075,0.09),(0.065,0.075),
        # cattle parameters
        (0.18,0.19),(0.88,0.9),(0.87,0.9),(0.87,0.9),(0.07,0.09),(0.06,0.07),
        # pig parameters
        (0.2,0.22),(0.81,0.87),(0.92,0.94),(0.92,0.94),(0.08,0.11),(0.065,0.1)]
