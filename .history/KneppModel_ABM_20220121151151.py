...
class KneppModel(Model):
    ...
    def __init__(self,             
        ...
        self.datacollector = DataCollector(
                        ...
                        "Trees eaten by roe deer": lambda m: self.count_eaten(m, roeDeer_agent, "scrub"),
                        "Trees eaten by Exmoor pony": lambda m: self.count_eaten(m, exmoorPony, "scrub"),
                        "Trees eaten by Fallow deer": lambda m: self.count_eaten(m, fallowDeer, "scrub"),
                        "Trees eaten by longhorn cattle": lambda m: self.count_eaten(m, longhornCattle, "scrub"),
                        "Trees eaten by red deer": lambda m: self.count_eaten(m, redDeer, "scrub"),
