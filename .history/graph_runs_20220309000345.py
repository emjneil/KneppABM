...
def graph_runs():
    ...
    # histogram of top 5 parameters
    accepted_parameters["parameter1"].hist()
    plt.title("Histogram of [Parameter1]")
    plt.show()
    plt.savefig('/Users/emilyneil/Desktop/KneppABM/many_outputs2/fifty_perc/hist_parameter1.png')

    accepted_parameters["parameter2"].hist()
    plt.title("Histogram of [Parameter2]")
    plt.show()
    plt.savefig('/Users/emilyneil/Desktop/KneppABM/many_outputs2/fifty_perc/hist_parameter2.png')

    accepted_parameters["parameter3"].hist()
    plt.title("Histogram of [Parameter3]")
    plt.show()
    plt.savefig('/Users/emilyneil/Desktop/KneppABM/many_outputs2/fifty_perc/hist_parameter3.png')

    accepted_parameters["parameter4"].hist()
    plt.title("Histogram of [Parameter4]")
    plt.show()
    plt.savefig('/Users/emilyneil/Desktop/KneppABM/many_outputs2/fifty_perc/hist_parameter4.png')

    accepted_parameters["parameter5"].hist()
    plt.title("Histogram of [Parameter5]")
    plt.show()
    plt.savefig('/Users/emilyneil/Desktop/KneppABM/many_outputs2/fifty_perc/hist_parameter5.png')
    ...
    final_df.to_csv("/Users/emilyneil/Desktop/KneppABM/many_outputs2/fifty_perc/combined_df.csv")
    ...
    f.axes[2].vlines(x=134,ymin=115,ymax=165, color='r')
    ...
    f.axes[2].vlines(x=146,ymin=140,ymax=190, color='r')
    ...
    plt.savefig('/Users/emilyneil/Desktop/KneppABM/many_outputs2/fifty_perc/counterfactual.png')
    plt.show()
    ...
    plt.savefig('/Users/emilyneil/Desktop/KneppABM/many_outputs2/fifty_perc/rejected_accepted_runs.png')
    plt.show()
