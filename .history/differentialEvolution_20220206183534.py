...
def run_optimizer():
    ...
    bds = [
        ...
        # red deer parameters
        (0.38,0.5),(0.65,0.7),(0.75,0.8),(0.75,0.8),(0.075,0.2),(0.075,0.2),
        # exmoor pony parameters
        (0.6,0.7),(0.7,0.75),(0.7,0.75),(0.05,0.15),(0.05,0.15),
        # cattle parameters
        (0.1,0.25),(0.6,0.65),(0.7,0.75),(0.7,0.75),(0.05,0.15),(0.05,0.15),
        # # pig parameters
        (0.1,0.35),(0.5,0.6),(0.7,0.8),(0.7,0.8),(0.05,0.15),(0.05,0.15)]
