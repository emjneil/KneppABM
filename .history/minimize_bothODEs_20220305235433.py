...
def run_optimizer():
    ...
    bds = [
        ...
        (0.011,0.014),(0.038,0.041),(0.084,0.085),(0.0027,0.0028),(0.02,0.026),
        (0.01,0.015), # mature scrub competition
        (0.17,0.175),(0.17,0.175), # grass
        (0.05,0.06),(0.02,0.03), # saplings
        ...
        # roe deer parameters
        (0.18,0.2),(0.9,0.93),(0.87,0.95),(0.87,0.95),(0.14,0.16),(0.12,0.2),
        # fallow deer parameters
        (0.33,0.35),(0.9,0.93),(0.89,0.93),(0.85,0.93),(0.12,0.15),(0.1,0.2),
        # red deer parameters
        (0.34,0.37),(0.9,0.93),(0.89,0.93),(0.85,0.93),(0.12,0.15),(0.1,0.2),
        # exmoor pony parameters
        (0.85,0.9),(0.87,0.92),(0.85,0.92),(0.12,0.15),(0.09,0.2),
        # cattle parameters
        (0.18,0.21),(0.87,0.92),(0.85,0.92),(0.82,0.88),(0.12,0.15),(0.09,0.2),
        # pig parameters
        (0.25,0.3),(0.75,0.8),(0.9,0.95),(0.9,0.95),(0.11,0.15),(0.1,0.2)]

    
    initial_guess = [
        # habitats reproduction 
        0.012     , 0.04070625, 0.08479093, 0.0027    , 0.017     ,
        0.01      , 0.175     , 0.17477425, 0.06      , 0.02575999,
        0.0455012 , 0.06      , 0.18281812, 0.91      , 0.93      ,
        0.93      , 0.14      , 0.13      , 0.35      , 0.90594704,
        0.9275    , 0.92      , 0.13      , 0.12      , 0.37      ,
        0.90152721, 0.91226621, 0.92      , 0.13      , 0.13      ,
        0.88853249, 0.9       , 0.88      , 0.12      , 0.11319775,
        0.2       , 0.88304486, 0.9       , 0.88      , 0.12      ,
        0.1155    , 0.25023499, 0.78447304, 0.9275    , 0.92      ,
        0.11980129, 0.11824327   ]

    
    res = minimize(objectiveFunction, initial_guess, method='Nelder-Mead', bounds=bds, options={'maxiter': 10})
