...
def objectiveFunction(x):
    ...
    chance_reproduceSapling = 0.095
    chance_reproduceYoungScrub = 0.099
    chance_regrowGrass = 0.015
    chance_saplingBecomingTree = 0.0041
    chance_youngScrubMatures = 0.0099
    chance_scrubOutcompetedByTree = 0.035
    chance_grassOutcompetedByTree = 0.12
    chance_grassOutcompetedByScrub = 0.1
    chance_saplingOutcompetedByTree = 0.04
    chance_saplingOutcompetedByScrub = 0.00086
    chance_youngScrubOutcompetedByScrub = 0.0097
    chance_youngScrubOutcompetedByTree = 0.015
    # initial values
    initial_roeDeer = 0.08
    initial_grassland = 0.8
    initial_woodland = 0.15
    initial_scrubland = 0.05
    roeDeer_reproduce = 0.21
    roeDeer_gain_from_grass = 0.098
    roeDeer_gain_from_Trees = 0.12
    roeDeer_gain_from_Scrub = 0.47
    roeDeer_gain_from_Saplings = 0.0036
    roeDeer_gain_from_YoungScrub = 0.062
...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0,0.25],[0,0.1],[0,0.1],[0,0.4],[0,0.005],[0,0.05],
        # red deer parameters
        [0,0.25],[0,0.1],[0,0.1],[0,0.4],[0,0.005],[0,0.05],
        # exmoor pony parameters
        [0,0.1],[0,0.1],[0,0.4],[0,0.005],[0,0.05],
        # cattle parameters
        [0,0.25],[0,0.1],[0,0.1],[0,0.4],[0,0.005],[0,0.05],
        # pig parameters
        [0,0.5],[0,0.1],[0,0.005],[0,0.05]
    ])
...
def graph_results():
    ...
    # define the parameters
    chance_reproduceSapling = 0.77
    chance_reproduceYoungScrub = 0.87
    chance_regrowGrass = 0.54
    chance_saplingBecomingTree = 0.00013
    chance_youngScrubMatures = 0.00035
    chance_scrubOutcompetedByTree = 0.082
    chance_grassOutcompetedByTree = 0.098
    chance_grassOutcompetedByScrub = 0.7
    chance_saplingOutcompetedByTree = 0.62
    chance_saplingOutcompetedByScrub = 0.65
    chance_youngScrubOutcompetedByScrub = 0.19
    chance_youngScrubOutcompetedByTree = 0.02
    # initial values
    initial_roeDeer = 0.14
    initial_grassland = 0.75
    initial_woodland = 0.13
    initial_scrubland = 0.034
    roeDeer_reproduce = 0.13
    roeDeer_gain_from_grass = 0.0047
    roeDeer_gain_from_Trees = 0.038
    roeDeer_gain_from_Scrub = 0.036
    roeDeer_gain_from_Saplings = 0.0083
    roeDeer_gain_from_YoungScrub = 0.0065
