...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.01,0.025],[0.01,0.1],[0,0.025],[0.0025,0.005],[0.005,0.01],
        # habitat competition
        [0,0.1],[0,0.01],[0,0.01],[0,0.01],[0,0.001],[0,0.005],[0,0.01],     
        # roe deer parameters
        [0.1,0.25],[0.025,0.25],[0.025,0.25],[0.025,0.25],[0.01,0.25],[0.01,0.25]
    ])
