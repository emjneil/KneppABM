...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.05,0.055],[0.085,0.087],[0.1,0.12],[0.0015,0.002],[0.005,0.0075],
        # habitat competition
        [0.024,0.026], # mature scrub
        [0.15,0.18],[0.13,0.15], # grass
        [0.2,0.25],[0.075,0.15], # saplings
        [0.075,0.15],[0.2,0.25], # young scrub  
        # roe deer parameters
        [0.19,0.21],[0.075,0.15],[0.05,0.15],[0.05,0.15],[0.075,0.15],[0.075,0.15]
    ])
    # chance_saplingBecomingTree = 0.0042
    # chance_youngScrubMatures = 0.0075 [0.0015,0.006],[0.004,0.08],

#  The best solution found:
#  [0.05329263 0.08699296 0.14264183 0.0015179  0.00530936 0.02547167
#  0.09779388 0.09327644 0.08772536 0.05686263 0.04573757 0.0790344
#  0.21773833 0.17539018 0.07627507 0.18070576 0.12712249 0.07023359]
