...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.045,0.06],[0.065,0.074],[0.071,0.073],[0.002,0.0025],[0.0075,0.01],
        # habitat competition
        [0.015,0.025], # mature scrub
        [0.2,0.25],[0.2,0.25], # grass
        [0.25,0.3],[0.15,0.25], # saplings
        [0.15,0.25],[0.25,0.3], # young scrub  
        # roe deer parameters
        [0.17,0.22],[0.1,0.15],[0.1,0.15],[0.1,0.15],[0.075,0.1],[0.075,0.1]
    ])
