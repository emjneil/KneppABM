...
def run_optimizer():
    ...
    (0.0075,0.025),(0.02,0.045),(0.075,0.076),(0.0025,0.003),(0.014,0.017),
    (0.013,0.017), # mature scrub competition
    (0.17,0.18),(0.17,0.18), # grass
    (0.03,0.15),(0.01,0.15), # saplings
    (0.01,0.15),(0.03,0.15), # young scrub  
    # roe deer parameters
    (0.15,0.25),(0.5,1),(0.75,1),(0.75,1),(0.01,1),(0.01,1),
    # fallow deer parameters
    (0.1,0.5),(0.5,1),(0.75,1),(0.75,1),(0.01,0.75),(0.01,0.75),
    # red deer parameters
    (0.1,0.5),(0.5,1),(0.75,1),(0.75,1),(0.01,0.75),(0.01,0.75),
    # exmoor pony parameters
    (0.5,1),(0.75,1),(0.75,1),(0.01,0.75),(0.01,0.75),
    # cattle parameters
    (0.1,0.4),(0.5,1),(0.75,1),(0.75,1),(0.01,0.75),(0.01,0.75),
    # pig parameters
    (0.1,0.5),(0,0.75),(0.75,1),(0.75,1),(0.01,0.75),(0.01,0.75)]
