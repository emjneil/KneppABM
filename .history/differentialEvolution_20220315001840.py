...
def run_optimizer():
    ...
    bds = [
        ...
        # roe deer parameters
        (0.16,0.20),(0.91,0.92),(0.91,0.92),(0.91,0.92),(0.1,0.135),(0.09,0.1),
        # fallow deer parameters
        (0.31,0.32),(0.89,0.91),(0.89,0.91),(0.89,0.91),(0.09,0.12),(0.085,0.095),
        # red deer parameters
        (0.35,0.37),(0.89,0.91),(0.89,0.91),(0.89,0.91),(0.09,0.12),(0.085,0.095),
        # exmoor pony parameters
        (0.88,0.9),(0.88,0.9),(0.88,0.9),(0.075,0.11),(0.075,0.085),
        # cattle parameters
        (0.18,0.19),(0.88,0.91),(0.88,0.9),(0.88,0.9),(0.075,0.11),(0.075,0.085),
        # pig parameters
