...
class habitatAgent (Agent):
    ...
    def step(self):
        ...
        if self.edibles["grass"] - outcompeted_grass_byScrub < 0: outcompeted_grass_byScrub = 0

        outcompeted_grass_byScrub = min(outcompeted_grass_byScrub, 100 - self.edibles['grass'])
        ...
        print(outcompeted_saplings_byScrub)
        outcompeted_saplings_byScrub = min(outcompeted_saplings_byScrub, 5000 - self.edibles['saplings'])
        print(self.edibles["saplings"], outcompeted_saplings_byScrub)
