...
def run_optimizer():
    ...
    bds = [
        ...
        (0.002,0.0025),(0.0024,0.0026),(0.0135,0.014),(0.0021,0.0022),(0.0065,0.007),
        (0.0025,0.0027), # mature scrub competition
        (0.094,0.095),(0.093,0.094), # grass
        (0.004,0.005),(0.0015,0.0025), # saplings
        (0.004,0.005),(0.004,0.0065), # young scrub  
        # roe deer parameters
        (0.16,0.19),(0.93,0.95),(0.91,0.92),(0.91,0.92),(0.12,0.13),(0.085,0.1),
        # fallow deer parameters
        (0.31,0.32),(0.92,0.93),(0.89,0.91),(0.89,0.91),(0.1,0.12),(0.075,0.085),
        # red deer parameters
        (0.355,0.365),(0.91,0.93),(0.89,0.91),(0.89,0.91),(0.1,0.12),(0.07,0.08),
        # exmoor pony parameters
        (0.88,0.91),(0.89,0.9),(0.88,0.9),(0.075,0.11),(0.05,0.075),
        # cattle parameters
        (0.185,0.19),(0.88,0.9),(0.88,0.9),(0.89,0.91),(0.075,0.11),(0.05,0.075),
        # pig parameters
        (0.25,0.32),(0.86,0.88),(0.9,0.94),(0.9,0.94),(0.075,0.13),(0.05,0.1)]
