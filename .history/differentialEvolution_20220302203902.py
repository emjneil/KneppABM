...
def run_optimizer():
    ...
    bds = [
        ...
        # roe deer parameters
        (0.18,0.2),(0.85,0.93),(0.85,0.93),(0.85,0.93),(0.05,0.2),(0.05,0.2),
        # fallow deer parameters
        (0.33,0.41),(0.89,0.95),(0.85,0.93),(0.85,0.93),(0.05,0.2),(0.05,0.2),
        # red deer parameters
        (0.38,0.405),(0.85,0.94),(0.85,0.93),(0.85,0.93),(0.05,0.2),(0.05,0.2),
        # exmoor pony parameters
        (0.9,0.95),(0.85,0.95),(0.85,0.92),(0.05,0.2),(0.05,0.2),
        # cattle parameters
        (0.17,0.22),(0.88,0.95),(0.85,0.93),(0.85,0.93),(0.05,0.2),(0.05,0.2),
        # pig parameters
        (0.3,0.37),(0.8,0.83),(0.85,0.94),(0.85,0.94),(0.05,0.2),(0.05,0.2)]
