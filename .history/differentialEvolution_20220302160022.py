...
def run_optimizer():
    ...
    bds = [
        ...
        # roe deer parameters
        (0.18,0.2),(0.9,0.95),(0.9,0.93),(0.9,0.93),(0.15,0.2),(0.1,0.15),
        # fallow deer parameters
        (0.37,0.41),(0.89,0.94),(0.88,0.93),(0.89,0.93),(0.08,0.15),(0.05,0.15),
        # red deer parameters
        (0.38,0.405),(0.89,0.94),(0.88,0.93),(0.89,0.93),(0.08,0.15),(0.05,0.15),
        # exmoor pony parameters
        (0.9,0.93),(0.88,0.92),(0.87,0.92),(0.05,0.15),(0.075,0.14),
        # cattle parameters
        (0.15,0.22),(0.9,0.93),(0.87,0.92),(0.88,0.92),(0.075,0.15),(0.05,0.14),
        # pig parameters
