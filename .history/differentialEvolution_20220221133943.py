...
def run_optimizer():
    ...
    # roe deer parameters
    (0.15,0.25),(0.5,1),(0.82,0.83),(0.82,0.83),(0.14,0.16),(0.14,0.16),
    # fallow deer parameters
    (0.1,0.5),(0.5,1),(0.81,0.82),(0.81,0.82),(0.13,0.15),(0.13,0.15),
    # red deer parameters
    (0.1,0.5),(0.5,1),(0.8,0.82),(0.8,0.82),(0.12,0.15),(0.12,0.15),
    # exmoor pony parameters
    (0.5,1),(0.5,1),(0.78,0.8),(0.11,0.14),(0.11,0.14),
    # cattle parameters
    (0.1,0.4),(0.5,1),(0.77,0.8),(0.77,0.8),(0.1,0.14),(0.1,0.14),
    # pig parameters
