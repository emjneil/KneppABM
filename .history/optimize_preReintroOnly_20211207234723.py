...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.1,0.13],[0.15,0.2],[0.02,0.025],[0.0025,0.005],[0.005,0.01],
        # habitat competition
        [0.03,0.04],[0.025,0.1],[0.025,0.1],[0.01,0.02],[0.001,0.005],[0.001,0.01],[0.01,0.02],     
        # roe deer parameters
        [0.15,0.25],[0.1,0.5],[0.1,0.5],[0.1,0.5],[0.0025,0.01],[0.0025,0.01]
    ])
...
#  The best solution found:                                                                           
#  [0.1142116  0.11624582 0.02116522 0.00251198 0.0080807  0.03289605
#  0.09225429 0.03484386 0.01637971 0.0037667  0.00685413 0.01541325
#  0.19869669 0.23335866 0.49650928 0.4312432  0.00252353 0.00846222]
