...
def run_optimizer():
    ...
    bds = [
        ...
        (0.0025,0.0045),(0.0025,0.0045),(0.0135,0.014),(0.0023,0.0024),(0.0086,0.0087),
        (0.00065,0.0015), # mature scrub competition
        (0.094,0.095),(0.093,0.094), # grass
        (0.035,0.1),(0.01,0.025), # saplings
        (0.035,0.1),(0.035,0.1), # young scrub  
        # roe deer parameters
