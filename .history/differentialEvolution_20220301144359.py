...
def run_optimizer():
    ...
    bds = [
        ...
        (0.01,0.012),(0.038,0.042),(0.084,0.085),(0.0027,0.0028),(0.014,0.0145),
        (0.016,0.017), # mature scrub competition
        (0.17,0.175),(0.17,0.175), # grass
        (0.04,0.06),(0.03,0.05), # saplings
        (0.03,0.05),(0.04,0.06), # young scrub  
        # roe deer parameters
        (0.18,0.2),(0.94,0.95),(0.92,0.93),(0.92,0.93),(0.14,0.16),(0.14,0.16),
        # fallow deer parameters
        (0.36,0.42),(0.9,0.94),(0.9,0.93),(0.9,0.93),(0.13,0.14),(0.13,0.14),
        # red deer parameters
        (0.38,0.405),(0.9,0.94),(0.9,0.93),(0.9,0.93),(0.12,0.14),(0.12,0.14),
