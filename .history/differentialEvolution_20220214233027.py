...
def run_optimizer():
    ...
    bds = [
        ...
        (0.33,0.42),(0.7,0.8),(0.75,0.8),(0.75,0.8),(0.075,0.16),(0.075,0.16),
        # red deer parameters
        (0.33,0.42),(0.68,0.8),(0.75,0.8),(0.75,0.8),(0.075,0.15),(0.075,0.15),
        # exmoor pony parameters
        (0.63,0.75),(0.73,0.78),(0.73,0.78),(0.05,0.14),(0.05,0.14),
        # cattle parameters
        (0.18,0.25),(0.65,0.7),(0.72,0.76),(0.72,0.76),(0.05,0.13),(0.05,0.13),
        # # pig parameters
