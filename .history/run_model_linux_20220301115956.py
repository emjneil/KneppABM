...
#      fun: 7609.0
        ...
        chance_reproduceSapling = 0.01231498
        chance_reproduceYoungScrub = 0.03903877
        chance_regrowGrass = 0.08479035
        chance_saplingBecomingTree = 0.00263711
        chance_youngScrubMatures = 0.01514143
        chance_scrubOutcompetedByTree = 0.01632931
        chance_grassOutcompetedByTree = 0.17617216
        chance_grassOutcompetedByScrub = 0.17476992
        chance_saplingOutcompetedByTree = 0.05548632
        chance_saplingOutcompetedByScrub = 0.0257358
        chance_youngScrubOutcompetedByScrub = 0.04560602
        chance_youngScrubOutcompetedByTree = 0.05165619
        ...
        # roe deer
        roeDeer_reproduce = 0.18264644
        roeDeer_gain_from_grass = 0.9342863
        roeDeer_gain_from_Trees = 0.93408981
        roeDeer_gain_from_Scrub = 0.93157463
        roeDeer_gain_from_Saplings = 0.13303401
        roeDeer_gain_from_YoungScrub = 0.149385
        # Fallow deer
        fallowDeer_reproduce = 0.38174276
        fallowDeer_gain_from_grass = 0.90586939
        fallowDeer_gain_from_Trees = 0.9019206
        fallowDeer_gain_from_Scrub = 0.92603123
        fallowDeer_gain_from_Saplings = 0.13661793
        fallowDeer_gain_from_YoungScrub = 0.11656884
        # Red deer
        redDeer_reproduce = 0.40810051
        redDeer_gain_from_grass = 0.9006806
        redDeer_gain_from_Trees = 0.90510545
        redDeer_gain_from_Scrub = 0.92069408
        redDeer_gain_from_Saplings = 0.13561093
        redDeer_gain_from_YoungScrub = 0.14271593
        # Exmoor ponies
        ponies_gain_from_grass = 0.89107578
        ponies_gain_from_Trees = 0.90619935
        ponies_gain_from_Scrub = 0.90198161
        ponies_gain_from_Saplings = 0.132171
        ponies_gain_from_YoungScrub = 0.11316225
        # Longhorn cattle
        cows_reproduce = 0.21865324
        cows_gain_from_grass = 0.88272001
        cows_gain_from_Trees = 0.90780963
        cows_gain_from_Scrub = 0.91655279
        cows_gain_from_Saplings = 0.10013374
        cows_gain_from_YoungScrub = 0.1493697
        # Tamworth pigs
        pigs_reproduce = 0.19007943
        pigs_gain_from_grass = 0.78373635
        pigs_gain_from_Trees = 0.937337
        pigs_gain_from_Scrub = 0.93462533
        pigs_gain_from_Saplings = 0.12009254
        pigs_gain_from_YoungScrub = 0.11813223
    ...
    accepted_parameters.to_csv('/Users/emilyneil/Desktop/KneppABM/many_outputs/ten_perc/accepted_parameters.csv')
