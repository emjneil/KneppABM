...
class habitatAgent (Agent):
    def __init__(self, unique_id, pos, model, condition, trees_here, saplings_here, scrub_here, youngscrub_here, perc_grass_here, perc_bareground_here):
        ...
        self.scrub_deaths["scrub competition"] = 0
        self.scrub_deaths["tree competition"] = 0
        self.scrub_deaths["eaten by roe"] = 0

        self.sapling_deaths["scrub competition"] = 0
        self.sapling_deaths["tree competition"] = 0
