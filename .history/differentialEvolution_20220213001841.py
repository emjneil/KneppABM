...
def run_optimizer():
    ...
    bds = [
        ...
        (0.01,0.015),(0.035,0.04),(0.075,0.078),(0.0027,0.0035),(0.015,0.02),
        (0.015,0.025), # mature scrub competition
        (0.085,0.087),(0.085,0.087), # grass
        (0.05,0.09),(0.02,0.09), # saplings
        (0.03,0.09),(0.05,0.09), # young scrub  
        ...
        # # pig parameters
        (0.17,0.25),(0.5,0.65),(0.75,0.85),(0.75,0.85),(0.1,0.2),(0.1,0.2)]
