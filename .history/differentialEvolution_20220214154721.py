...
def run_optimizer():
    ...
    bds = [
        ...
        # roe deer parameters
        (0.18,0.22),(0.75,0.95),(0.8,0.95),(0.8,0.95),(0.14,0.18),(0.14,0.18),
        # fallow deer parameters
        (0.33,0.42),(0.7,0.75),(0.75,0.8),(0.75,0.8),(0.12,0.16),(0.12,0.16),
        # red deer parameters
        (0.33,0.42),(0.68,0.73),(0.75,0.8),(0.75,0.8),(0.12,0.15),(0.12,0.15),
        # exmoor pony parameters
        (0.63,0.71),(0.73,0.78),(0.73,0.78),(0.1,0.14),(0.1,0.14),
        # cattle parameters
        (0.18,0.25),(0.65,0.7),(0.72,0.76),(0.72,0.76),(0.1,0.13),(0.1,0.13),
        # # pig parameters
        (0.17,0.25),(0.5,0.65),(0.75,0.85),(0.75,0.85),(0.1,0.18),(0.1,0.18)]
