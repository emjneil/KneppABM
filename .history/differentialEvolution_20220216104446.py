...
def run_optimizer():
    ...
    bds = [
        ...
        (0.0075,0.017),(0.035,0.05),(0.075,0.076),(0.0023,0.003),(0.01,0.02),
        (0.015,0.018), # mature scrub competition
        (0.17,0.2),(0.17,0.2), # grass
        (0.06,0.09),(0.01,0.045), # saplings
        (0.03,0.045),(0.06,0.09), # young scrub  

        # roe deer parameters
        (0.18,0.21),(0.8,0.85),(0.8,0.85),(0.8,0.85),(0.12,0.18),(0.12,0.18),
