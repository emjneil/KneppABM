...
def run_optimizer():
    ...
    bds = [
        ...
        # roe deer parameters
        (0.18,0.2),(0.87,0.91),(0.87,0.93),(0.87,0.93),(0.14,0.16),(0.13,0.15),
        # fallow deer parameters
        (0.33,0.35),(0.85,0.91),(0.85,0.92),(0.85,0.92),(0.12,0.14),(0.1,0.13),
        # red deer parameters
        (0.37,0.38),(0.85,0.95),(0.85,0.92),(0.85,0.92),(0.12,0.14),(0.1,0.13),
        # exmoor pony parameters
        (0.8,0.95),(0.82,0.9),(0.82,0.88),(0.1,0.14),(0.1,0.13),
        # cattle parameters
        (0.18,0.22),(0.8,0.9),(0.82,0.9),(0.82,0.88),(0.09,0.14),(0.1,0.13),
        # pig parameters
