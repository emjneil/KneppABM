...
def run_optimizer():
    ...
    bds = [
        ...
        # roe deer parameters
        (0.18,0.2),(0.9,0.91),(0.9,0.91),(0.9,0.91),(0.13,0.15),(0.13,0.15),
        # fallow deer parameters
        (0.25,0.35),(0.85,0.9),(0.85,0.9),(0.85,0.9),(0.12,0.14),(0.12,0.14),
        # red deer parameters
        (0.38,0.41),(0.87,0.9),(0.87,0.9),(0.87,0.9),(0.12,0.14),(0.12,0.14),
        # exmoor pony parameters
        (0.82,0.88),(0.82,0.9),(0.82,0.9),(0.11,0.14),(0.11,0.14),
        # cattle parameters
        (0.17,0.22),(0.81,0.85),(0.81,0.85),(0.81,0.85),(0.1,0.14),(0.1,0.14),
        # pig parameters
