...
def objectiveFunction(x):
    ...
    if filtered_result < 250000:
        ...
        with pd.option_context('display.max_columns',None):
            just_nodes = results[results['Time'] == 134]  # 140
            just_nodes = results[results['Time'] == 146] # 165
            just_nodes = results[results['Time'] == 158] # 251
            just_nodes = results[results['Time'] == 170] # 278
...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.15,0.35],[0.05,0.17],[0.01,0.2],[0.01,0.2],[0.005,0.014],[0.005,0.01],
        # # red deer parameters
