...
# Who's eating what
    ...
    habitat_type = np.tile(["Sapling", "Sapling", "Sapling", "Sapling","Sapling", "Sapling", "Sapling", "Sapling", "Sapling"], 185) 
    ...
    {'Time': sapling_df, 'Ecosystem Element': habitat_type, 'Death By': death_by, 'Amount Died': amount_killed})
