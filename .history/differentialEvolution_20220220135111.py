...
def run_optimizer():
    ...
    bds = [
        ...
        (0.01,0.012),(0.038,0.042),(0.075,0.076),(0.0025,0.003),(0.015,0.018),
        (0.013,0.017), # mature scrub competition
        (0.17,0.18),(0.17,0.18), # grass
        (0.035,0.055),(0.015,0.02), # saplings
        (0.03,0.043),(0.035,0.055), # young scrub  
        # roe deer parameters
        (0.18,0.2),(0.8,0.82),(0.82,0.83),(0.82,0.83),(0.14,0.15),(0.14,0.15),
        # fallow deer parameters
        (0.34,0.37),(0.79,0.81),(0.81,0.82),(0.81,0.82),(0.13,0.14),(0.13,0.14),
        # red deer parameters
        (0.39,0.41),(0.78,0.8),(0.79,0.82),(0.79,0.82),(0.12,0.14),(0.12,0.14),
        # exmoor pony parameters
        (0.76,0.77),(0.78,0.79),(0.78,0.79),(0.11,0.13),(0.11,0.13),
        # cattle parameters
        (0.19,0.22),(0.75,0.76),(0.77,0.78),(0.77,0.78),(0.1,0.13),(0.1,0.13),
        # pig parameters
        (0.18,0.25),(0.63,0.75),(0.8,0.85),(0.8,0.85),(0.12,0.14),(0.12,0.14)]
