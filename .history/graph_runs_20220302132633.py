...
def graph_runs():
    ...
    final_df.to_csv("/Users/emilyneil/Desktop/KneppABM/many_outputs/five_perc/combined_df.csv")
    ...
    plt.savefig('/Users/emilyneil/Desktop/KneppABM/many_outputs/five_perc/counterfactual.png')
    plt.show()
    ...
    plt.savefig('/Users/emilyneil/Desktop/KneppABM/many_outputs/five_perc/rejected_accepted_runs.png')
    plt.show()
