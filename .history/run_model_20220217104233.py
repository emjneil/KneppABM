...
def run_all_models():
    ...
    for _ in range(number_simulations):
        ...
        pigs_gain_from_Trees = random.uniform((output_parameters[43]-(output_parameters[43]*perc_aboveBelow)), (output_parameters["variable"][43]+(output_parameters["variable"][43]*perc_aboveBelow)))
        pigs_gain_from_Scrub = random.uniform((output_parameters[43]-(output_parameters[43]*perc_aboveBelow)), (output_parameters["variable"][43]+(output_parameters["variable"][43]*perc_aboveBelow)))

        pigs_gain_from_Saplings = random.uniform((output_parameters[43]-(output_parameters[43]*perc_aboveBelow)), (output_parameters["variable"][43]+(output_parameters["variable"][43]*perc_aboveBelow)))
