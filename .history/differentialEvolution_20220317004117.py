...
def run_optimizer():
    ...
    bds = [
        ...
        (0.0025,0.0032),(0.0025,0.0032),(0.0135,0.014),(0.0021,0.0022),(0.0067,0.007),
        (0.0025,0.0027), # mature scrub competition
        (0.094,0.095),(0.093,0.094), # grass
        (0.0055,0.0065),(0.0025,0.0035), # saplings
        (0.0055,0.0065),(0.0055,0.0065), # young scrub  
        # roe deer parameters
        (0.16,0.19),(0.93,0.94),(0.93,0.94),(0.92,0.94),(0.1,0.12),(0.09,0.11),
        # fallow deer parameters
        (0.31,0.32),(0.92,0.93),(0.92,0.93),(0.92,0.93),(0.08,0.12),(0.08,0.1),
        # red deer parameters
        (0.34,0.354),(0.92,0.93),(0.91,0.93),(0.91,0.93),(0.075,0.12),(0.08,0.1),
        # exmoor pony parameters
        (0.91,0.92),(0.9,0.92),(0.9,0.92),(0.08,0.11),(0.08,0.1),
        # cattle parameters
        (0.19,0.195),(0.88,0.92),(0.89,0.92),(0.89,0.92),(0.075,0.11),(0.075,0.11),
        # pig parameters
        (0.29,0.31),(0.86,0.88),(0.93,0.95),(0.93,0.95),(0.09,0.12),(0.09,0.11)]
