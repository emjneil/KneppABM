...
def run_optimizer():
    ...
    bds = [
        ...
        # roe deer parameters
        (0.18,0.2),(0.85,0.91),(0.88,0.95),(0.88,0.95),(0.1,0.15),(0.1,0.15),
        # fallow deer parameters
        (0.39,0.41),(0.8,0.95),(0.8,0.95),(0.8,0.95),(0.05,0.2),(0.05,0.2),
        # red deer parameters
        (0.38,0.41),(0.8,0.95),(0.8,0.95),(0.8,0.95),(0.075,0.2),(0.075,0.2),
