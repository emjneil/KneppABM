...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.01,0.025],[0.015,0.05],[0.02,0.025],[0.0025,0.005],[0.005,0.01],
        # habitat competition
        [0.0075,0.03],[0.05,0.15],[0.025,0.15],[0.01,0.035],[0.0001,0.001],[0.001,0.007],[0.01,0.1],     
        # roe deer parameters
        [0.1,0.25],[0.1,0.5],[0.1,0.5],[0.1,0.5],[0.0025,0.01],[0.0025,0.01]
    ])
