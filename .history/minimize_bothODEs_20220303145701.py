...
def run_optimizer():
    ...
    bds = [
        ...
        (0.38,0.5),(0.89,0.95),(0.85,0.95),(0.85,0.95),(0.05,0.2),(0.05,0.2),
        # red deer parameters
        (0.37,0.41),(0.85,0.95),(0.85,0.95),(0.85,0.95),(0.05,0.2),(0.05,0.2),
        # exmoor pony parameters
        (0.85,0.95),(0.8,0.95),(0.8,0.95),(0.05,0.2),(0.05,0.2),
        # cattle parameters
        (0.17,0.21),(0.85,0.95),(0.8,0.95),(0.8,0.95),(0.05,0.15),(0.05,0.2),
        # pig parameters
        (0.25,0.32),(0.8,0.86),(0.8,0.92),(0.8,0.92),(0.05,0.2),(0.05,0.2)]
