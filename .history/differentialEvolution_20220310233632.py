...
def run_optimizer():
    ...
    bds = [
        ...
        # roe deer parameters
        (0.18,0.2),(0.9,0.95),(0.85,0.95),(0.85,0.95),(0.12,0.14),(0.1,0.12),
        # fallow deer parameters
        (0.3,0.31),(0.9,0.93),(0.85,0.93),(0.85,0.93),(0.1,0.12),(0.08,0.11),
        # red deer parameters
        (0.33,0.37),(0.9,0.93),(0.85,0.93),(0.85,0.93),(0.1,0.12),(0.08,0.11),
