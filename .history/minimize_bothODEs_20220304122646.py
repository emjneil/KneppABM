...
def run_optimizer():
    ...
    bds = [
        ...
        (0.06,0.07),(0.025,0.03), # saplings
        (0.045,0.05),(0.06,0.07), # young scrub  
        # roe deer parameters
        (0.18,0.2),(0.9,0.91),(0.92,0.93),(0.92,0.93),(0.13,0.14),(0.11,0.14),
        # fallow deer parameters
        (0.33,0.35),(0.85,0.91),(0.85,0.92),(0.85,0.92),(0.1,0.13),(0.1,0.13),
        # red deer parameters
        (0.37,0.38),(0.85,0.95),(0.85,0.92),(0.85,0.92),(0.1,0.13),(0.1,0.13),
        # exmoor pony parameters
        (0.8,0.95),(0.88,0.9),(0.82,0.9),(0.075,0.13),(0.075,0.13),
        # cattle parameters
        (0.18,0.22),(0.85,0.9),(0.88,0.9),(0.83,0.88),(0.075,0.11),(0.075,0.11),
        # pig parameters
