...
def run_optimizer():
    ...
    bds = [
        ...
        (0.01,0.012),(0.035,0.037),(0.075,0.076),(0.0025,0.003),(0.019,0.021),
        (0.014,0.016), # mature scrub competition
        (0.17,0.18),(0.17,0.18), # grass
        (0.05,0.06),(0.025,0.04), # saplings
        (0.03,0.05),(0.05,0.06), # young scrub  
        # roe deer parameters
        (0.17,0.19),(0.9,0.91),(0.9,0.91),(0.9,0.91),(0.14,0.17),(0.14,0.17),
        # fallow deer parameters
        (0.25,0.35),(0.87,0.9),(0.85,0.9),(0.85,0.9),(0.13,0.16),(0.13,0.16),
        # red deer parameters
        (0.38,0.41),(0.86,0.9),(0.87,0.9),(0.87,0.9),(0.13,0.15),(0.13,0.15),
        # exmoor pony parameters
        (0.83,0.88),(0.85,0.9),(0.83,0.9),(0.12,0.15),(0.12,0.15),
        # cattle parameters
        (0.17,0.21),(0.85,0.88),(0.83,0.85),(0.83,0.85),(0.11,0.15),(0.11,0.15),
        # pig parameters
