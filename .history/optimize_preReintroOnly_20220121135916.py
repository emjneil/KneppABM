...
def graph_results():
    ...
    {'Time': stacked_time, 'Ecosystem Element': stacked_eco_element, 'Abundance': stacked_habitats, 'Grown saplings': grown_saplings_tiled, 'Grown Young Scrub': grown_youngScrub_tiled, 'Grass Outcompeted by Tree': outcompeted_grass_tiled, 'Scrub Outcompeted by Tree': outcompeted_scrub_tiled, 'Sapling Outcompeted by Tree': outcompeted_sapling_tiled, 'Young Scrub Outcompeted by Tree': outcompeted_youngScrub_tiled, 
