...
def graph_results():
    ...
    habitat_type = np.tile(["Sapling", "Sapling", "Sapling", "Sapling","Sapling", "Sapling", "Sapling", "Sapling", "Sapling", "Young Scrub", "Young Scrub", "Young Scrub", "Young Scrub", "Grass", "Grass", "Grass", "Scrub", "Scrub", "Tree"], 51) 
