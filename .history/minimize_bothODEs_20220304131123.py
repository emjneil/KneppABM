...
def run_optimizer():
    ...
    bds = [
        ...
        (0.01,0.012),(0.038,0.04),(0.084,0.085),(0.0027,0.0028),(0.014,0.016),
        (0.01,0.013), # mature scrub competition
        (0.17,0.175),(0.17,0.175), # grass
        (0.06,0.07),(0.025,0.035), # saplings
        (0.045,0.05),(0.06,0.07), # young scrub  
        # roe deer parameters
        (0.18,0.2),(0.9,0.91),(0.92,0.93),(0.92,0.93),(0.11,0.13),(0.1,0.13),
        # fallow deer parameters
        (0.33,0.35),(0.85,0.91),(0.85,0.92),(0.85,0.92),(0.09,0.13),(0.09,0.13),
        # red deer parameters
        (0.37,0.38),(0.85,0.95),(0.85,0.92),(0.85,0.92),(0.09,0.13),(0.09,0.13),
        # exmoor pony parameters
        (0.8,0.95),(0.88,0.9),(0.82,0.9),(0.09,0.12),(0.08,0.12),
        # cattle parameters
        (0.18,0.22),(0.85,0.9),(0.88,0.9),(0.83,0.88),(0.09,0.12),(0.08,0.12),
        # pig parameters
        (0.25,0.3),(0.75,0.8),(0.9,0.92),(0.9,0.92),(0.09,0.13),(0.09,0.13)]
