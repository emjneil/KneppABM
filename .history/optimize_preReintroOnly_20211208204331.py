...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.05,0.5],[0.05,0.5],[0.001,0.1],[0.0025,0.005],[0.005,0.01],
        # habitat competition
        [0,0.01],[0,0.25],[0,0.25],[0.05,0.25],[0,0.005],[0,0.01],[0.05,0.25],     
        # roe deer parameters
        [0.1,0.25],[0,0.25],[0,0.25],[0,0.25],[0.005,0.1],[0.005,0.1]
    ])
