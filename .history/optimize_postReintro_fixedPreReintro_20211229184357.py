...
def objectiveFunction(x):
    ...
    if filtered_result < 2500:
        ...
        with pd.option_context('display.max_columns',None):
            ...
            print(just_nodes1[["Tamworth pigs"]])
            print(just_nodes2[["Tamworth pigs"]])
            print(just_nodes3[["Tamworth pigs"]])
...
def run_optimizer():
    ...
    bds = np.array([
        ...
        # # cattle parameters
        [0.05,0.3],[0.025,0.075],[0.025,0.075],[0.025,0.075],[0.0005,0.001],[0.0005,0.001]
        # # pig parameters
