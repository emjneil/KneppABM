...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.05,0.08],[0.07,0.08],[0.1,0.12],[0.0015,0.006],[0.004,0.08],
        # habitat competition
        [0.023,0.075], # mature scrub
        [0.09,0.1],[0.09,0.1], # grass
        [0.08,0.15],[0.02,0.15], # saplings
        [0.04,0.15],[0.08,0.15], # young scrub  
        # roe deer parameters
        [0.15,0.22],[0.1,0.25],[0.15,0.25],[0.15,0.25],[0.1,0.2],[0.1,0.2]
    ])
