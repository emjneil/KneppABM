...
def run_optimizer():
    ...
    bds = [
        ...
        (0.01,0.02),(0.025,0.04),(0.05,0.08),(0.002,0.004),(0.008,0.025),
        ...
        # roe deer parameters
        (0.18,0.22),(0.75,0.8),(0.8,0.9),(0.8,0.9),(0.15,0.25),(0.15,0.25),
        # fallow deer parameters
        (0.3,0.45),(0.7,0.75),(0.75,0.9),(0.75,0.9),(0.1,0.25),(0.1,0.25),
        # red deer parameters
        (0.3,0.45),(0.65,0.7),(0.75,0.85),(0.75,0.85),(0.1,0.25),(0.1,0.25),
        # exmoor pony parameters
        (0.6,0.7),(0.7,0.8),(0.7,0.8),(0.05,0.15),(0.05,0.2),
        # cattle parameters
        (0.15,0.3),(0.6,0.65),(0.65,0.8),(0.65,0.8),(0.05,0.2),(0.05,0.2),
        # # pig parameters
