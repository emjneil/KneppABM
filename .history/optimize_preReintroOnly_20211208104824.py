...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.01,0.02],[0.05,0.075],[0.02,0.025],[0.0025,0.005],[0.005,0.01],
        # habitat competition
        [0.05,0.06],[0.025,0.1],[0.025,0.1],[0.0001,0.0007],[0,0.001],[0.001,0.01],[0,0.01],     
        # roe deer parameters
        [0.1,0.25],[0.025,0.05],[0.025,0.05],[0.025,0.05],[0.007,0.05],[0.007,0.05]
    ])
...
#  The best solution found:                                                                           
#  [4.96531853e-02 1.77509169e-01 2.07079196e-02 3.44369410e-03
#  6.61611666e-03 7.26010014e-02 6.34316753e-02 4.39040345e-02
#  9.89029607e-04 4.15537399e-04 9.22820802e-03 9.38349250e-03
#  2.00265590e-01 2.11746251e-01 3.38927159e-01 4.68146197e-01
#  5.45040023e-03 9.95940811e-03]
