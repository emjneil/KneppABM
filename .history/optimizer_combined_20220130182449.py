...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.35,0.45],[0.6,0.75],[0.6,0.75],[0.6,0.75],[0.14,0.2],[0.14,0.2],
        # red deer parameters
        [0.28,0.4],[0.55,0.7],[0.55,0.7],[0.55,0.7],[0.1,0.17],[0.1,0.17],
        # exmoor pony parameters
        [0.5,0.7],[0.5,0.7],[0.5,0.7],[0.075,0.15],[0.075,0.15],
        # cattle parameters
        [0.15,0.25],[0.4,0.65],[0.4,0.65],[0.4,0.65],[0.05,0.15],[0.05,0.15],
        # # pig parameters
        [0.05,0.15],[0.05,0.5],[0.55,0.75],[0.55,0.75],[0.01,0.25],[0.01,0.25]
    ])
