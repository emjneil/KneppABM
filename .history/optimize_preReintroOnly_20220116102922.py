...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.05,0.057],[0.084,0.09],[0.1,0.14],[0.0015,0.005],[0.00041,0.03],
        # habitat competition
        [0.023,0.029], # mature scrub
        [0.09,0.1],[0.085,0.095], # grass
        [0.09,0.15],[0.01,0.06], # saplings
        [0.04,0.07],[0.075,0.15], # young scrub  
        # roe deer parameters
        [0.15,0.23],[0.05,0.25],[0.05,0.15],[0.05,0.15],[0.05,0.15],[0.05,0.15]
    ])
