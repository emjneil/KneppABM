...
def run_all_models():
    ...
    # (filtered_preReintro["Tamworth pigs"] <= 21) & (filtered_preReintro["Tamworth pigs"] >= 17) &
    ...
    with pd.option_context('display.max_columns',None):
        print(final_results[(final_results["Time", "Roe deer", "Exmoor pony", "Fallow deer", "Longhorn cattle", "Red deer", "Tamworth pigs", "Grassland", "Woodland", "Thorny Scrub", "Bare ground"] == 184)])
