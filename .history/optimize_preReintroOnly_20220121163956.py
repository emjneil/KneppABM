...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.025,0.075],[0.025,0.075],[0.075,0.1],[0.0017,0.004],[0.005,0.06],
        # habitat competition
        [0.01,0.025], # mature scrub
        [0.05,0.1],[0.05,0.1], # grass
        [0.01,0.1],[0.01,0.05], # saplings
        [0.01,0.05],[0.01,0.1], # young scrub  
        # roe deer parameters
        [0.15,0.22],[0.2,0.5],[0.2,0.5],[0.2,0.5],[0.2,0.5],[0.2,0.5]
    ])
