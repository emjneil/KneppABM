...
def run_optimizer():
    ...
    bds = [
        ...
        (0.003,0.006),(0.003,0.006),(0.01,0.025),(0.0021,0.0027),(0.0053,0.01),
        (0.001,0.0015), # mature scrub competition
        (0.075,0.1),(0.075,0.1), # grass
        (0.09,0.1),(0.01,0.025), # saplings
        (0.05,0.1),(0.09,0.1), # young scrub  
        # roe deer parameters
        (0.17,0.25),(0.89,0.94),(0.89,0.94),(0.89,0.94),(0.075,0.1),(0.05,0.1),
        # fallow deer parameters
        (0.3,0.31),(0.85,0.93),(0.8,0.93),(0.8,0.93),(0.03,0.09),(0.03,0.09),
        # red deer parameters
        (0.3,0.4),(0.85,0.93),(0.8,0.93),(0.8,0.93),(0.03,0.09),(0.03,0.09),
