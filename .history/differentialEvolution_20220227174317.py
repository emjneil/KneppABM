...
def run_optimizer():
    ...
    bds = [
        ...
        (0.011,0.012),(0.041,0.042),(0.084,0.085),(0.0027,0.0028),(0.014,0.0145),
        (0.016,0.017), # mature scrub competition
        (0.17,0.175),(0.17,0.175), # grass
        (0.05,0.052),(0.043,0.045), # saplings
        (0.045,0.047),(0.051,0.053), # young scrub  
        # roe deer parameters
        (0.18,0.2),(0.93,0.94),(0.92,0.93),(0.92,0.93),(0.14,0.16),(0.14,0.16),
        # fallow deer parameters
        (0.38,0.39),(0.9,0.93),(0.9,0.93),(0.9,0.93),(0.14,0.2),(0.13,0.2),
        # red deer parameters
        (0.38,0.405),(0.9,0.93),(0.9,0.93),(0.9,0.93),(0.12,0.14),(0.12,0.14),
        # exmoor pony parameters
        (0.88,0.91),(0.88,0.92),(0.88,0.92),(0.12,0.14),(0.12,0.14),
        # cattle parameters
        (0.19,0.22),(0.88,0.91),(0.88,0.92),(0.88,0.92),(0.12,0.13),(0.12,0.13),
        # pig parameters
        (0.15,0.35),(0.8,0.83),(0.93,0.94),(0.93,0.94),(0.13,0.15),(0.13,0.15)]
