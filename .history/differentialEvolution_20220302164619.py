...
def run_optimizer():
    ...
    bds = [
        ...
        (0.01,0.015),(0.03,0.045),(0.084,0.085),(0.0027,0.0028),(0.014,0.02),
        ...
        # roe deer parameters
        (0.18,0.2),(0.9,0.95),(0.9,0.93),(0.9,0.93),(0.15,0.16),(0.1,0.13),
        ...
        (0.9,0.93),(0.88,0.92),(0.87,0.92),(0.075,0.14),(0.075,0.12),
        # cattle parameters
        (0.15,0.22),(0.9,0.93),(0.87,0.92),(0.88,0.92),(0.075,0.15),(0.05,0.12),
        # pig parameters
        (0.3,0.45),(0.8,0.83),(0.93,0.94),(0.9,0.94),(0.1,0.15),(0.075,0.13)]
