...
def run_optimizer():
    ...
    bds = [
        ...
        # roe deer parameters
        (0.18,0.2),(0.9,0.93),(0.87,0.93),(0.87,0.93),(0.13,0.14),(0.12,0.13),
        # fallow deer parameters
        (0.33,0.35),(0.9,0.93),(0.89,0.92),(0.85,0.92),(0.12,0.14),(0.12,0.14),
        # red deer parameters
        (0.37,0.39),(0.9,0.93),(0.89,0.92),(0.85,0.92),(0.12,0.14),(0.12,0.14),
