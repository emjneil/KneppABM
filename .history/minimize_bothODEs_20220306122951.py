...
def run_optimizer():
    ...
    bds = [
        ...
        # roe deer parameters
        (0.18,0.2),(0.9,0.93),(0.9,0.95),(0.9,0.95),(0.12,0.25),(0.1,0.25),
        # fallow deer parameters
        (0.33,0.35),(0.9,0.93),(0.9,0.93),(0.9,0.93),(0.1,0.2),(0.09,0.2),
        # red deer parameters
        (0.34,0.37),(0.9,0.93),(0.9,0.93),(0.9,0.93),(0.1,0.2),(0.09,0.2),
        # exmoor pony parameters
        (0.85,0.9),(0.88,0.92),(0.88,0.92),(0.09,0.15),(0.08,0.15),
        # cattle parameters
        (0.18,0.21),(0.87,0.92),(0.88,0.92),(0.88,0.9),(0.09,0.15),(0.08,0.15),
        # pig parameters
