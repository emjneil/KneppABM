...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0,0.4],[0,1],[0,1],[0,1],[0,0.15],[0,0.15],
        # red deer parameters
        [0,0.4],[0,1],[0,1],[0,1],[0,0.15],[0,0.15],
        # exmoor pony parameters
        [0,1],[0,1],[0,1],[0,0.15],[0,0.15],
        # cattle parameters
        [0,0.3],[0,1],[0,1],[0,1],[0,0.15],[0,0.15],
        # # pig parameters
        [0,0.25],[0,1],[0,0.15],[0,0.15],[0,1]
    ])
...
# y values - number of trees, scrub, etc. 
    ...
    print(len(y_values_reality0), len(species_list_ages), len(indices_list_ages))
