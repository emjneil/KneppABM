...
def run_optimizer():
    ...
    bds = [
        ...
        (0.01,0.013),(0.038,0.042),(0.084,0.085),(0.0027,0.0028),(0.014,0.0145),
        ...
        # roe deer parameters
        (0.18,0.2),(0.94,0.95),(0.92,0.93),(0.92,0.93),(0.13,0.16),(0.13,0.16),
        # fallow deer parameters
        (0.38,0.45),(0.9,0.94),(0.9,0.93),(0.9,0.93),(0.12,0.15),(0.12,0.15),
        # red deer parameters
