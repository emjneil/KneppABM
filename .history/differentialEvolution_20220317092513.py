...
def objectiveFunction(x, info):
    ...
    max_start_saplings = 1
    max_start_youngScrub = 1
...
def run_optimizer():
    ...
    bds = [
        ...
        (0.0025,0.0031),(0.0025,0.0031),(0.0135,0.014),(0.0021,0.0022),(0.0067,0.007),
        (0.0025,0.0027), # mature scrub competition
        (0.094,0.095),(0.093,0.094), # grass
        (0.007,0.0075),(0.0023,0.0027), # saplings
        (0.0065,0.0072),(0.007,0.0075), # young scrub  
        # roe deer parameters
        (0.16,0.19),(0.93,0.94),(0.93,0.94),(0.92,0.94),(0.18,0.19),(0.14,0.15),
        # fallow deer parameters
        (0.31,0.32),(0.92,0.93),(0.92,0.93),(0.92,0.93),(0.16,0.18),(0.1,0.13),
        # red deer parameters
        (0.34,0.354),(0.92,0.93),(0.91,0.93),(0.91,0.93),(0.16,0.18),(0.1,0.13),
        # exmoor pony parameters
        (0.91,0.92),(0.9,0.92),(0.9,0.92),(0.15,0.16),(0.09,0.12),
        # cattle parameters
        (0.18,0.2),(0.88,0.95),(0.89,0.95),(0.89,0.95),(0.15,0.16),(0.09,0.12),
        # pig parameters
        (0.29,0.31),(0.86,0.88),(0.93,0.95),(0.93,0.95),(0.14,0.15),(0.12,0.13)]
...
#   fun: 181.8787843737709
#  message: 'Maximum number of iterations has been exceeded.'
#     nfev: 94
#      nit: 1
#  success: False
#        x: array([0.00263407, 0.00277081, 0.0139025 , 0.0021909 , 0.00682057,
#        0.00251319, 0.09474794, 0.09362937, 0.00701235, 0.00249343,
#        0.00710791, 0.00717379, 0.18213904, 0.9393147 , 0.93515345,
#        0.92549271, 0.18595383, 0.14231817, 0.31998205, 0.92246322,
#        0.92990848, 0.92260583, 0.17817923, 0.10049821, 0.34874102,
#        0.92956347, 0.91821897, 0.91621545, 0.1761029 , 0.10934135,
#        0.91691297, 0.91998366, 0.90728326, 0.15160507, 0.11093608,
#        0.19059264, 0.89471746, 0.90492845, 0.93229563, 0.1503241 ,
#        0.09804718, 0.30677155, 0.87151223, 0.93727966, 0.9463037 ,
#        0.14121664, 0.12350112])

# fun: 37.30652681066847
#  message: 'Maximum number of iterations has been exceeded.'
#     nfev: 94
#      nit: 1
#  success: False
#        x: array([0.00380935, 0.0034991 , 0.01363972, 0.00234405, 0.00864537,
#        0.00139678, 0.09493675, 0.0939928 , 0.08155715, 0.01669364,
#        0.07734443, 0.07887598, 0.1844588 , 0.93049318, 0.91245618,
#        0.91105723, 0.13207854, 0.10429096, 0.31988531, 0.9269663 ,
#        0.89772247, 0.89496679, 0.11152061, 0.089364  , 0.36689966,
#        0.92111507, 0.90657701, 0.90231884, 0.10251338, 0.07787185,
#        0.90169285, 0.89900062, 0.89563528, 0.08430975, 0.06053468,
#        0.18710352, 0.89357462, 0.89247387, 0.90320444, 0.11577805,
#        0.06283521, 0.26281333, 0.86311818, 0.90660151, 0.91111365,
#        0.10858845, 0.06871119])
