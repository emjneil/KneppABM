...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.05,0.1],[0.1,0.12],[0.24,0.26],[0.0015,0.006],[0.004,0.08],
        # habitat competition
        [0.01,0.03], # mature scrub
        [0.01,0.1],[0.01,0.1], # grass
        [0.05,0.1],[0.01,0.05], # saplings
        [0.05,0.1],[0.075,0.1], # young scrub  
        # roe deer parameters
        [0.18,0.25],[0.1,0.2],[0.075,0.15],[0.075,0.15],[0.025,0.1],[0.025,0.1]
    ])
...
#  The best solution found:
#  [0.01783611 0.10034912 0.26319381 0.00155018 0.00645459 0.02021087
#  0.0458881  0.09700306 0.04988611 0.0172847  0.07391575 0.0889276
#  0.20104186 0.16376377 0.13738758 0.12786644 0.08294847 0.03399095]
...
def graph_results():
    ...
    # habitats
    chance_reproduceSapling = .018
    chance_reproduceYoungScrub = 0.1
    chance_regrowGrass = 0.26
    chance_saplingBecomingTree = 0.00155
    chance_youngScrubMatures = 0.0065
...
#  7.0
    # chance_saplingBecomingTree = 0.0042
    # chance_youngScrubMatures = 0.0075
    chance_scrubOutcompetedByTree = 0.02
    chance_grassOutcompetedByTree = 0.046
    chance_grassOutcompetedByScrub = 0.097
    chance_saplingOutcompetedByTree = 0.05
    chance_saplingOutcompetedByScrub = 0.017
    chance_youngScrubOutcompetedByScrub = 0.074
    chance_youngScrubOutcompetedByTree = 0.089
    # initial values
    initial_roeDeer = 0.12
    initial_grassland = 0.8
    initial_woodland = 0.14
    ...
    roeDeer_gain_from_grass = 0.16
    roeDeer_gain_from_Trees = 0.14
    roeDeer_gain_from_Scrub = 0.13
    roeDeer_gain_from_Saplings = 0.08
    roeDeer_gain_from_YoungScrub = 0.03
    # roeDeer_reproduce = 0.2
