...
def run_optimizer():
    ...
    bds = [
        ...
        (0.002,0.0035),(0.002,0.0035),(0.0135,0.014),(0.0023,0.0024),(0.0086,0.0087),
        (0.001,0.002), # mature scrub competition
        (0.094,0.095),(0.093,0.094), # grass
        (0.075,0.085),(0.01,0.025), # saplings
        ...
        # red deer parameters
        (0.35,0.37),(0.89,0.91),(0.89,0.91),(0.89,0.91),(0.09,0.11),(0.075,0.085),
