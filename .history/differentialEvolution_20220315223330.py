...
def run_optimizer():
    ...
    bds = [
        ...
        # roe deer parameters
        (0.17,0.20),(0.93,0.95),(0.91,0.94),(0.91,0.94),(0.12,0.13),(0.11,0.12),
        # fallow deer parameters
        (0.315,0.32),(0.92,0.93),(0.89,0.91),(0.89,0.91),(0.1,0.12),(0.09,0.11),
        # red deer parameters
        (0.36,0.37),(0.92,0.93),(0.89,0.91),(0.89,0.91),(0.11,0.12),(0.08,0.1),
        # exmoor pony parameters
        (0.9,0.91),(0.89,0.9),(0.88,0.9),(0.1,0.11),(0.065,0.085),
        # cattle parameters
        (0.185,0.19),(0.88,0.9),(0.88,0.9),(0.89,0.91),(0.09,0.11),(0.065,0.085),
        # pig parameters
        (0.17,0.27),(0.86,0.88),(0.9,0.92),(0.9,0.92),(0.09,0.12),(0.065,0.1)]
