...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.05,0.1],[0.05,0.2],[0.025,0.05],[0.0025,0.005],[0.005,0.008],
        # habitat competition
        [0.0005,0.001],[0.05,0.075],[0.07,0.1],[0.15,0.2],[0.01,0.1],[0.01,0.1],[0.15,0.2],     
        # roe deer parameters
        [0.19,0.21],[0.1,0.25],[0.1,0.3],[0.1,0.3],[0.015,0.025],[0.015,0.025],
