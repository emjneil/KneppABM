...
def run_optimizer():
    ...
    bds = [
        ...
        (0.05,0.056),(0.025,0.04), # saplings
        (0.04,0.05),(0.05,0.055), # young scrub  
        # roe deer parameters
        (0.18,0.2),(0.93,0.94),(0.93,0.94),(0.92,0.94),(0.13,0.15),(0.13,0.15),
        # fallow deer parameters
        (0.35,0.41),(0.9,0.91),(0.9,0.91),(0.9,0.92),(0.11,0.13),(0.11,0.13),
        # red deer parameters
        (0.41,0.45),(0.89,0.91),(0.89,0.91),(0.89,0.92),(0.11,0.13),(0.11,0.13),
        # exmoor pony parameters
        (0.87,0.91),(0.89,0.92),(0.89,0.92),(0.11,0.13),(0.11,0.13),
        # cattle parameters
        (0.18,0.25),(0.88,0.91),(0.9,0.92),(0.9,0.92),(0.1,0.13),(0.1,0.13),
        # pig parameters
