...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.015,0.025],[0.02,0.035],[0.075,0.077],[0.002,0.006],[0.01,0.02],
        [0.01,0.025], # mature scrub competition
        [0.08,0.09],[0.08,0.09], # grass
        [0.03,0.04],[0.015,0.04], # saplings
        [0.015,0.04],[0.03,0.04], # young scrub  
        # roe deer parameters
        [0.17,0.21],[0.5,0.75],[0.75,1],[0.75,1],[0.1,0.15],[0.1,0.15]
    ])
