...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.1,0.12],[0.2,0.5],[0.2,0.5],
        # habitat competition
        [0.001,0.002],[0.25,0.35],[0.25,0.35],[0.35,0.75],[0.05,0.75],[0.05,0.75],[0.35,0.75],     
        # roe deer parameters
        [0.17,0.21],[0.1,0.2],[0.075,0.25],[0.075,0.2],[0.0075,0.015],[0.0075,0.015],
