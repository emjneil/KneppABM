...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.05,0.1],[0.05,0.1],[0.01,0.025],[0.001,0.005],[0.005,0.01],
        # habitat competition
        [0.025,0.075],[0.05,0.15],[0.05,0.15],[0.025,0.05],[0.01,0.015],[0.01,0.015],[0.025,0.05],     
        # roe deer parameters
        [0.1,0.25],[0.01,0.5],[0.01,0.5],[0.01,0.5],[0,0.1],[0,0.1]
    ])

#  [0.08131213 0.0474097  0.070962223 0.00056271 0.02603168 0.08620662
