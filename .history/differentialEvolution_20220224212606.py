...
def run_optimizer():
    ...
    bds = [
        ...
        # roe deer parameters
        (0.18,0.2),(0.93,0.94),(0.93,0.94),(0.92,0.94),(0.14,0.2),(0.14,0.2),
        # fallow deer parameters
        (0.31,0.35),(0.9,0.93),(0.9,0.93),(0.9,0.93),(0.13,0.2),(0.13,0.2),
        # red deer parameters
        (0.39,0.41),(0.88,0.92),(0.88,0.93),(0.88,0.93),(0.13,0.2),(0.13,0.2),
        # exmoor pony parameters
        (0.87,0.91),(0.87,0.92),(0.87,0.92),(0.12,0.2),(0.12,0.2),
        # cattle parameters
        (0.18,0.21),(0.86,0.91),(0.87,0.92),(0.87,0.92),(0.12,0.2),(0.12,0.2),
        # pig parameters
        (0.15,0.35),(0.75,0.85),(0.9,0.91),(0.9,0.91),(0.12,0.2),(0.12,0.2)]
