...
def run_optimizer():
    ...
    bds = [
        ...
        (0.06,0.09),(0.015,0.02), # saplings
        (0.045,0.09),(0.06,0.09), # young scrub  
        # roe deer parameters
        (0.16,0.20),(0.91,0.92),(0.91,0.92),(0.91,0.92),(0.1,0.135),(0.08,0.095),
        # fallow deer parameters
        (0.31,0.32),(0.89,0.91),(0.89,0.91),(0.89,0.91),(0.075,0.1),(0.07,0.08),
        # red deer parameters
        (0.35,0.37),(0.89,0.91),(0.89,0.91),(0.89,0.91),(0.075,0.1),(0.07,0.08),
        # exmoor pony parameters
        (0.88,0.9),(0.88,0.9),(0.88,0.9),(0.075,0.1),(0.025,0.075),
        # cattle parameters
        (0.18,0.19),(0.88,0.91),(0.88,0.9),(0.88,0.9),(0.075,0.1),(0.025,0.075),
        # pig parameters
        (0.2,0.3),(0.85,0.9),(0.9,0.92),(0.9,0.92),(0.075,0.15),(0.025,0.08)]
