...
class habitatAgent (Agent):
    ...
    def step(self):
        ...
        available_sapling_cell = [i for i in no_herbivores if i.edibles["saplings"] < 3000 and i.edibles["trees"] < 390]
        ...
        available_youngscrub_cell = [i for i in no_herbivores if i.edibles["youngScrub"] < 3000 and i.edibles['scrub'] < 390]
