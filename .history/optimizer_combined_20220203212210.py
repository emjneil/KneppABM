...
def run_optimizer():
    ...
    bds = np.array([
        ...
        # roe deer parameters
        [0.18,0.22],[0.75,0.8],[0.77,0.83],[0.77,0.83],[0.15,0.2],[0.15,0.2],
        # fallow deer parameters
        [0.3,0.45],[0.65,0.75],[0.75,0.8],[0.75,0.8],[0.1,0.2],[0.1,0.2],
        # red deer parameters
        [0.3,0.45],[0.6,0.75],[0.75,0.8],[0.75,0.8],[0.1,0.15],[0.1,0.15],
        # exmoor pony parameters
        [0.6,0.7],[0.7,0.75],[0.7,0.75],[0.1,0.15],[0.1,0.15],
        # cattle parameters
