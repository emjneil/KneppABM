...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.015,0.035],[0.03,0.05],[0.075,0.077],[0.002,0.006],[0.009,0.02],
        [0.01,0.015], # mature scrub competition
        [0.05,0.06],[0.05,0.06], # grass
        [0.03,0.05],[0.01,0.04], # saplings
        [0.01,0.04],[0.03,0.05], # young scrub  
        # roe deer parameters
        [0.15,0.21],[0.5,0.75],[0.75,1],[0.75,1],[0.1,0.25],[0.1,0.25]
    ])
