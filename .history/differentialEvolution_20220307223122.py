...
def run_optimizer():
    ...
    bds = [
        ...
        (0.37,0.41),(0.89,0.93),(0.85,0.93),(0.85,0.93),(0.075,0.13),(0.075,0.13),
        # red deer parameters
        (0.38,0.4),(0.85,0.93),(0.85,0.93),(0.85,0.93),(0.075,0.1),(0.075,0.1),
        # exmoor pony parameters
        (0.85,0.92),(0.86,0.92),(0.86,0.92),(0.05,0.1),(0.05,0.1),
        # cattle parameters
        (0.18,0.21),(0.85,0.92),(0.86,0.92),(0.86,0.92),(0.05,0.1),(0.05,0.1),
        # pig parameters
