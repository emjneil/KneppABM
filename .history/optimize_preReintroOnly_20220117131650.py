...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.05,0.055],[0.085,0.087],[0.1,0.12],[0.0015,0.0055],[0.02,0.03],
        # habitat competition
        [0.024,0.026], # mature scrub
        [0.15,0.18],[0.13,0.15], # grass
        [0.11,0.16],[0.05,0.1], # saplings
        [0.04,0.1],[0.11,0.13], # young scrub  
        # roe deer parameters
        [0.19,0.21],[0.075,0.17],[0.1,0.23],[0.1,0.23],[0.075,0.15],[0.075,0.15]
    ])
