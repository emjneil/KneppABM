...
def run_optimizer():
    ...
    bds = [
        ...
        (0.0025,0.0035),(0.0025,0.0035),(0.01,0.015),(0.0022,0.0024),(0.008,0.009),
        (0.0014,0.0016), # mature scrub competition
        (0.09,0.095),(0.09,0.095), # grass
        (0.075,0.085),(0.02,0.03), # saplings
        (0.075,0.085),(0.075,0.085), # young scrub  
        # roe deer parameters
        ...
        # pig parameters
        (0.25,0.28),(0.75,0.82),(0.89,0.94),(0.89,0.94),(0.05,0.1),(0.05,0.09)]
