...
class habitatAgent (Agent):
    ...
    def step(self):
        ...
        outcompeted_grass_byScrub = max(outcompeted_grass_byScrub, 100 - self.edibles['grass'])
        ...
        outcompeted_saplings_byScrub = max(outcompeted_saplings_byScrub, 5000 - self.edibles['saplings'])
