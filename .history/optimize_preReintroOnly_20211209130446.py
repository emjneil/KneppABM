...
def objectiveFunction(x):
    ...
    if (list(results.loc[results['Time'] == 1, 'Saplings'])[0]) > round(max_start_saplings*3000*1800) and (list(results.loc[results['Time'] == 5, 'Young Scrub'])[0]) > round(max_start_youngScrub*3000*1800):
        filtered_result = (
            # pre-reintro model
