...
def graph_results():
    ...
    death_by = np.tile(["Grown saplings", "Outcompeted Saplings", "Outcompeted Saplings-Scrub", "Eaten Saplings", "Grown young scrub", "Outcompeted Young Scrub", "Outcompeted Young Scrub-Scrub"
        "Eaten Grass", "Eaten Trees", "Eaten Mature Scrub", "Eaten Saplings", "Eaten Young Scrub"], 51)
