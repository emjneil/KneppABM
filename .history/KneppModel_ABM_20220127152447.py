...
class KneppModel(Model):
    ...
    def remove_pig(self, herbivore, count_piglets, count_sow, count_boar):
        ...
        my_choice_piglet = random.sample(list(to_remove_notBoars), k = min(count_piglets, len(to_remove_notBoars)))
        my_choice_sow = random.sample(list(to_remove_notBoars), k = min(count_sow, len(to_remove_notBoars)))
