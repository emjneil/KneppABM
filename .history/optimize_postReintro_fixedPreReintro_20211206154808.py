...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0,10.5],[0,0.025],[0,0.075],[0,0.075],[0,0.01],[0,0.01],
        # red deer parameters
        [0,0.5],[0,0.025],[0,0.075],[0,0.075],[0,0.01],[0,0.01],
        # exmoor pony parameters
        [0,0.025],[0,0.075],[0,0.075],[0,0.01],[0,0.01],
        # cattle parameters
        [0,0.5],[0,0.025],[0,0.075],[0,0.075],[0,0.01],[0,0.01],
        # pig parameters
        [0,0.5],[0,0.025],[0,0.01],[0,0.01]
    ])
