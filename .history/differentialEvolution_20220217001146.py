...
def run_optimizer():
    ...
    bds = [
        ...
        (0.012,0.015),(0.03,0.043),(0.075,0.076),(0.0025,0.004),(0.01,0.025),
        (0.011,0.015), # mature scrub competition
        (0.17,0.2),(0.17,0.2), # grass
        (0.1,0.14),(0.02,0.14), # saplings
        (0.1,0.14),(0.1,0.14), # young scrub  

        # roe deer parameters
        (0.18,0.21),(0.8,0.85),(0.82,0.85),(0.82,0.85),(0.075,0.15),(0.12,0.15),
