...
def run_optimizer():
    ...
    bds = [
        ...
        (0.021,0.024),(0.04,0.042),(0.073,0.074),(0.002,0.0022),(0.018,0.021),
        (0.013,0.015), # mature scrub competition
        (0.085,0.087),(0.085,0.087), # grass
        (0.07,0.09),(0.05,0.09), # saplings
        (0.05,0.09),(0.07,0.09), # young scrub  
        # roe deer parameters
        (0.15,0.22),(0.75,0.8),(0.8,0.85),(0.8,0.85),(0.14,0.2),(0.14,0.2),
        # fallow deer parameters
        (0.33,0.42),(0.7,0.75),(0.75,0.8),(0.75,0.8),(0.1,0.16),(0.1,0.16),
        # red deer parameters
        (0.33,0.42),(0.68,0.73),(0.75,0.8),(0.75,0.8),(0.1,0.16),(0.1,0.16),
        # exmoor pony parameters
        (0.63,0.71),(0.73,0.78),(0.73,0.78),(0.1,0.15),(0.1,0.15),
        # cattle parameters
        (0.18,0.25),(0.65,0.7),(0.72,0.76),(0.72,0.76),(0.1,0.14),(0.1,0.14),
        # # pig parameters
        (0.17,0.25),(0.5,0.65),(0.75,0.85),(0.75,0.85),(0.1,0.14),(0.1,0.14)]
