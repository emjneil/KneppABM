...
def run_optimizer():
    ...
    bds = [
        ...
        (0.01,0.017),(0.035,0.045),(0.073,0.076),(0.003,0.0035),(0.013,0.016),
        (0.01,0.016), # mature scrub competition
        (0.085,0.087),(0.085,0.087), # grass
        (0.045,0.05),(0.02,0.036), # saplings
        (0.025,0.05),(0.033,0.05), # young scrub  
        # roe deer parameters
        ...
        # red deer parameters
        (0.38,0.47),(0.68,0.7),(0.75,0.78),(0.75,0.78),(0.1,0.16),(0.1,0.16),
        # exmoor pony parameters
        (0.63,0.68),(0.73,0.75),(0.73,0.75),(0.1,0.15),(0.1,0.15),
        # cattle parameters
        (0.2,0.22),(0.62,0.65),(0.72,0.75),(0.72,0.75),(0.1,0.14),(0.1,0.14),
        # # pig parameters
