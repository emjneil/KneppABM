...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.053,0.057],[0.068,0.07],[0.071,0.073],[0.002,0.0025],[0.009,0.02],
        # habitat competition
        [0.047,0.053], # mature scrub
        [0.15,0.21],[0.1,0.2], # grass
        [0.15,0.21],[0.075,0.13], # saplings
        [0.075,0.13],[0.15,0.21], # young scrub  
        # roe deer parameters
        [0.17,0.22],[0.1,0.15],[0.05,0.15],[0.05,0.15],[0.075,0.12],[0.075,0.12]
    ])
    # chance_saplingBecomingTree = 0.0042
    # chance_youngScrubMatures = 0.0075 [0.0015,0.006],[0.004,0.08],

#  The best solution found:
#  [0.0586052  0.07311948 0.07146459 0.00216923 0.00961829 0.05219193
#  0.14282219 0.12207045 0.2042572  0.12175613 0.05767537 0.16327844
#  0.1897264  0.12661685 0.13679664 0.09923375 0.10487707 0.0947647 ]
