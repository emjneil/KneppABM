...
def objectiveFunction(x):
    ...
    model = KneppModel(
        ...
        width = 50, height = 36, max_time = 185, reintroduction = False, 
...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.025,0.1],[0.025,0.15],[0.025,0.05],[0.0025,0.005],[0.005,0.008],
        # habitat competition
        [0.0005,0.001],[0.05,0.075],[0.05,0.075],[0.01,0.15],[0.01,0.1],[0.01,0.1],[0.01,0.15],     
        # roe deer parameters
        [0.19,0.22],[0.05,0.25],[0.1,0.5],[0.1,0.5],[0.005,0.025],[0.005,0.025],
