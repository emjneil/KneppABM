...
def run_optimizer():
    ...
    bds = [
        ...
        (0.0029,0.0036),(0.0029,0.0034),(0.0135,0.014),(0.0023,0.0024),(0.0086,0.0087),
        (0.0014,0.0015), # mature scrub competition
        (0.094,0.095),(0.093,0.094), # grass
        (0.084,0.086),(0.013,0.023), # saplings
        (0.084,0.086),(0.084,0.086), # young scrub  
        # roe deer parameters
        (0.19,0.20),(0.93,0.94),(0.92,0.94),(0.92,0.94),(0.12,0.13),(0.07,0.09),
        # fallow deer parameters
        (0.31,0.32),(0.9,0.92),(0.9,0.92),(0.9,0.92),(0.1,0.11),(0.075,0.085),
        # red deer parameters
        (0.38,0.39),(0.9,0.92),(0.9,0.92),(0.9,0.92),(0.095,0.1),(0.07,0.08),
        # exmoor pony parameters
        (0.89,0.9),(0.89,0.91),(0.89,0.9),(0.085,0.095),(0.06,0.075),
        # cattle parameters
        (0.18,0.19),(0.88,0.9),(0.88,0.9),(0.88,0.9),(0.08,0.095),(0.06,0.075),
        # pig parameters
        (0.2,0.22),(0.81,0.87),(0.92,0.94),(0.92,0.94),(0.085,0.13),(0.07,0.1)]
