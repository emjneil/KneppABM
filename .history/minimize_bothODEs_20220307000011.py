...
def run_optimizer():
    ...
    bds = [
        ...
        (0.05,0.1),(0.025,0.05), # saplings
        (0.045,0.1),(0.05,0.1), # young scrub  
        # roe deer parameters
        (0.18,0.2),(0.9,0.95),(0.9,0.95),(0.9,0.95),(0.075,0.15),(0.075,0.15),
        # fallow deer parameters
        (0.33,0.35),(0.89,0.93),(0.89,0.93),(0.89,0.93),(0.05,0.13),(0.05,0.13),
        # red deer parameters
        (0.34,0.37),(0.89,0.93),(0.89,0.93),(0.89,0.93),(0.05,0.13),(0.05,0.13),
        # exmoor pony parameters
        (0.88,0.9),(0.88,0.92),(0.88,0.92),(0.025,0.12),(0.025,0.12),
        # cattle parameters
        (0.18,0.21),(0.87,0.92),(0.87,0.92),(0.87,0.92),(0.025,0.12),(0.025,0.12),
        # pig parameters
        (0.25,0.3),(0.75,0.8),(0.9,0.95),(0.9,0.95),(0.05,0.15),(0.05,0.15)]

    initial_guess = [
        # habitats reproduction 
        0.01231498     , 0.03903877     , 0.08479035, 0.00263711    , 0.01514143     ,
        0.01632931     , 0.17617216     , 0.17477425, 0.05548632      , 0.0257358,
        0.04560602 , 0.05165619      , 0.18281812, 0.9342863      , 0.93      ,
        0.93      , 0.13303401      , 0.149385      , 0.35      , 0.90594704,
        0.9275    , 0.92      , 0.06      , 0.06      , 0.37      ,
        0.90152721, 0.91226621, 0.93      , 0.06      , 0.06      ,
        0.89853249, 0.9       , 0.88      , 0.05      , 0.05,
        0.11       , 0.89304486, 0.9       , 0.88      , 0.05      ,
