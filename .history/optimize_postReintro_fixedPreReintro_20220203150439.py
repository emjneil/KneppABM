...
def run_optimizer():
    ...
    bds = np.array([
        ...
        # red deer parameters
        [0.25,0.45],[0.45,0.5],[0.55,0.75],[0.55,0.75],[0.075,0.12],[0.075,0.12],
        # exmoor pony parameters
        [0.4,0.5],[0.45,0.65],[0.45,0.65],[0.05,0.11],[0.05,0.11],
        # cattle parameters
        [0.15,0.3],[0.25,0.35],[0.35,0.65],[0.35,0.65],[0.05,0.11],[0.05,0.11],
        # # pig parameters
        [0.1,0.75],[0.1,0.25],[0.6,0.75],[0.6,0.75],[0.075,0.12],[0.075,0.12]
    ])
