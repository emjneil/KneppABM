...
def run_all_models():
    ...
    number_filters_passed = 0

    # filter the runs and tag the dataframe
    # pre-reintroduction model
    if (final_results["Time"] == 50) & (final_results["Roe deer"] <= 40) & (final_results["Roe deer"] >= 6) & (final_results["Grassland"] <= 90) & (final_results["Grassland"] >= 49) & (final_results["Woodland"] <= 27) & (final_results["Woodland"] >= 7) & (final_results["Thorny Scrub"] <= 21) & (final_results["Thorny Scrub"] >= 1):
        number_filters_passed += 1 
        # May 2020 (last filters)
        if filtered_preReintro[(filtered_preReintro["Time"] == 184) & (filtered_preReintro["Tamworth pigs"] <= 29) & (filtered_preReintro["Tamworth pigs"] >= 9) & (filtered_preReintro["Exmoor pony"] <= 17) & (filtered_preReintro["Exmoor pony"] >= 14) & (filtered_preReintro["Longhorn cattle"] <= 106) & (filtered_preReintro["Longhorn cattle"] >= 56) & (filtered_preReintro["Roe deer"] <= 80) & (filtered_preReintro["Roe deer"] >= 20) & (filtered_preReintro["Grassland"] <= 69) & (filtered_preReintro["Grassland"] >= 49) & (filtered_preReintro["Thorny Scrub"] <= 35) & (filtered_preReintro["Thorny Scrub"] >= 21) & (filtered_preReintro["Woodland"] <= 29) & (filtered_preReintro["Woodland"] >= 9):
            number_filters_passed += 1
        else: break
