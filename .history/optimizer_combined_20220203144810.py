...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.3,0.45],[0.65,0.75],[0.7,0.75],[0.7,0.75],[0.13,0.17],[0.13,0.17],
        # red deer parameters
        [0.25,0.4],[0.63,0.75],[0.7,0.75],[0.7,0.75],[0.12,0.17],[0.12,0.17],
        # exmoor pony parameters
        [0.63,0.68],[0.65,0.7],[0.65,0.7],[0.1,0.15],[0.1,0.15],
        # cattle parameters
        [0.15,0.35],[0.55,0.7],[0.6,0.65],[0.6,0.65],[0.075,0.15],[0.075,0.15],
        # # pig parameters
        [0.15,0.5],[0.3,0.6],[0.8,0.85],[0.8,0.85],[0.1,0.15],[0.1,0.15]
    ])
