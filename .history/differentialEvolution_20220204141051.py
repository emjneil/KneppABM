...
def updt(total, progress, extra=""): # print progress bar
    """
...
def objectiveFunction(x):
    ...
    updt(popsize * (maxiter + 1) * len(optimization), info['Nfeval'] + 1)
    info['Nfeval'] += 1
...
def run_optimizer():
    ...
    bds = [
        ...
        (0.01,0.02),(0.025,0.04),(0.05,0.08),(0.002,0.004),(0.01,0.025),
        ...
        # cattle parameters
        (0.15,0.3),(0.6,0.65),(0.65,0.72),(0.65,0.72),(0.05,0.15),(0.05,0.15),
        # # pig parameters
        (0.15,0.35),(0.5,0.6),(0.7,0.8),(0.7,0.8),(0.05,0.15),(0.05,0.15)]

    optimization = differential_evolution(objectiveFunction, bounds = bds, popsize = popsize, seed = 0, maxiter = maxiter, polish=False)
