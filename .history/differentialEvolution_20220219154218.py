...
def run_optimizer():
    ...
    bds = [
        ...
        (0.011,0.001514),(0.043,0.045),(0.075,0.076),(0.0025,0.0035),(0.013,0.015),
        (0.013,0.018), # mature scrub competition
        (0.17,0.2),(0.17,0.2), # grass
        (0.045,0.06),(0.02,0.035), # saplings
        (0.03,0.048),(0.04,0.06), # young scrub  
        # roe deer parameters
        (0.18,0.2),(0.8,0.82),(0.82,0.83),(0.82,0.83),(0.14,0.15),(0.14,0.15),
        # fallow deer parameters
        (0.33,0.42),(0.77,0.8),(0.8,0.82),(0.8,0.82),(0.12,0.14),(0.12,0.14),
        # red deer parameters
        (0.33,0.41),(0.77,0.8),(0.79,0.82),(0.79,0.82),(0.12,0.14),(0.12,0.14),
        # exmoor pony parameters
        (0.76,0.77),(0.78,0.8),(0.78,0.8),(0.11,0.13),(0.11,0.13),
        # cattle parameters
