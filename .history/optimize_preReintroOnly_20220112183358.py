...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.01,0.05],[0.025,0.5],[0.025,0.5],
        # habitat competition
        [0.001,0.01], # mature scrub
        [0.1,0.25],[0.1,0.25], # grass
        [0.1,0.25],[0.01,0.1], # saplings
        [0.1,0.25],[0.01,0.1], # young scrub  
        # roe deer parameters
        [0.15,0.25],[0.1,0.25],[0.075,0.25],[0.075,0.25],[0.0075,0.05],[0.0075,0.05]
    ])
