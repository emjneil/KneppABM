...
def objectiveFunction(x):
    ...
    # cows_gain_from_YoungScrub = 0.0001

 [0.27621172 0.04034344 0.01142394 0.01789536 0.0019737  0.00141137]
...
def run_optimizer():
    ...
    bds = np.array([
        ...
        # [0,0.45],[0,0.25],[0.1,0.2],[0.1,0.2],[0.001,0.05],[0.001,0.05],
        ...
        # # cattle parameters
        [0.05,0.3],[0,0.15],[0,0.1],[0,0.1],[0,0.005],[0,0.005]
        # # pig parameters
...
def graph_results():
    ...
    cows_gain_from_grass = output_parameters["variable"][0]
    cows_gain_from_Trees = output_parameters["variable"][1]
    cows_gain_from_Scrub =output_parameters["variable"][2]
    cows_gain_from_Saplings = output_parameters["variable"][3]
    cows_gain_from_YoungScrub = output_parameters["variable"][4]
