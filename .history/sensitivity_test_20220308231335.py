...
for index, row in final_parameters.iteritems():
    for perc_number in perc_aboveBelow:
        ...
        initial_woodland = 0.14
        initial_scrubland = 0.01
        roeDeer_gain_from_grass = final_parameters_temp.values[12]
        roeDeer_gain_from_Trees = final_parameters_temp.values[13]
        roeDeer_gain_from_Scrub = final_parameters_temp.values[14]
        roeDeer_gain_from_Saplings = final_parameters_temp.values[15]
        roeDeer_gain_from_YoungScrub = final_parameters_temp.values[16]
        ponies_gain_from_grass = final_parameters_temp.values[17]
        ponies_gain_from_Trees = final_parameters_temp.values[18]
        ponies_gain_from_Scrub = final_parameters_temp.values[19]
        ponies_gain_from_Saplings = final_parameters_temp.values[20]
        ponies_gain_from_YoungScrub = final_parameters_temp.values[21]
        cows_reproduce = final_parameters_temp.values[22]
        cows_gain_from_grass = final_parameters_temp.values[23]
        cows_gain_from_Trees = final_parameters_temp.values[24]
        cows_gain_from_Scrub = final_parameters_temp.values[25]
        cows_gain_from_Saplings = final_parameters_temp.values[26]
        cows_gain_from_YoungScrub = final_parameters_temp.values[27]
        fallowDeer_reproduce = final_parameters_temp.values[28]
        fallowDeer_gain_from_grass = final_parameters_temp.values[29]
        fallowDeer_gain_from_Trees = final_parameters_temp.values[30]
        fallowDeer_gain_from_Scrub = final_parameters_temp.values[31]
        fallowDeer_gain_from_Saplings = final_parameters_temp.values[32]
        fallowDeer_gain_from_YoungScrub = final_parameters_temp.values[33]
        redDeer_reproduce = final_parameters_temp.values[34]
        redDeer_gain_from_grass = final_parameters_temp.values[35]
        redDeer_gain_from_Trees = final_parameters_temp.values[36]
        redDeer_gain_from_Scrub = final_parameters_temp.values[37]
        redDeer_gain_from_Saplings = final_parameters_temp.values[38]
        redDeer_gain_from_YoungScrub = final_parameters_temp.values[39]
        pigs_reproduce = final_parameters_temp.values[40]
        pigs_gain_from_grass = final_parameters_temp.values[41]
        pigs_gain_from_Trees = final_parameters_temp.values[42]
        pigs_gain_from_Scrub = final_parameters_temp.values[43]
        pigs_gain_from_Saplings = final_parameters_temp.values[44]
        pigs_gain_from_YoungScrub = final_parameters_temp.values[45]
...
top_ten.to_excel("/Users/emilyneil/Desktop/KneppABM/many_outputs2/final_df_gradients_roeDeer.xlsx")
# plot those
...
top_ten.to_excel("/Users/emilyneil/Desktop/KneppABM/many_outputs2/final_df_gradients_fallowDeer.xlsx")
# plot those
...
top_ten.to_excel("/Users/emilyneil/Desktop/KneppABM/many_outputs2/final_df_gradients_redDeer.xlsx")
# plot those
...
top_ten.to_excel("/Users/emilyneil/Desktop/KneppABM/many_outputs2/final_df_gradients_cattle.xlsx")
# plot those
...
top_ten.to_excel("/Users/emilyneil/Desktop/KneppABM/many_outputs2/final_df_gradients_pig.xlsx")
# plot those
...
top_ten.to_excel("/Users/emilyneil/Desktop/KneppABM/many_outputs2/final_df_gradients_pony.xlsx")
# plot those
...
top_ten.to_excel("/Users/emilyneil/Desktop/KneppABM/many_outputs2/final_df_gradients_grass.xlsx")
# plot those
...
top_ten.to_excel("/Users/emilyneil/Desktop/KneppABM/many_outputs2/final_df_gradients_scrub.xlsx")
# plot those
...
top_ten.to_excel("/Users/emilyneil/Desktop/KneppABM/many_outputs2/final_df_gradients_woodland.xlsx")
# plot those
