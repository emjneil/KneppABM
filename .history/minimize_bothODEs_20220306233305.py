...
def run_optimizer():
    ...
    bds = [
        ...
        (0.012,0.013),(0.039,0.04),(0.084,0.085),(0.0026,0.0028),(0.016,0.04),
        (0.015,0.017), # mature scrub competition
        (0.17,0.175),(0.17,0.175), # grass
        (0.045,0.1),(0.025,0.05), # saplings
        (0.045,0.1),(0.045,0.1), # young scrub  
        ...
        # roe deer parameters
        (0.18,0.2),(0.9,0.93),(0.9,0.95),(0.9,0.95),(0.05,0.1),(0.05,0.1),
        # fallow deer parameters
        (0.33,0.35),(0.9,0.93),(0.9,0.93),(0.9,0.93),(0.01,0.1),(0.01,0.1),
        # red deer parameters
        (0.34,0.37),(0.9,0.93),(0.9,0.93),(0.9,0.93),(0.01,0.1),(0.01,0.1),
        # exmoor pony parameters
        (0.85,0.9),(0.88,0.92),(0.88,0.92),(0.01,0.1),(0.01,0.1),
        # cattle parameters
        (0.18,0.21),(0.87,0.92),(0.88,0.92),(0.88,0.9),(0.01,0.1),(0.01,0.1),
        # pig parameters
        (0.25,0.3),(0.75,0.8),(0.9,0.95),(0.9,0.95),(0.01,0.25),(0.01,0.25)]

    
    initial_guess = [
        # habitats reproduction 
        0.02     , 0.025     , 0.08479093, 0.0027    , 0.03     ,
        0.015     , 0.175     , 0.17477425, 0.07      , 0.03,
        0.07 , 0.07      , 0.18281812, 0.91      , 0.93      ,
        0.93      , 0.08      , 0.08      , 0.35      , 0.90594704,
        0.9275    , 0.92      , 0.06      , 0.06      , 0.37      ,
        0.90152721, 0.91226621, 0.93      , 0.06      , 0.06      ,
        0.89853249, 0.9       , 0.88      , 0.05      , 0.05,
        0.2       , 0.89304486, 0.9       , 0.88      , 0.05      ,
        0.05    , 0.25023499, 0.78447304, 0.9275    , 0.92      ,
        0.06, 0.06 ]

    
    res = minimize(objectiveFunction, initial_guess, method='Nelder-Mead', bounds=bds, options={'maxiter': 25})
