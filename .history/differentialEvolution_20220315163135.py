...
def run_optimizer():
    ...
    bds = [
        ...
        (0.0041,0.0042),(0.0035,0.0036),(0.0135,0.014),(0.0023,0.0024),(0.0086,0.0087),
        (0.0018,0.0019), # mature scrub competition
        (0.094,0.095),(0.093,0.094), # grass
        (0.075,0.078),(0.015,0.016), # saplings
        (0.075,0.077),(0.075,0.077), # young scrub  
        # roe deer parameters
        (0.16,0.20),(0.93,0.94),(0.91,0.92),(0.91,0.92),(0.1,0.135),(0.1,0.12),
        # fallow deer parameters
        (0.315,0.32),(0.91,0.92),(0.89,0.91),(0.89,0.91),(0.09,0.12),(0.09,0.1),
        # red deer parameters
        (0.36,0.37),(0.91,0.92),(0.89,0.91),(0.89,0.91),(0.09,0.12),(0.09,0.1),
