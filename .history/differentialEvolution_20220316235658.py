...
def run_optimizer():
    ...
    bds = [
        ...
        (0.003,0.0035),(0.003,0.0035),(0.0135,0.014),(0.0021,0.0022),(0.0067,0.007),
        ...
        # roe deer parameters
        (0.16,0.19),(0.93,0.94),(0.91,0.95),(0.91,0.95),(0.09,0.12),(0.09,0.11),
        # fallow deer parameters
        (0.31,0.32),(0.92,0.93),(0.89,0.93),(0.89,0.93),(0.08,0.11),(0.08,0.11),
        # red deer parameters
        (0.35,0.36),(0.92,0.93),(0.89,0.93),(0.89,0.93),(0.075,0.11),(0.075,0.11),
        # exmoor pony parameters
        (0.91,0.92),(0.88,0.92),(0.88,0.92),(0.075,0.1),(0.075,0.1),
        # cattle parameters
        (0.19,0.195),(0.9,0.92),(0.9,0.91),(0.89,0.9),(0.075,0.1),(0.075,0.1),
        # pig parameters
        (0.29,0.31),(0.86,0.88),(0.9,0.95),(0.9,0.95),(0.075,0.12),(0.075,0.11)]
