...
def run_optimizer():
    ...
    bds = [
        ...
        (0.02,0.025),(0.035,0.043),(0.073,0.076),(0.0017,0.0021),(0.02,0.05),
        (0.01,0.015), # mature scrub competition
        (0.085,0.087),(0.085,0.087), # grass
        (0.045,0.1),(0.02,0.1), # saplings
        (0.3,0.1),(0.04,0.1), # young scrub  
        # roe deer parameters
        ...
        # red deer parameters
        (0.38,0.4),(0.68,0.73),(0.75,0.8),(0.75,0.8),(0.1,0.16),(0.1,0.16),
