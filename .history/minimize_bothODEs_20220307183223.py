...
def run_optimizer():
    ...
    bds = [
        ...
        (0.04,0.075),(0.02,0.05), # saplings
        (0.03,0.075),(0.04,0.075), # young scrub  
        # roe deer parameters
        (0.18,0.2),(0.85,0.95),(0.85,0.95),(0.85,0.95),(0.075,0.15),(0.075,0.15),
        # fallow deer parameters
        (0.37,0.41),(0.89,0.93),(0.85,0.93),(0.85,0.93),(0.05,0.13),(0.05,0.13),
        # red deer parameters
        (0.38,0.4),(0.85,0.93),(0.85,0.93),(0.85,0.93),(0.05,0.13),(0.05,0.13),
        # exmoor pony parameters
        (0.85,0.92),(0.86,0.92),(0.86,0.92),(0.025,0.12),(0.025,0.12),
        # cattle parameters
        (0.18,0.21),(0.85,0.92),(0.86,0.92),(0.86,0.92),(0.025,0.12),(0.025,0.12),
        # pig parameters
        (0.25,0.32),(0.8,0.86),(0.85,0.92),(0.85,0.92),(0.075,0.15),(0.075,0.15)]
