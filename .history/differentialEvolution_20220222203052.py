...
def run_optimizer():
    ...
    (0.01,0.015),(0.035,0.043),(0.075,0.076),(0.0025,0.003),(0.014,0.017),
    (0.013,0.017), # mature scrub competition
    (0.17,0.18),(0.17,0.18), # grass
    (0.05,0.075),(0.015,0.03), # saplings
    (0.04,0.075),(0.05,0.075), # young scrub  
    # roe deer parameters
    (0.17,0.22),(0.9,0.95),(0.9,0.95),(0.9,0.95),(0,0.3),(0,0.3),
    # fallow deer parameters
    (0.3,0.45),(0.8,0.9),(0.8,0.9),(0.8,0.9),(0.01,0.25),(0.01,0.25),
    # red deer parameters
    (0.35,0.41),(0.85,0.9),(0.85,0.9),(0.85,0.9),(0.01,0.23),(0.01,0.23),
    # exmoor pony parameters
    (0.75,0.85),(0.75,0.85),(0.75,0.85),(0.12,0.18),(0.12,0.18),
    # cattle parameters
    (0.18,0.22),(0.75,0.85),(0.75,0.85),(0.75,0.85),(0.1,0.15),(0.1,0.15),
    # pig parameters
    (0.12,0.2),(0.6,0.75),(0.9,0.95),(0.9,0.95),(0.01,0.25),(0.01,0.25)]

    # bds = [
    #     # habitat repro & growth
    #     (0.0075,0.05),(0.01,0.05),(0.075,0.076),(0.0025,0.003),(0.014,0.017),
    #     (0.013,0.017), # mature scrub competition
    #     (0.17,0.18),(0.17,0.18), # grass
    #     (0.03,0.1),(0.01,0.1), # saplings
    #     (0.01,0.1),(0.03,0.1), # young scrub  
    #     # roe deer parameters
    #     (0.18,0.2),(0.8,0.82),(0.82,0.83),(0.82,0.83),(0.14,0.16),(0.14,0.16),
    #     # fallow deer parameters
    #     (0.3,0.45),(0.79,0.81),(0.81,0.82),(0.81,0.82),(0.13,0.15),(0.13,0.15),
    #     # red deer parameters
    #     (0.3,0.45),(0.78,0.8),(0.8,0.82),(0.8,0.82),(0.12,0.15),(0.12,0.15),
    #     # exmoor pony parameters
    #     (0.76,0.77),(0.78,0.8),(0.78,0.8),(0.11,0.14),(0.11,0.14),
    #     # cattle parameters
    #     (0.18,0.25),(0.75,0.77),(0.77,0.8),(0.77,0.8),(0.1,0.14),(0.1,0.14),
    #     # pig parameters
    #     (0.18,0.35),(0.63,0.75),(0.8,0.85),(0.8,0.85),(0.12,0.15),(0.12,0.15)]
