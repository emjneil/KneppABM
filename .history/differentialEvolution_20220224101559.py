...
def run_optimizer():
    ...
    bds = [
        ...
        # red deer parameters
        (0.38,0.43),(0.87,0.9),(0.87,0.9),(0.87,0.9),(0.13,0.16),(0.13,0.16),
        # exmoor pony parameters
        (0.83,0.88),(0.85,0.9),(0.83,0.9),(0.12,0.15),(0.12,0.15),
        # cattle parameters
        (0.17,0.21),(0.85,0.88),(0.83,0.87),(0.83,0.87),(0.12,0.15),(0.12,0.15),
        # pig parameters
        (0.18,0.4),(0.7,0.8),(0.87,0.95),(0.87,0.95),(0.13,0.17),(0.13,0.17)]
