...
def run_all_models():
    ...
    (filtered_Feb2016["Fallow deer"] <= 190) & (filtered_Feb2016["Fallow deer"] >= 190) &
    ...
    (filtered_Feb2019["Fallow deer"] <= 318) & (filtered_Feb2019["Fallow deer"] >= 238) &
    ...
    (filtered_Feb2020["Fallow deer"] <= 287) & (filtered_Feb2020["Fallow deer"] >= 207) &
    ...
    (filtered_April2020["Longhorn cattle"] <= 106) & (filtered_April2020["Longhorn cattle"] >= 56) &
    ...
    with open('/Users/emilyneil/Desktop/KneppABM/many_outputs2/one_perc/passed_filters.txt', 'w') as f:
    ...
    # save to csv
    accepted_parameters.to_csv('/Users/emilyneil/Desktop/KneppABM/many_outputs2/one_perc/accepted_parameters.csv')
