...
def run_optimizer():
    ...
    bds = [
        ...
        (0.01,0.013),(0.031,0.035),(0.084,0.085),(0.0026,0.0028),(0.024,0.03),
        (0.015,0.017), # mature scrub competition
        (0.17,0.175),(0.17,0.175), # grass
        (0.055,0.065),(0.02,0.03), # saplings
        (0.04,0.055),(0.05,0.065), # young scrub  
        # roe deer parameters
        (0.18,0.2),(0.9,0.93),(0.9,0.95),(0.9,0.95),(0.01,0.25),(0.01,0.25),
        # fallow deer parameters
        (0.33,0.35),(0.9,0.93),(0.9,0.93),(0.9,0.93),(0.01,0.25),(0.01,0.25),
        # red deer parameters
        (0.34,0.37),(0.9,0.93),(0.9,0.93),(0.9,0.93),(0.01,0.25),(0.01,0.25),
        # exmoor pony parameters
        (0.85,0.9),(0.88,0.92),(0.88,0.92),(0.01,0.2),(0.01,0.2),
        # cattle parameters
        (0.18,0.21),(0.87,0.92),(0.88,0.92),(0.88,0.9),(0.01,0.2),(0.01,0.2),
        # pig parameters
    ...
    initial_guess = [
        ...
        0.012     , 0.031     , 0.08479093, 0.0027    , 0.022     ,
        0.015     , 0.175     , 0.17477425, 0.06      , 0.02575999,
        0.0455012 , 0.06      , 0.18281812, 0.91      , 0.93      ,
        0.93      , 0.14      , 0.13      , 0.35      , 0.90594704,
        0.9275    , 0.92      , 0.13      , 0.12      , 0.37      ,
        0.90152721, 0.91226621, 0.93      , 0.13      , 0.13      ,
    ...
    res = minimize(objectiveFunction, initial_guess, method='Nelder-Mead', bounds=bds, options={'maxiter': 1})
