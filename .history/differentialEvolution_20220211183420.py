...
def run_optimizer():
    ...
    bds = [
        ...
        (0.025,0.035),(0.045,0.05),(0.073,0.076),(0.0017,0.0021),(0.013,0.05),
        (0.01,0.015), # mature scrub competition
        (0.085,0.087),(0.085,0.087), # grass
        (0.045,0.075),(0.02,0.05), # saplings
        (0.3,0.05),(0.04,0.075), # young scrub  
        # roe deer parameters
        (0.18,0.21),(0.75,0.8),(0.8,0.85),(0.8,0.85),(0.14,0.2),(0.14,0.2),
        # fallow deer parameters
        (0.36,0.42),(0.7,0.75),(0.75,0.8),(0.75,0.8),(0.1,0.16),(0.1,0.16),
        # red deer parameters
        (0.36,0.42),(0.68,0.73),(0.75,0.8),(0.75,0.8),(0.1,0.16),(0.1,0.16),
        # exmoor pony parameters
        (0.63,0.71),(0.73,0.78),(0.73,0.78),(0.1,0.15),(0.1,0.15),
        # cattle parameters
        (0.2,0.23),(0.65,0.7),(0.72,0.76),(0.72,0.76),(0.1,0.14),(0.1,0.14),
        # # pig parameters
