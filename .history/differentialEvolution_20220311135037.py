...
def run_optimizer():
    ...
    bds = [
        ...
        (0.0012,0.002), # mature scrub competition
        (0.09,0.1),(0.09,0.1), # grass
        (0.075,0.095),(0.02,0.03), # saplings
        (0.075,0.095),(0.075,0.095), # young scrub  
        # roe deer parameters
        (0.17,0.22),(0.89,0.94),(0.89,0.94),(0.89,0.94),(0.09,0.1),(0.05,0.09),
        # fallow deer parameters
        (0.3,0.31),(0.85,0.93),(0.8,0.93),(0.8,0.93),(0.05,0.09),(0.03,0.08),
        # red deer parameters
        (0.3,0.38),(0.85,0.93),(0.8,0.93),(0.8,0.93),(0.05,0.09),(0.03,0.08),
        # exmoor pony parameters
        (0.85,0.92),(0.8,0.9),(0.8,0.9),(0.025,0.09),(0.025,0.08),
        # cattle parameters
        (0.18,0.21),(0.85,0.9),(0.8,0.9),(0.8,0.9),(0.025,0.09),(0.025,0.08),
        # pig parameters
        (0.25,0.28),(0.75,0.82),(0.82,0.9),(0.82,0.9),(0.025,0.1),(0.025,0.09)]
