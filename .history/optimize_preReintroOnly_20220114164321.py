...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.028,0.033],[0.04,0.045],[0.03,0.035],[0.0015,0.002],[0.015,0.02],
        # habitat competition
        [0.025,0.03], # mature scrub
        [0.1,0.13],[0.08,0.1], # grass
        [0.075,0.08],[0.01,0.02], # saplings
        [0.04,0.045],[0.07,0.08], # young scrub  
        # roe deer parameters
        [0.18,0.21],[0.1,0.14],[0.1,0.12],[0.1,0.12],[0.025,0.075],[0.025,0.075]
    ])
...
#  The best solution found:
#  [0.02978627 0.04001659 0.03181897 0.00160631 0.01820707 0.0287625
#  0.11914944 0.0859934  0.07675938 0.01772103 0.04239854 0.07446818
#  0.18927851 0.14454829 0.11715024 0.11601291 0.07572239 0.05203799]
