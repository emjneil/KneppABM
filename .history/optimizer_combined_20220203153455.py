...
def run_optimizer():
    ...
    bds = np.array([
        ...
        # red deer parameters
        [0.25,0.45],[0.45,0.75],[0.55,0.8],[0.55,0.8],[0.075,0.12],[0.075,0.12],
        # exmoor pony parameters
        [0.4,0.7],[0.45,0.8],[0.45,0.8],[0.05,0.11],[0.05,0.11],
        # cattle parameters
        [0.15,0.3],[0.25,0.7],[0.35,0.75],[0.35,0.75],[0.05,0.11],[0.05,0.11],
        # # pig parameters
        [0.1,0.75],[0.1,0.6],[0.6,0.8],[0.6,0.8],[0.075,0.12],[0.075,0.12]
    ])
