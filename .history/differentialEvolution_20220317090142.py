...
def run_optimizer():
    ...
    bds = [
        ...
        (0.0063,0.0075),(0.007,0.0075), # young scrub  
        # roe deer parameters
        (0.16,0.19),(0.93,0.94),(0.93,0.94),(0.92,0.94),(0.09,0.2),(0.09,0.2),
        # fallow deer parameters
        (0.31,0.32),(0.92,0.93),(0.92,0.93),(0.92,0.93),(0.16,0.17),(0.13,0.15),
        # red deer parameters
