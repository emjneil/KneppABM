...
def run_optimizer():
    ...
    bds = [
        ...
        (0.01,0.012),(0.039,0.042),(0.075,0.076),(0.0025,0.003),(0.015,0.016),
        (0.014,0.016), # mature scrub competition
        (0.17,0.18),(0.17,0.18), # grass
        (0.04,0.06),(0.02,0.03), # saplings
        (0.03,0.05),(0.04,0.06), # young scrub  
        # roe deer parameters
        (0.17,0.19),(0.9,0.91),(0.9,0.91),(0.9,0.91),(0.15,0.17),(0.15,0.17),
        # fallow deer parameters
        (0.25,0.35),(0.87,0.9),(0.85,0.9),(0.85,0.9),(0.14,0.16),(0.14,0.16),
        # red deer parameters
        (0.38,0.43),(0.87,0.9),(0.87,0.9),(0.87,0.9),(0.14,0.16),(0.14,0.16),
        # exmoor pony parameters
        (0.83,0.88),(0.85,0.9),(0.83,0.9),(0.13,0.15),(0.13,0.15),
        # cattle parameters
        (0.17,0.21),(0.85,0.88),(0.83,0.87),(0.83,0.87),(0.13,0.15),(0.13,0.15),
        # pig parameters
        (0.18,0.4),(0.7,0.8),(0.87,0.95),(0.87,0.95),(0.14,0.17),(0.14,0.17)]
...
#        0.10452791, 0.10536622])
    ...
    with open('/Users/emilyneil/Desktop/KneppABM/outputs/post_reintro/differentialEvolution_outputs.txt', 'w') as f:
        print('run_number' + str(run_number) + 'Differential Evolution Outputs:', optimization, file=f)
    print(optimization)
...
def graph_results():
    output_parameters = run_optimizer(run_number)
