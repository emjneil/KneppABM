...
def run_optimizer():
    ...
    bds = [
        ...
        (0.012,0.014),(0.035,0.04),(0.083,0.085),(0.0026,0.0033),(0.014,0.016),
        (0.015,0.017), # mature scrub competition
        (0.17,0.18),(0.17,0.18), # grass
        (0.04,0.05),(0.02,0.04), # saplings
        (0.03,0.04),(0.04,0.05), # young scrub  
        # roe deer parameters
        (0.18,0.2),(0.93,0.94),(0.93,0.94),(0.92,0.94),(0.14,0.17),(0.14,0.17),
        # fallow deer parameters
        (0.31,0.35),(0.9,0.93),(0.9,0.93),(0.9,0.93),(0.13,0.16),(0.13,0.16),
        # red deer parameters
        (0.39,0.41),(0.88,0.92),(0.9,0.93),(0.9,0.93),(0.13,0.16),(0.13,0.16),
        # exmoor pony parameters
        (0.87,0.91),(0.9,0.92),(0.9,0.92),(0.12,0.16),(0.12,0.16),
        # cattle parameters
        (0.18,0.25),(0.88,0.91),(0.9,0.92),(0.9,0.92),(0.12,0.16),(0.12,0.16),
        # pig parameters
        (0.15,0.35),(0.75,0.85),(0.93,0.94),(0.93,0.94),(0.12,0.16),(0.12,0.16)]
