...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.01,0.02],[0.03,0.045],[0.07,0.08],[0.002,0.006],[0.01,0.05],
        ...
        # roe deer parameters
        [0.17,0.21],[0.5,0.75],[0.75,1],[0.75,1],[0.1,0.25],[0.1,0.25],
        # fallow deer parameters
        [0.15,0.45],[0.45,0.55],[0.65,0.75],[0.65,0.75],[0.08,0.25],[0.08,0.25],
        # red deer parameters
        [0.15,0.45],[0.45,0.5],[0.55,0.7],[0.55,0.7],[0.075,0.25],[0.075,0.25],
        # exmoor pony parameters
        [0.25,0.5],[0.45,0.65],[0.45,0.65],[0.05,0.2],[0.05,0.2],
        # cattle parameters
        [0.15,0.3],[0.25,0.35],[0.35,0.6],[0.35,0.6],[0.05,0.2],[0.05,0.2],
        # # pig parameters
        [0.01,0.1],[0.05,0.25],[0.4,0.75],[0.4,0.75],[0.01,0.25],[0.01,0.25]
    ])
