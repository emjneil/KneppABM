...
def run_optimizer():
    ...
    bds = [
        ...
        (0.011,0.012),(0.041,0.045),(0.083,0.085),(0.0026,0.0028),(0.014,0.015),
        (0.015,0.017), # mature scrub competition
        (0.17,0.18),(0.17,0.18), # grass
        (0.05,0.055),(0.03,0.05), # saplings
        (0.03,0.05),(0.052,0.055), # young scrub  
        # roe deer parameters
        (0.18,0.2),(0.93,0.94),(0.92,0.94),(0.92,0.94),(0.15,0.18),(0.15,0.18),
        # fallow deer parameters
        (0.35,0.41),(0.9,0.93),(0.9,0.93),(0.9,0.93),(0.13,0.15),(0.13,0.15),
        # red deer parameters
        (0.35,0.45),(0.89,0.93),(0.89,0.93),(0.89,0.93),(0.13,0.15),(0.13,0.15),
        # exmoor pony parameters
        (0.9,0.91),(0.89,0.92),(0.89,0.92),(0.12,0.14),(0.12,0.14),
        # cattle parameters
        (0.19,0.21),(0.89,0.91),(0.89,0.92),(0.89,0.92),(0.12,0.14),(0.12,0.14),
        # pig parameters
        (0.25,0.28),(0.8,0.83),(0.93,0.94),(0.93,0.94),(0.12,0.16),(0.12,0.16)]
