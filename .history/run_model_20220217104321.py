...
def run_all_models():
    ...
    for _ in range(number_simulations):
        ...
        pigs_gain_from_Saplings = random.uniform((output_parameters[45]-(output_parameters[45]*perc_aboveBelow)), (output_parameters["variable"][45]+(output_parameters["variable"][45]*perc_aboveBelow)))
        pigs_gain_from_YoungScrub = random.uniform((output_parameters["variable"][46]-(output_parameters["variable"][46]*perc_aboveBelow)), (output_parameters["variable"][46]+(output_parameters["variable"][46]*perc_aboveBelow)))
        # impact grass
