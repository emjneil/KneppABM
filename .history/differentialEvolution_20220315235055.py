...
def run_optimizer():
    ...
    bds = [
        ...
        (0.0025,0.0075),(0.0025,0.0075),(0.0135,0.014),(0.0023,0.0024),(0.0086,0.0087),
        (0.0015,0.005), # mature scrub competition
        (0.094,0.095),(0.093,0.094), # grass
        (0.0025,0.0075),(0.0025,0.0075), # saplings
        (0.0025,0.0075),(0.0025,0.0075), # young scrub  
        # roe deer parameters
        (0.18,0.19),(0.93,0.94),(0.91,0.92),(0.91,0.92),(0,0.14),(0,0.11),
        # fallow deer parameters
        (0.315,0.32),(0.92,0.93),(0.89,0.91),(0.89,0.91),(0.11,0.12),(0.085,0.1),
        # red deer parameters
        (0.36,0.37),(0.92,0.93),(0.89,0.91),(0.89,0.91),(0.09,0.12),(0.075,0.1),
        # exmoor pony parameters
        (0.9,0.91),(0.89,0.9),(0.88,0.9),(0.08,0.11),(0.05,0.09),
        # cattle parameters
        (0.185,0.19),(0.88,0.9),(0.88,0.9),(0.89,0.91),(0.08,0.11),(0.05,0.09),
        # pig parameters
        (0.25,0.35),(0.86,0.88),(0.9,0.94),(0.9,0.94),(0.09,0.14),(0.06,0.11)]
