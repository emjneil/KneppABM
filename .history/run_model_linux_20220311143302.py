...
def run_all_models():
    ...
    for _ in range(number_simulations):
        ...
        chance_reproduceSapling = random.uniform(0.00363746-(0.00363746*perc_aboveBelow), 0.00363746+(0.00363746*perc_aboveBelow))
        chance_reproduceYoungScrub = random.uniform(0.00398376-(0.00398376*perc_aboveBelow), 0.00398376+(0.00398376*perc_aboveBelow))

        chance_regrowGrass = random.uniform(0.01439831-(0.01439831*perc_aboveBelow), 0.01439831+(0.01439831*perc_aboveBelow))
        chance_saplingBecomingTree = random.uniform(0.00247949-(0.00247949*perc_aboveBelow), 0.00247949+(0.00247949*perc_aboveBelow))
        chance_youngScrubMatures =random.uniform(0.00612243-(0.00612243*perc_aboveBelow), 0.00612243+(0.00612243*perc_aboveBelow))
        chance_scrubOutcompetedByTree = random.uniform(0.00154572-(0.00154572*perc_aboveBelow), 0.00154572+(0.00154572*perc_aboveBelow))

        chance_grassOutcompetedByTree = random.uniform(0.09076791-(0.09076791*perc_aboveBelow), 0.09076791+(0.09076791*perc_aboveBelow))
        chance_grassOutcompetedByScrub = random.uniform(0.09781457-(0.09781457*perc_aboveBelow), 0.09781457+(0.09781457*perc_aboveBelow))
        chance_saplingOutcompetedByTree = random.uniform(0.0872984-(0.0872984*perc_aboveBelow), 0.0872984+(0.0872984*perc_aboveBelow))
        chance_saplingOutcompetedByScrub = random.uniform(0.0252614-(0.0252614*perc_aboveBelow), 0.0252614+(0.0252614*perc_aboveBelow))
        chance_youngScrubOutcompetedByScrub =random.uniform(0.08107137-(0.08107137*perc_aboveBelow), 0.08107137+(0.08107137*perc_aboveBelow))
        chance_youngScrubOutcompetedByTree = random.uniform(0.0773524-(0.0773524*perc_aboveBelow), 0.0773524+(0.0773524*perc_aboveBelow))
        ...
        # roe deer
        roeDeer_reproduce = random.uniform(0.21242423-(0.21242423*perc_aboveBelow), 0.21242423+(0.21242423*perc_aboveBelow))
        roeDeer_gain_from_grass = random.uniform(0.91492895-(0.91492895*perc_aboveBelow), 0.91492895+(0.91492895*perc_aboveBelow))
        roeDeer_gain_from_Trees =random.uniform(0.93626946-(0.93626946*perc_aboveBelow), 0.93626946+(0.93626946*perc_aboveBelow))
        roeDeer_gain_from_Scrub =random.uniform(0.90584016-(0.90584016*perc_aboveBelow), 0.90584016+(0.90584016*perc_aboveBelow))
        roeDeer_gain_from_Saplings = random.uniform(0.09774338-(0.09774338*perc_aboveBelow), 0.09774338+(0.09774338*perc_aboveBelow))
        roeDeer_gain_from_YoungScrub = random.uniform(0.08670035-(0.08670035*perc_aboveBelow), 0.08670035+(0.08670035*perc_aboveBelow))
        # Fallow deer
        fallowDeer_reproduce = random.uniform(0.30395749-(0.30395749*perc_aboveBelow), 0.30395749+(0.30395749*perc_aboveBelow))
        fallowDeer_gain_from_grass = random.uniform(0.89600212-(0.89600212*perc_aboveBelow), 0.89600212+(0.89600212*perc_aboveBelow))
        fallowDeer_gain_from_Trees = random.uniform(0.88448929-(0.88448929*perc_aboveBelow), 0.88448929+(0.88448929*perc_aboveBelow))
        fallowDeer_gain_from_Scrub = random.uniform(0.91179716-(0.91179716*perc_aboveBelow), 0.91179716+(0.91179716*perc_aboveBelow))
        fallowDeer_gain_from_Saplings = random.uniform(0.07577348-(0.07577348*perc_aboveBelow), 0.07577348+(0.07577348*perc_aboveBelow))
        fallowDeer_gain_from_YoungScrub = random.uniform(0.05126157-(0.05126157*perc_aboveBelow), 0.05126157+(0.05126157*perc_aboveBelow))
        # Red deer
        redDeer_reproduce = random.uniform(0.33402819-(0.33402819*perc_aboveBelow), 0.33402819+(0.33402819*perc_aboveBelow))
        redDeer_gain_from_grass = random.uniform(0.87508469-(0.87508469*perc_aboveBelow), 0.87508469+(0.87508469*perc_aboveBelow))
        redDeer_gain_from_Trees = random.uniform(0.92910842-(0.92910842*perc_aboveBelow), 0.92910842+(0.92910842*perc_aboveBelow))
        redDeer_gain_from_Scrub = random.uniform(0.8649237-(0.8649237*perc_aboveBelow), 0.8649237+(0.8649237*perc_aboveBelow))
        redDeer_gain_from_Saplings = random.uniform(0.07281205-(0.07281205*perc_aboveBelow), 0.07281205+(0.07281205*perc_aboveBelow))
        redDeer_gain_from_YoungScrub = random.uniform(0.05774011-(0.05774011*perc_aboveBelow), 0.05774011+(0.05774011*perc_aboveBelow))
        # Exmoor ponies
        ponies_gain_from_grass = random.uniform(0.91995145-(0.91995145*perc_aboveBelow), 0.91995145+(0.91995145*perc_aboveBelow))
        ponies_gain_from_Trees = random.uniform(0.87282624-(0.87282624*perc_aboveBelow), 0.87282624+(0.87282624*perc_aboveBelow)) 
        ponies_gain_from_Scrub = random.uniform(0.88342492-(0.88342492*perc_aboveBelow), 0.88342492+(0.88342492*perc_aboveBelow))
        ponies_gain_from_Saplings = random.uniform(0.06321734-(0.06321734*perc_aboveBelow), 0.06321734+(0.06321734*perc_aboveBelow))
        ponies_gain_from_YoungScrub = random.uniform(0.06506027-(0.06506027*perc_aboveBelow), 0.06506027+(0.06506027*perc_aboveBelow))
        # Longhorn cattle
        cows_reproduce = random.uniform(0.18213533-(0.18213533*perc_aboveBelow), 0.18213533+(0.18213533*perc_aboveBelow))
        cows_gain_from_grass = random.uniform(0.86225527-(0.86225527*perc_aboveBelow), 0.86225527+(0.86225527*perc_aboveBelow))
        cows_gain_from_Trees = random.uniform(0.88008693-(0.88008693*perc_aboveBelow), 0.88008693+(0.88008693*perc_aboveBelow))
        cows_gain_from_Scrub = random.uniform(0.8662372-(0.8662372*perc_aboveBelow), 0.8662372+(0.8662372*perc_aboveBelow))
        cows_gain_from_Saplings = random.uniform(0.06170927-(0.06170927*perc_aboveBelow), 0.06170927+(0.06170927*perc_aboveBelow))
        cows_gain_from_YoungScrub = random.uniform(0.06513015-(0.06513015*perc_aboveBelow), 0.06513015+(0.06513015*perc_aboveBelow))
        # Tamworth pigs
        pigs_reproduce = random.uniform(0.25581066-(0.25581066*perc_aboveBelow), 0.25581066+(0.25581066*perc_aboveBelow))
        pigs_gain_from_grass = random.uniform(0.78745503-(0.78745503*perc_aboveBelow), 0.78745503+(0.78745503*perc_aboveBelow))
        pigs_gain_from_Trees =random.uniform(0.9-(0.9*perc_aboveBelow), 0.9+(0.9*perc_aboveBelow))
        pigs_gain_from_Scrub = random.uniform(0.9-(0.9*perc_aboveBelow), 0.9+(0.9*perc_aboveBelow))
        pigs_gain_from_Saplings = random.uniform(0.06627703-(0.06627703*perc_aboveBelow), 0.06627703+(0.06627703*perc_aboveBelow))
        pigs_gain_from_YoungScrub = random.uniform(0.06833359-(0.06833359*perc_aboveBelow), 0.06833359+(0.06833359*perc_aboveBelow))
    ...
    # (filtered_preReintro["Longhorn cattle"] <= 140) & (filtered_preReintro["Longhorn cattle"] >= 90) &
    ...
    # with open('/Users/emilyneil/Desktop/KneppABM/outputs/one_perc/passed_filters.txt', 'w') as f:
    # with open('passed_filters.txt', 'w') as f:
