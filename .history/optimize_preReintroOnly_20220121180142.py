...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.015,0.05],[0.015,0.05],[0.05,0.1],[0.002,0.004],[0.005,0.05],
        [0.018,0.05], # mature scrub competition
        [0.055,0.075],[0.055,0.065], # grass
        [0.035,0.055],[0.025,0.045], # saplings
        [0.025,0.05],[0.025,0.055], # young scrub  
        # roe deer parameters
        [0.15,0.21],[0.3,0.5],[0.3,0.5],[0.3,0.5],[0.3,0.5],[0.3,0.5]
    ])
