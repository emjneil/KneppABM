...
class KneppModel(Model):
    ...
    def __init__(self,             
        ...
        self.datacollector = DataCollector(
                        ...
                        "Outcompeted Grass": lambda m: self.count_habitats_outcompeted_scrub(m, "grass"),
                        "Outcompeted Mature Scrub": lambda m: self.count_habitats_outcompeted_scrub(m, "scrub"),
                        "Outcompeted Saplings": lambda m: self.count_habitats_outcompeted_scrub(m, "saplings"),
                        "Outcompeted Young Scrub": lambda m: self.count_habitats_outcompeted_scrub(m, "youngScrub"), 
