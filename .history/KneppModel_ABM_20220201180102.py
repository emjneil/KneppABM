...
class tamworthPigs(RandomWalker):
    ...
    def giveBirth(self):
        ...
        for _ in range(random.randint(1,10)):
            piglet_condition == "piglet"
            piglet = tamworthPigs(self.model.next_id(), self.pos, self.model, self.moore, self.energy, self.condition == piglet_condition)
            print(piglet.condition)
