...
def run_optimizer():
    ...
    bds = [
        ...
        # roe deer parameters
        (0.17,0.22),(0.89,0.94),(0.89,0.94),(0.89,0.94),(0.09,0.1),(0.075,0.09),
        # fallow deer parameters
        (0.3,0.31),(0.85,0.93),(0.8,0.93),(0.8,0.93),(0.05,0.09),(0.05,0.08),
        # red deer parameters
        (0.3,0.38),(0.85,0.93),(0.8,0.93),(0.8,0.93),(0.05,0.09),(0.05,0.08),
        # exmoor pony parameters
        (0.85,0.92),(0.8,0.9),(0.8,0.9),(0.05,0.08),(0.05,0.075),
        # cattle parameters
        (0.18,0.21),(0.85,0.9),(0.8,0.9),(0.8,0.9),(0.05,0.08),(0.05,0.075),
        # pig parameters
