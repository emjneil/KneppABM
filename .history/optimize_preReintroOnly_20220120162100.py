...
def objectiveFunction(x):
    ...
    chance_grassOutcompetedByTree = 0.48
    chance_grassOutcompetedByScrub = 0.44
...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.07,0.075],[0.11,0.13],[0.15,0.16],[0.0015,0.0025],[0.0065,0.015],
        # habitat competition
        [0.02,0.025], # mature scrub
        # [0.48,0.5],[0.44,0.45], # grass
        [0.7,0.8],[0.3,0.7], # saplings
        [0.3,0.7],[0.6,0.8], # young scrub  
        # roe deer parameters
        [0.17,0.21],[0.1,0.25],[0.12,0.2],[0.12,0.2],[0.1,0.15],[0.1,0.15]
    ])
