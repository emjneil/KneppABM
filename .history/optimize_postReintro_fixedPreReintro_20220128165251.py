...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.35,0.45],[0.45,0.55],[0.65,0.75],[0.65,0.75],[0.08,0.12],[0.08,0.12],
        # red deer parameters
        [0.33,0.45],[0.45,0.5],[0.55,0.7],[0.55,0.7],[0.075,0.12],[0.075,0.12],
        # exmoor pony parameters
        [0.4,0.5],[0.3,0.65],[0.3,0.65],[0.05,0.11],[0.05,0.11],
        # cattle parameters
        [0.15,0.3],[0.25,0.35],[0.25,0.5],[0.25,0.5],[0.05,0.11],[0.05,0.11],
        # # pig parameters
        [0.01,0.2],[0.05,0.25],[0.4,0.75],[0.4,0.75],[0.01,0.15],[0.01,0.15]
    ])
