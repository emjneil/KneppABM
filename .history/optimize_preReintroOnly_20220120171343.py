...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.07,0.13],[0.11,0.13],[0.15,0.16],[0.0015,0.006],[0.004,0.08],
        # habitat competition
        [0.02,0.025], # mature scrub
        # [0.48,0.5],[0.44,0.45], # grass
        [0.75,0.9],[0.2,0.4], # saplings
        [0.2,0.4],[0.5,0.9], # young scrub  
        # roe deer parameters
        [0.17,0.21],[0.1,0.25],[0.12,0.2],[0.12,0.2],[0.075,0.13],[0.075,0.13]
    ])
