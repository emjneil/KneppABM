...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.02,0.03],[0.025,0.035],[0.075,0.077],[0.002,0.006],[0.01,0.02],
        [0.01,0.015], # mature scrub competition
        [0.06,0.075],[0.06,0.075], # grass
        [0.025,0.035],[0.025,0.035], # saplings
        [0.025,0.035],[0.025,0.035], # young scrub  
        # roe deer parameters
        [0.15,0.21],[0.5,0.75],[0.75,1],[0.75,1],[0.1,0.2],[0.1,0.2]
    ])
