...
def run_optimizer():
    ...
    bds = [
        ...
        (0.0016,0.0022), # mature scrub competition
        (0.094,0.095),(0.093,0.094), # grass
        (0.088,0.095),(0.015,0.017), # saplings
        (0.077,0.08),(0.088,0.095), # young scrub  
        # roe deer parameters
        (0.18,0.20),(0.91,0.92),(0.91,0.92),(0.91,0.92),(0.1,0.12),(0.08,0.095),
        # fallow deer parameters
        (0.31,0.32),(0.89,0.91),(0.89,0.91),(0.89,0.91),(0.1,0.13),(0.075,0.09),
        # red deer parameters
        (0.36,0.38),(0.89,0.91),(0.89,0.91),(0.89,0.91),(0.09,0.13),(0.075,0.09),
