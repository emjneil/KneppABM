...
def objectiveFunction(x):
    ...
    if (list(results.loc[results['Time'] == 1, 'Saplings'])[0]) > (list(results.loc[results['Time'] == 0, 'Saplings'])[0]) and (list(results.loc[results['Time'] == 1, 'Young Scrub'])[0]) > (list(results.loc[results['Time'] == 0, 'Young Scrub'])[0]):
        ...
        filtered_result = (
        ((list(results.loc[results['Time'] == 1, 'Saplings'])[0]) - (list(results.loc[results['Time'] == 0, 'Saplings'])[0])**2)+
        (list(results.loc[results['Time'] == 1, 'Young Scrub'])[0]) - (list(results.loc[results['Time'] == 0, 'Young Scrub'])[0])**2)
