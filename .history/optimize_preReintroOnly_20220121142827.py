...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.01,0.1],[0.01,0.1],[0,0.1],[0.0015,0.006],[0.004,0.08],
        # habitat competition
        [0,0.05], # mature scrub
        [0,0.1],[0,0.1], # grass
        ...
        # roe deer parameters
        [0.15,0.2],[0.01,0.25],[0.01,0.25],[0.01,0.25],[0.01,0.25],[0.01,0.25]
    ])
...
def graph_results():
    ...
    death_by = np.tile(["Grown saplings", "Outcompeted Saplings", "Outcompeted Saplings-Scrub", "Eaten Saplings", "Grown young scrub", "Outcompeted Young Scrub", "Outcompeted Young Scrub-Scrub", "Eaten Young Scrub", "Outcompeted Grass", "Outcompeted Grass-Scrub", "Eaten Grass", "Outcompeted Mature Scrub", "Eaten Mature Scrub", "Eaten Trees"], 51)
    amount_killed = final_results.drop(['Time', "Bare ground","Grassland", "Woodland", "Thorny Scrub", "Roe deer", "Exmoor pony", "Fallow deer", "Longhorn cattle", "Red deer", "Tamworth pigs", "Bare Areas"], axis=1).values.flatten()        
    stacked_time = np.repeat(final_results['Time'], 14)

    final_df_stacked = pd.DataFrame(
    {'Time': stacked_time, 'Ecosystem Element': habitat_type, 'Abundance': stacked_abundance, 'Death By': death_by})
    ...
    outcompeted_youngScrub = final_results.drop(['Time', "Bare ground", "Grassland", "Woodland", "Thorny Scrub", "Roe deer", "Exmoor pony", "Fallow deer", "Longhorn cattle", "Red deer", "Tamworth pigs", "Grass", "Trees", "Mature Scrub", "Saplings", "Young Scrub", "Bare Areas", "Grown saplings", "Grown young scrub", "Outcompeted Grass", "Outcompeted Mature Scrub", "Outcompeted Saplings", "Outcompeted Grass-Scrub", "Outcompeted Young Scrub-Scrub", "Outcompeted Saplings-Scrub", "Eaten Grass", "Eaten Trees", "Eaten Mature Scrub", "Eaten Saplings", "Eaten Young Scrub"], axis=1).values.flatten() 
    outcompeted_youngScrub_tiled = np.repeat(outcompeted_youngScrub, 6)
    # and outcompeted by mature scrub
    outcompeted_grass_byScrub = final_results.drop(['Time', "Bare ground", "Grassland", "Woodland", "Thorny Scrub", "Roe deer", "Exmoor pony", "Fallow deer", "Longhorn cattle", "Red deer", "Tamworth pigs", "Grass", "Trees", "Mature Scrub", "Saplings", "Young Scrub", "Bare Areas", "Grown saplings", "Grown young scrub", "Outcompeted Grass", "Outcompeted Mature Scrub", "Outcompeted Saplings", "Outcompeted Young Scrub","Outcompeted Young Scrub-Scrub", "Outcompeted Saplings-Scrub", "Eaten Grass", "Eaten Trees", "Eaten Mature Scrub", "Eaten Saplings", "Eaten Young Scrub"], axis=1).values.flatten() 
    outcompeted_grass_byScrub_tiled = np.repeat(outcompeted_grass_byScrub, 6)
    outcompeted_youngScrub_byScrub = final_results.drop(['Time', "Bare ground", "Grassland", "Woodland", "Thorny Scrub", "Roe deer", "Exmoor pony", "Fallow deer", "Longhorn cattle", "Red deer", "Tamworth pigs", "Grass", "Trees", "Mature Scrub", "Saplings", "Young Scrub", "Bare Areas", "Grown saplings", "Grown young scrub", "Outcompeted Grass", "Outcompeted Mature Scrub", "Outcompeted Saplings", "Outcompeted Young Scrub", "Outcompeted Grass-Scrub", "Outcompeted Saplings-Scrub", "Eaten Grass", "Eaten Trees", "Eaten Mature Scrub", "Eaten Saplings", "Eaten Young Scrub"], axis=1).values.flatten() 
    outcompeted_youngScrub_byScrub_tiled =np.repeat(outcompeted_youngScrub_byScrub, 6)
    outcompeted_sapling_byScrub = final_results.drop(['Time', "Bare ground", "Grassland", "Woodland", "Thorny Scrub", "Roe deer", "Exmoor pony", "Fallow deer", "Longhorn cattle", "Red deer", "Tamworth pigs", "Grass", "Trees", "Mature Scrub", "Saplings", "Young Scrub", "Bare Areas", "Grown saplings", "Grown young scrub", "Outcompeted Grass", "Outcompeted Mature Scrub", "Outcompeted Saplings", "Outcompeted Young Scrub", "Outcompeted Grass-Scrub", "Outcompeted Young Scrub-Scrub",  "Eaten Grass", "Eaten Trees", "Eaten Mature Scrub", "Eaten Saplings", "Eaten Young Scrub"], axis=1).values.flatten() 
    outcompeted_sapling_byScrub_tiled =np.repeat(outcompeted_sapling_byScrub, 6)
    # and eaten by deer
    grass_eatenByDeer = final_results.drop(['Time', "Bare ground", "Grassland", "Woodland", "Thorny Scrub", "Roe deer", "Exmoor pony", "Fallow deer", "Longhorn cattle", "Red deer", "Tamworth pigs", "Grass", "Trees", "Mature Scrub", "Saplings", "Young Scrub", "Bare Areas", "Grown saplings", "Grown young scrub", "Outcompeted Grass", "Outcompeted Mature Scrub", "Outcompeted Saplings", "Outcompeted Young Scrub", "Outcompeted Grass-Scrub", "Outcompeted Young Scrub-Scrub", "Outcompeted Saplings-Scrub", "Eaten Trees", "Eaten Mature Scrub", "Eaten Saplings", "Eaten Young Scrub"], axis=1).values.flatten() 
    grass_eatenByDeer_tiled =np.repeat(grass_eatenByDeer, 6)
    trees_eatenByDeer = final_results.drop(['Time', "Bare ground", "Grassland", "Woodland", "Thorny Scrub", "Roe deer", "Exmoor pony", "Fallow deer", "Longhorn cattle", "Red deer", "Tamworth pigs", "Grass", "Trees", "Mature Scrub", "Saplings", "Young Scrub", "Bare Areas", "Grown saplings", "Grown young scrub", "Outcompeted Grass", "Outcompeted Mature Scrub", "Outcompeted Saplings", "Outcompeted Young Scrub", "Outcompeted Grass-Scrub", "Outcompeted Young Scrub-Scrub", "Outcompeted Saplings-Scrub", "Eaten Grass", "Eaten Mature Scrub", "Eaten Saplings", "Eaten Young Scrub"], axis=1).values.flatten() 
    trees_eatenByDeer_tiled =np.repeat(trees_eatenByDeer, 6)
    scrub_eatenByDeer = final_results.drop(['Time', "Bare ground", "Grassland", "Woodland", "Thorny Scrub", "Roe deer", "Exmoor pony", "Fallow deer", "Longhorn cattle", "Red deer", "Tamworth pigs", "Grass", "Trees", "Mature Scrub", "Saplings", "Young Scrub", "Bare Areas", "Grown saplings", "Grown young scrub", "Outcompeted Grass", "Outcompeted Mature Scrub", "Outcompeted Saplings", "Outcompeted Young Scrub", "Outcompeted Grass-Scrub", "Outcompeted Young Scrub-Scrub", "Outcompeted Saplings-Scrub", "Eaten Grass", "Eaten Trees",  "Eaten Saplings", "Eaten Young Scrub"], axis=1).values.flatten() 
    scrub_eatenByDeer_tiled =np.repeat(scrub_eatenByDeer, 6)
    saplings_eatenByDeer = final_results.drop(['Time', "Bare ground", "Grassland", "Woodland", "Thorny Scrub", "Roe deer", "Exmoor pony", "Fallow deer", "Longhorn cattle", "Red deer", "Tamworth pigs", "Grass", "Trees", "Mature Scrub", "Saplings", "Young Scrub", "Bare Areas", "Grown saplings", "Grown young scrub", "Outcompeted Grass", "Outcompeted Mature Scrub", "Outcompeted Saplings", "Outcompeted Young Scrub", "Outcompeted Grass-Scrub", "Outcompeted Young Scrub-Scrub", "Outcompeted Saplings-Scrub", "Eaten Grass", "Eaten Trees", "Eaten Mature Scrub","Eaten Young Scrub"], axis=1).values.flatten() 
    saplings_eatenByDeer_tiled =np.repeat(saplings_eatenByDeer, 6)
    youngScrub_eatenByDeer = final_results.drop(['Time', "Bare ground", "Grassland", "Woodland", "Thorny Scrub", "Roe deer", "Exmoor pony", "Fallow deer", "Longhorn cattle", "Red deer", "Tamworth pigs", "Grass", "Trees", "Mature Scrub", "Saplings", "Young Scrub", "Bare Areas", "Grown saplings", "Grown young scrub", "Outcompeted Grass", "Outcompeted Mature Scrub", "Outcompeted Saplings", "Outcompeted Young Scrub", "Outcompeted Grass-Scrub", "Outcompeted Young Scrub-Scrub", "Outcompeted Saplings-Scrub", "Eaten Grass", "Eaten Trees", "Eaten Mature Scrub", "Eaten Saplings"], axis=1).values.flatten() 
    youngScrub_eatenByDeer_tiled =np.repeat(youngScrub_eatenByDeer, 6)
    stacked_eco_element = np.tile(["Grass", "Trees", "Mature Scrub", "Saplings", "Young Scrub", "Bare Areas"], 51)

    final_df_stacked = pd.DataFrame(
    {'Time': final_results['Time'], 'Ecosystem Element': stacked_eco_element, 'Abundance': stacked_abundance, 'Grown saplings': grown_saplings_tiled, 'Grown Young Scrub': grown_youngScrub_tiled, 'Grass Outcompeted by Tree': outcompeted_grass_tiled, 'Scrub Outcompeted by Tree': outcompeted_scrub_tiled, 'Sapling Outcompeted by Tree': outcompeted_sapling_tiled, 'Young Scrub Outcompeted by Tree': outcompeted_youngScrub_tiled, 
    'Grass Outcompeted by Scrub': outcompeted_grass_byScrub_tiled, 'Young Scrub Outcompeted By Scrub': outcompeted_youngScrub_byScrub_tiled, 'Sapling Outcompeted by Scrub': outcompeted_sapling_byScrub_tiled, 
    'Grass Eaten by Roe Deer': grass_eatenByDeer_tiled, 
    'Trees Eaten by Roe Deer': trees_eatenByDeer_tiled, 'Scrub Eaten by Roe Deer': scrub_eatenByDeer_tiled, 'Saplings Eaten By Roe Deer': saplings_eatenByDeer_tiled, 'Young Scrub Eaten by Roe Deer': youngScrub_eatenByDeer_tiled})
    
    # final_df_stacked.to_excel("output df.xlsx")  
