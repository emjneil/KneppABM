...
class habitatAgent (Agent):
    ...
    def step(self):
        ...
        # don't let it go over 780 mature shrubs
        number_scrub_maturing = min(number_scrub_maturing, 780 - self.edibles['scrub'])
        ...
        # don't let it go over 390 trees
        number_saplings_maturing = min(number_saplings_maturing, 390 - self.edibles["trees"])
        ...
        available_sapling_cell = [i for i in no_herbivores if i.edibles["saplings"] < 11500 and i.edibles["trees"] < 390]
        ...
        available_youngscrub_cell = [i for i in no_herbivores if i.edibles["youngScrub"] < 11500 and i.edibles['scrub'] < 390]
        ...
        combined_trees_shrubs = ((self.edibles["trees"]/390)*self.model.chance_grassOutcompetedByTree) + ((self.edibles['scrub']/780)*self.model.chance_grassOutcompetedByScrub)
        ...
        mature_scrub_outcompeted = np.random.binomial(n=self.edibles['scrub'], p=(self.edibles["trees"]/390)*self.model.chance_scrubOutcompetedByTree)
        self.edibles['scrub'] -= mature_scrub_outcompeted

        # saplings being outcompeted by scrub/trees
        combined_saplings = ((self.edibles["trees"]/390)*self.model.chance_saplingOutcompetedByTree) + ((self.edibles['scrub']/780)*self.model.chance_saplingOutcompetedByScrub)
        ...
        # combined_scrub = ((self.edibles["trees"]/390)*self.model.chance_youngScrubOutcompetedByTree) + ((self.edibles['scrub']/780)*self.model.chance_youngScrubOutcompetedByScrub)
        ...
        for _ in range(len(habitat_choices)):
            if self.energy < 1:
                ...
                if my_choice == "saplings":
                    ...
                    if eatenSaps >= habitat_patch.edibles["saplings"] - (round(habitat_patch.edibles["saplings"] * (habitat_patch.edibles['scrub']/780))):
                        eatenSaps = habitat_patch.edibles["saplings"] - (round(habitat_patch.edibles["saplings"] * (habitat_patch.edibles['scrub']/780)))
                    ...
                    # scrub facilitates saplings by preventing herbivory
                    if eatenYoungScrub >= habitat_patch.edibles["youngScrub"] - (round(habitat_patch.edibles["youngScrub"] * (habitat_patch.edibles['scrub']/780))):
                        eatenYoungScrub = habitat_patch.edibles["youngScrub"] - (round(habitat_patch.edibles["youngScrub"] * (habitat_patch.edibles['scrub']/780)))
    ...
    def __init__(self,             
        ...
        for cell, condit, in zip(self.grid.coord_iter(), condition):
            ...
            if my_condition == 'grassland': # more than 50% grassland, no more than 10 mature trees/shrubs
                ...
                trees_here = random.randint(0, 49)
                saplings_here = random.randint(0, round(max_start_saplings * 11500))
                scrub_here = random.randint(50, 780)
                youngscrub_here = random.randint(0, round(max_start_youngScrub * 11500))
                ...
                trees_here = random.randint(49, 390)
                saplings_here = random.randint(0, round(max_start_saplings * 11500))
                scrub_here = random.randint(0, 780)
                youngscrub_here = random.randint(0, round(max_start_youngScrub * 11500))
                perc_grass_here = random.randint(0, 100)
                perc_bareground_here = 100 - perc_grass_here
