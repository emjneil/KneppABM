...
def run_optimizer():
    ...
    bds = [
        ...
        (0.002,0.0036),(0.002,0.0036),(0.0135,0.014),(0.0023,0.0024),(0.0086,0.0087),
        (0.0014,0.0015), # mature scrub competition
        (0.094,0.095),(0.093,0.094), # grass
        (0.084,0.1),(0.015,0.02), # saplings
        (0.084,0.075),(0.084,0.1), # young scrub  
        # roe deer parameters
        (0.18,0.20),(0.92,0.94),(0.91,0.94),(0.91,0.94),(0.11,0.15),(0.05,0.11),
        # fallow deer parameters
        (0.31,0.32),(0.89,0.92),(0.89,0.92),(0.89,0.92),(0.1,0.13),(0.05,0.1),
        # red deer parameters
        (0.36,0.38),(0.89,0.92),(0.89,0.92),(0.89,0.92),(0.09,0.13),(0.05,0.1),
        # exmoor pony parameters
        (0.88,0.9),(0.88,0.91),(0.88,0.9),(0.085,0.12),(0.05,0.1),
        # cattle parameters
        (0.18,0.19),(0.88,0.91),(0.88,0.9),(0.88,0.9),(0.085,0.12),(0.05,0.1),
        # pig parameters
        (0.2,0.3),(0.85,0.9),(0.92,0.94),(0.92,0.94),(0.085,0.13),(0.05,0.1)]
