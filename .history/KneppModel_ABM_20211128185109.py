...
class KneppModel(Model):
    ...
    def __init__(self,             
        ...
        for cell, condit, in zip(self.grid.coord_iter(), condition):
            ...
            i, x, y = cell
            my_condition = condit
            if my_condition == 'grassland' and self.RC1_noFood == False and self.RC2_noTreesScrub == False and self.RC3_noTrees == False: # more than 50% grassland, no more than 10 mature trees/shrubs
