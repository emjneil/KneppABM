...
def graph_runs():
    ...
    final_df.to_excel("/Users/emilyneil/Desktop/KneppABM/many_outputs/five_perc/combined_df.xlsx")
    ...
    plt.savefig('/Users/emilyneil/Desktop/KneppABM/many_outputs/five_perc/5%_counterfactual.png')
    plt.show()
    ...
    plt.savefig('/Users/emilyneil/Desktop/KneppABM/many_outputs/five_perc/5%_rejected_accepted_runs.png')
    plt.show()
