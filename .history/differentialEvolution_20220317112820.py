...
def run_optimizer():
    ...
    bds = [
        ...
        # roe deer parameters
        (0.18,0.19),(0.93,0.94),(0.93,0.94),(0.93,0.94),(0.1,0.25),(0.1,0.25),
        # fallow deer parameters
        (0.31,0.32),(0.92,0.93),(0.92,0.93),(0.92,0.93),(0.1,0.25),(0.1,0.25),
        # red deer parameters
        (0.34,0.354),(0.92,0.95),(0.92,0.95),(0.92,0.95),(0.1,0.25),(0.1,0.25),
        # exmoor pony parameters
        (0.91,0.92),(0.91,0.92),(0.91,0.92),(0.1,0.25),(0.1,0.25),
        # cattle parameters
        (0.18,0.21),(0.91,0.94),(0.89,0.94),(0.92,0.94),(0.1,0.25),(0.1,0.25),
        # pig parameters
        (0.29,0.31),(0.86,0.88),(0.93,0.95),(0.93,0.95),(0.1,0.25),(0.1,0.25)]
