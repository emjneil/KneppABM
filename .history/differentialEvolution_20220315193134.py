...
def run_optimizer():
    ...
    bds = [
        ...
        # roe deer parameters
        (0.16,0.20),(0.93,0.94),(0.91,0.92),(0.91,0.92),(0.11,0.14),(0.1,0.12),
        # fallow deer parameters
        (0.315,0.32),(0.91,0.93),(0.89,0.91),(0.89,0.91),(0.1,0.13),(0.09,0.11),
        # red deer parameters
        (0.36,0.37),(0.91,0.93),(0.89,0.91),(0.89,0.91),(0.1,0.13),(0.09,0.11),
        # exmoor pony parameters
        (0.89,0.91),(0.88,0.9),(0.88,0.9),(0.08,0.12),(0.08,0.1),
        # cattle parameters
        (0.18,0.19),(0.89,0.91),(0.88,0.9),(0.88,0.9),(0.08,0.12),(0.08,0.1),
        # pig parameters
        (0.15,0.3),(0.85,0.89),(0.9,0.92),(0.9,0.92),(0.08,0.14),(0.08,0.12)]
