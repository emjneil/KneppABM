...
def run_optimizer():
    ...
    bds = [
        ...
        (0.003,0.0035),(0.0025,0.0035),(0.0135,0.014),(0.0021,0.0022),(0.0067,0.007),
        (0.0025,0.0027), # mature scrub competition
        (0.094,0.095),(0.093,0.094), # grass
        (0.0071,0.0073),(0.0015,0.0022), # saplings
        (0.007,0.0072),(0.0071,0.0073), # young scrub  
        # roe deer parameters
        (0.18,0.19),(0.93,0.94),(0.93,0.94),(0.93,0.94),(0.19,0.2),(0.14,0.15),
        # fallow deer parameters
        (0.31,0.32),(0.92,0.93),(0.92,0.93),(0.92,0.93),(0.18,0.19),(0.12,0.13),
        # red deer parameters
        (0.34,0.354),(0.92,0.93),(0.92,0.93),(0.92,0.93),(0.18,0.19),(0.12,0.13),
        # exmoor pony parameters
        (0.91,0.92),(0.91,0.92),(0.91,0.92),(0.16,0.17),(0.1,0.11),
        # cattle parameters
        (0.195,0.21),(0.91,0.92),(0.89,0.92),(0.92,0.93),(0.162,0.17),(0.105,0.11),
        # pig parameters
        (0.29,0.31),(0.86,0.88),(0.93,0.95),(0.93,0.95),(0.18,0.2),(0.12,0.13)]
...
#fun: 93.32958339228435
#  message: 'Maximum number of iterations has been exceeded.'
#     nfev: 188
#      nit: 1
#  success: False
#        x: array([0.00297532, 0.00262716, 0.01399416, 0.002158  , 0.00694609,
#        0.0026891 , 0.09409881, 0.09374205, 0.00710851, 0.00213404,
#        0.0071618 , 0.00711317, 0.18019181, 0.93433073, 0.93074943,
#        0.92948404, 0.19256409, 0.14354872, 0.31308832, 0.92407722,
#        0.92913206, 0.92441831, 0.18731518, 0.12293806, 0.35332104,
#        0.92064398, 0.91163434, 0.91802141, 0.18703872, 0.12962438,
#        0.91096871, 0.91085224, 0.90462835, 0.16568741, 0.10959601,
#        0.19934137, 0.91427636, 0.89429386, 0.92988414, 0.16298673,
#        0.10988354, 0.30087164, 0.86517003, 0.93986933, 0.94985716,
#        0.19822851, 0.12762917])
