...
def run_optimizer():
    ...
    bds = [
        ...
        (0.011,0.013),(0.038,0.041),(0.084,0.085),(0.0026,0.0028),(0.015,0.02),
        ...
        # roe deer parameters
        (0.18,0.2),(0.9,0.93),(0.9,0.95),(0.9,0.95),(0.12,0.15),(0.1,0.15),
        # fallow deer parameters
        (0.33,0.35),(0.9,0.93),(0.9,0.93),(0.9,0.93),(0.1,0.13),(0.09,0.13),
        # red deer parameters
        (0.34,0.37),(0.9,0.93),(0.9,0.93),(0.9,0.93),(0.1,0.13),(0.09,0.13),
        # exmoor pony parameters
        (0.85,0.9),(0.88,0.92),(0.88,0.92),(0.09,0.12),(0.08,0.12),
        # cattle parameters
        (0.18,0.21),(0.87,0.92),(0.88,0.92),(0.88,0.9),(0.09,0.12),(0.08,0.12),
        # pig parameters
