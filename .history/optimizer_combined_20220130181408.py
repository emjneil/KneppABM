...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.025,0.05],[0.02,0.05], # saplings
        [0.025,0.05],[0.025,0.05], # young scrub  
        # roe deer parameters
        [0.15,0.3],[0.5,0.9],[0.5,0.9],[0.5,0.9],[0.1,0.25],[0.1,0.25],

        # fallow deer parameters
        [0.35,0.45],[0.4,0.8],[0.5,0.75],[0.5,0.75],[0.08,0.2],[0.08,0.2],
        # red deer parameters
        [0.3,0.4],[0.45,0.8],[0.45,0.65],[0.45,0.65],[0.075,0.2],[0.075,0.2],
        # exmoor pony parameters
        [0.5,0.8],[0.45,0.6],[0.45,0.6],[0.05,0.2],[0.05,0.2],
        # cattle parameters
