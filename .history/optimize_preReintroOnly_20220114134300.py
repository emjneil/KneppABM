...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.02,0.1],[0.025,0.1],[0.03,0.1],[0.0015,0.006],[0.01,0.02],
        # habitat competition
        [0.025,0.03], # mature scrub
        [0.065,0.1]5,[0.01,0.025], # grass
        [0.065,0.15],[0.01,0.05], # saplings
        [0.035,0.045],[0.065,0.075], # young scrub  
        # roe deer parameters
        [0.18,0.22],[0.075,0.2],[0.075,0.15],[0.075,0.15],[0.0075,0.075],[0.0075,0.075]
    ])
