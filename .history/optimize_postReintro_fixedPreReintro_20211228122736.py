...
def objectiveFunction(x):
    ...
    fallowDeer_reproduce = 0.38
    fallowDeer_gain_from_grass = 0.1
    fallowDeer_gain_from_Trees = 0.1
    fallowDeer_gain_from_Scrub = 0.16
    fallowDeer_gain_from_Saplings = 0.006
    fallowDeer_gain_from_YoungScrub = 0.003

 [0.3751105  0.10152844 0.10473073 0.15748788 0.00616779 0.00335312]
