...
def run_optimizer():
    ...
    bds = [
        ...
        # roe deer parameters
        (0.19,0.20),(0.92,0.94),(0.92,0.94),(0.92,0.94),(0.09,0.11),(0.07,0.1),
        # fallow deer parameters
        (0.31,0.32),(0.9,0.91),(0.9,0.92),(0.9,0.92),(0.07,0.1),(0.065,0.09),
        # red deer parameters
        (0.35,0.36),(0.89,0.91),(0.89,0.92),(0.89,0.92),(0.07,0.08),(0.065,0.08),
        # exmoor pony parameters
        (0.88,0.9),(0.88,0.9),(0.88,0.9),(0.065,0.075),(0.065,0.075),
        # cattle parameters
        (0.19,0.2),(0.88,0.89),(0.87,0.9),(0.87,0.9),(0.06,0.07),(0.06,0.07),
        # pig parameters
        (0.2,0.22),(0.81,0.85),(0.92,0.94),(0.92,0.94),(0.07,0.1),(0.05,0.1)]
