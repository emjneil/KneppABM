...
def run_optimizer():
    ...
    bds = [
        ...
        # roe deer parameters
        (0.19,0.20),(0.93,0.94),(0.92,0.94),(0.92,0.94),(0.12,0.13),(0.07,0.1),
        # fallow deer parameters
        (0.31,0.32),(0.9,0.92),(0.9,0.92),(0.9,0.92),(0.1,0.11),(0.075,0.1),
        # red deer parameters
        (0.38,0.39),(0.9,0.92),(0.9,0.92),(0.9,0.92),(0.095,0.1),(0.075,0.1),
        # exmoor pony parameters
        (0.89,0.9),(0.89,0.91),(0.89,0.9),(0.085,0.095),(0.07,0.1),
        # cattle parameters
        (0.18,0.19),(0.88,0.9),(0.88,0.9),(0.88,0.9),(0.085,0.095),(0.07,0.1),
        # pig parameters
        (0.2,0.26),(0.81,0.87),(0.92,0.94),(0.92,0.94),(0.085,0.13),(0.075,0.1)]
