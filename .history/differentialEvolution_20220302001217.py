...
def run_optimizer():
    ...
    bds = [
        ...
        (0.01,0.017),(0.04,0.055),(0.084,0.085),(0.0027,0.0028),(0.014,0.02),
        ...
        # roe deer parameters
        (0.18,0.2),(0.92,0.95),(0.91,0.93),(0.91,0.93),(0.13,0.23),(0.075,0.15),
        # fallow deer parameters
        (0.37,0.41),(0.89,0.94),(0.89,0.93),(0.89,0.93),(0.1,0.18),(0.05,0.15),
        # red deer parameters
        (0.38,0.405),(0.89,0.94),(0.89,0.93),(0.89,0.93),(0.1,0.18),(0.05,0.15),
        # exmoor pony parameters
        (0.9,0.93),(0.88,0.92),(0.88,0.92),(0.05,0.17),(0.075,0.14),
        # cattle parameters
        (0.15,0.22),(0.9,0.93),(0.88,0.92),(0.88,0.92),(0.075,0.17),(0.05,0.14),
        # pig parameters
        (0.3,0.45),(0.8,0.83),(0.93,0.94),(0.93,0.94),(0.075,0.2),(0.05,0.16)]
