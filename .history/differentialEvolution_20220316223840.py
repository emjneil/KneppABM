...
def run_optimizer():
    ...
    bds = [
        ...
        (0.0024,0.003),(0.0024,0.003),(0.0135,0.014),(0.0021,0.0022),(0.0067,0.007),
        ...
        # roe deer parameters
        (0.16,0.19),(0.93,0.95),(0.91,0.95),(0.91,0.95),(0.12,0.15),(0.09,0.1),
        # fallow deer parameters
        (0.31,0.32),(0.89,0.93),(0.89,0.93),(0.89,0.93),(0.1,0.14),(0.085,0.09),
        # red deer parameters
        (0.355,0.365),(0.89,0.93),(0.89,0.93),(0.89,0.93),(0.1,0.14),(0.085,0.09),
        # exmoor pony parameters
        (0.88,0.92),(0.88,0.92),(0.88,0.92),(0.09,0.13),(0.08,0.085),
        # cattle parameters
        (0.18,0.19),(0.88,0.92),(0.88,0.92),(0.88,0.92),(0.09,0.13),(0.08,0.085),
        # pig parameters
        (0.29,0.31),(0.86,0.88),(0.9,0.95),(0.9,0.95),(0.12,0.15),(0.08,0.1)]
