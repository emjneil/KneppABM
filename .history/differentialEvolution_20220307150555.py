...
def run_optimizer():
    ...
    bds = [
        ...
        (0.015,0.035),(0.01,0.05),(0.084,0.085),(0.0021,0.0025),(0.007,0.025),
        (0.0075,0.01), # mature scrub competition
        (0.17,0.175),(0.17,0.175), # grass
        (0.05,0.075),(0.03,0.05), # saplings
        (0.04,0.075),(0.05,0.075), # young scrub  
        # roe deer parameters
        (0.18,0.2),(0.85,0.95),(0.85,0.95),(0.85,0.95),(0.05,0.15),(0.05,0.15),
        # fallow deer parameters
        (0.37,0.41),(0.89,0.95),(0.85,0.95),(0.85,0.95),(0.025,0.14),(0.025,0.14),
        # red deer parameters
        (0.38,0.4),(0.85,0.95),(0.85,0.95),(0.85,0.95),(0.025,0.14),(0.025,0.14),
        # exmoor pony parameters
        (0.85,0.95),(0.86,0.95),(0.86,0.95),(0.01,0.2),(0.01,0.13),
        # cattle parameters
        (0.18,0.21),(0.85,0.95),(0.86,0.95),(0.86,0.95),(0.01,0.13),(0.01,0.13),
        # pig parameters
