...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.25,0.45],[0.45,0.75],[0.75,0.8],[0.75,0.8],[0.1,0.2],[0.1,0.2],
        # red deer parameters
        [0.25,0.45],[0.45,0.75],[0.7,0.8],[0.7,0.8],[0.1,0.15],[0.1,0.15],
        # exmoor pony parameters
        [0.6,0.7],[0.65,0.75],[0.65,0.75],[0.1,0.15],[0.1,0.15],
        # cattle parameters
        [0.15,0.3],[0.6,0.65],[0.6,0.7],[0.6,0.7],[0.075,0.15],[0.075,0.15],
        # # pig parameters
        [0.15,0.5],[0.5,0.6],[0.7,0.8],[0.7,0.8],[0.075,0.15],[0.075,0.15]
    ])
