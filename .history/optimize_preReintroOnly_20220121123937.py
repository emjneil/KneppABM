...
def graph_results():
    ...
    # and eaten by deer
    grass_eatenByDeer = final_results.drop(['Time', "Bare ground", "Grassland", "Woodland", "Thorny Scrub", "Roe deer", "Exmoor pony", "Fallow deer", "Longhorn cattle", "Red deer", "Tamworth pigs", "Grass", "Trees", "Mature Scrub", "Saplings", "Young Scrub", "Bare Areas", "Grown saplings", "Grown young scrub", "Outcompeted Grass", "Outcompeted Mature Scrub", "Outcompeted Saplings", "Outcompeted Young Scrub","Outcompeted Young Scrub-Scrub", "Outcompeted Saplings-Scrub","Eaten Trees", "Eaten Mature Scrub", "Eaten Saplings", "Eaten Young Scrub"], axis=1).values.flatten() 
    ...
    # outcompeted_grass = final_results.drop(['Time', "Bare ground", "Grassland", "Woodland", "Thorny Scrub", "Roe deer", "Exmoor pony", "Fallow deer", "Longhorn cattle", "Red deer", "Tamworth pigs", "Grass", "Trees", "Mature Scrub", "Saplings", "Young Scrub", "Bare Areas", "Grown saplings", "Grown young scrub", "Outcompeted Grass", "Outcompeted Mature Scrub", "Outcompeted Saplings", "Outcompeted Young Scrub", "Outcompeted Grass-Scrub", "Outcompeted Young Scrub-Scrub", "Outcompeted Saplings-Scrub", "Eaten Grass", "Eaten Trees", "Eaten Mature Scrub", "Eaten Saplings", "Eaten Young Scrub"], axis=1).values.flatten() 
 # stacked_competition = np.tile(["Eaten Mature Scrub", "Eaten Saplings", "Eaten Young Scrub"], 51) 
    ...
    'Grass Eaten by Roe Deer': grass_eatenByDeer_tiled, 'Trees Eaten by Roe Deer': trees_eatenByDeer_tiled, 'Scrub Eaten by Roe Deer': scrub_eatenByDeer_tiled})
