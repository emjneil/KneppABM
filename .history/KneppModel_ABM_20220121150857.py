        ...
        for _ in range(len(habitat_choices)):
            if self.energy < 1:
                ...
                if my_choice == "saplings":
                    ...
                    self.count_eaten[my_choice] += eatenSoil
            else:
                break
            # don't let energy be above 1; do a break and >= 1
            if self.energy >= 1:
...
class KneppModel(Model):
    ...
    def __init__(self,             
        ...
        self.datacollector = DataCollector(
                        ...
                        "Young Scrub eaten by roe deer": lambda m: self.count_eaten(m, roeDeer_agent, "saplings"),
                        "Young Scrub eaten by Exmoor pony": lambda m: self.count_eaten(m, exmoorPony, "saplings"),
                        "Young Scrub eaten by Fallow deer": lambda m: self.count_eaten(m, fallowDeer, "saplings"),
                        "Young Scrub eaten by longhorn cattle": lambda m: self.count_eaten(m, longhornCattle, "saplings"),
                        "Young Scrub eaten by red deer": lambda m: self.count_eaten(m, redDeer, "saplings"),
                        "Young Scrub eaten by pigs": lambda m: self.count_eaten(m, tamworthPigs, "saplings"),
