...
def run_optimizer():
    ...
    bds = [
        ...
        (0.0038,0.0039),(0.0034,0.0035),(0.0135,0.014),(0.0023,0.0024),(0.0086,0.0087),
        (0.0015,0.0017), # mature scrub competition
        (0.094,0.095),(0.093,0.094), # grass
        (0.082,0.085),(0.018,0.025), # saplings
        (0.077,0.085),(0.08,0.085), # young scrub  
        # roe deer parameters
