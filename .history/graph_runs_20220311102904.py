...
def graph_runs():
    ...
    # # numbers graphs
    numbers_results = final_results[["Time", "Roe deer", "Exmoor pony", "Fallow deer", "Longhorn cattle", "Red deer", "Tamworth pigs", "Grass", "Mature Trees", "Mature Scrub", "Saplings", "Young Scrub", "Bare ground", "accepted?", "run_number"]]
