...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.2,0.25],[0.1,0.35],[0.001,0.1],[0.0025,0.005],[0.005,0.01],
        # habitat competition
        [0,0.001],[0.01,0.1],[0.01,0.1],[0.4,0.5],[0.00001,0.0001],[0.0001,0.1],[0.25,0.5],     
        # roe deer parameters
        [0.1,0.25],[0,0.25],[0,0.25],[0,0.25],[0.005,0.025],[0.005,0.025]
    ])
