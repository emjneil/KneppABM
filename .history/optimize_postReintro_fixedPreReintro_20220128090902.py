...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.3,0.4],[0.45,0.55],[0.5,0.75],[0.5,0.75],[0.075,0.12],[0.075,0.12],
        # red deer parameters
        [0.3,0.4],[0.4,0.5],[0.4,0.75],[0.4,0.75],[0.1,0.15],[0.1,0.15],
        # exmoor pony parameters
        [0.4,0.7],[0.3,0.5],[0.3,0.7],[0.075,0.15],[0.075,0.15],
        # cattle parameters
        [0.1,0.3],[0.25,0.4],[0.2,0.6],[0.2,0.6],[0.05,0.15],[0.05,0.15],
        # # pig parameters
        [0.1,0.4],[0.01,0.3],[0.2,0.7],[0.2,0.7],[0.025,0.15],[0.025,0.15]
    ])
