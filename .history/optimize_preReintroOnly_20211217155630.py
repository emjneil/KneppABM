...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.12,0.14],[0.12,0.14],[0.025,0.05],[0.0025,0.005],[0.005,0.008],
        # habitat competition
        [0.0005,0.001],[0.025,0.075],[0.025,0.075],[0.1,0.5],[0.005,0.025],[0.01,0.025],[0.11,0.12],     
        # roe deer parameters
        [0.15,0.22],[0.01,0.1],[0.01,0.2],[0.01,0.2],[0.005,0.015],[0.005,0.015],
