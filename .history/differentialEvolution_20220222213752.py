...
def run_optimizer():
    ...
    bds = [
        ...
        # fallow deer parameters
        (0.25,0.4),(0.79,0.9),(0.81,0.9),(0.81,0.9),(0.13,0.25),(0.13,0.25),
        # red deer parameters
        (0.25,0.4),(0.78,0.9),(0.8,0.9),(0.8,0.9),(0.12,0.25),(0.12,0.25),
        # exmoor pony parameters
        (0.76,0.9),(0.78,0.9),(0.78,0.9),(0.11,0.25),(0.11,0.25),
        # cattle parameters
        (0.18,0.25),(0.75,0.85),(0.77,0.85),(0.77,0.85),(0.1,0.25),(0.1,0.25),
        # pig parameters
        (0.18,0.35),(0.63,0.8),(0.85,0.95),(0.85,0.95),(0.12,0.25),(0.12,0.25)]
