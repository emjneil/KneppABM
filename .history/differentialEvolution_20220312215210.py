...
def run_optimizer():
    ...
    bds = [
        ...
        (0.084,0.086),(0.023,0.025), # saplings
        (0.084,0.086),(0.084,0.086), # young scrub  
        # roe deer parameters
        (0.19,0.20),(0.92,0.94),(0.92,0.94),(0.92,0.94),(0.09,0.11),(0.08,0.1),
        # fallow deer parameters
        (0.31,0.32),(0.9,0.91),(0.9,0.92),(0.9,0.92),(0.075,0.1),(0.07,0.09),
        # red deer parameters
        (0.35,0.36),(0.89,0.91),(0.89,0.92),(0.89,0.92),(0.075,0.09),(0.07,0.08),
        # exmoor pony parameters
        (0.88,0.9),(0.88,0.9),(0.88,0.9),(0.075,0.085),(0.065,0.075),
        # cattle parameters
        (0.19,0.2),(0.88,0.89),(0.87,0.9),(0.87,0.9),(0.07,0.08),(0.06,0.07),
        # pig parameters
        (0.2,0.22),(0.81,0.85),(0.92,0.94),(0.92,0.94),(0.08,0.1),(0.065,0.1)]
