...
def run_optimizer():
    ...
    bds = [
        ...
        # roe deer parameters
        (0.18,0.22),(0.75,0.8),(0.8,0.83),(0.8,0.83),(0.12,0.17),(0.12,0.17),
        # fallow deer parameters
        (0.37,0.43),(0.7,0.75),(0.75,0.8),(0.75,0.8),(0.1,0.15),(0.1,0.15),
        # red deer parameters
        (0.35,0.5),(0.65,0.7),(0.75,0.8),(0.75,0.8),(0.1,0.15),(0.1,0.15),
        # exmoor pony parameters
        (0.63,0.68),(0.7,0.75),(0.7,0.75),(0.09,0.14),(0.09,0.14),
        # cattle parameters
        (0.1,0.25),(0.6,0.65),(0.7,0.75),(0.7,0.75),(0.09,0.12),(0.09,0.12),
        # # pig parameters
        (0.15,0.25),(0.5,0.6),(0.7,0.8),(0.7,0.8),(0.09,0.12),(0.09,0.12)]
