...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.03,0.06],[0.065,0.1],[0.1,0.12],[0.0015,0.006],[0.0075,0.08],
        # habitat competition
        [0.02,0.025], # mature scrub
        [0.15,0.25],[0.13,0.25], # grass
        [0.075,0.25],[0.01,0.15], # saplings
        [0.01,0.25],[0.075,0.25], # young scrub  
        # roe deer parameters
        [0.15,0.22],[0.05,0.15],[0.05,0.15],[0.05,0.15],[0.075,0.15],[0.075,0.15]
    ])
