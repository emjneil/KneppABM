...
def run_optimizer():
    ...
    bds = [
        ...
        (0.0039,0.0043),(0.0033,0.004),(0.0135,0.014),(0.0023,0.0024),(0.0086,0.0087),
        (0.0019,0.002), # mature scrub competition
        (0.094,0.095),(0.093,0.094), # grass
        (0.075,0.08),(0.015,0.02), # saplings
        (0.075,0.08),(0.075,0.08), # young scrub  
        # roe deer parameters
        (0.17,0.20),(0.93,0.94),(0.91,0.92),(0.91,0.92),(0.11,0.15),(0.08,0.12),
        # fallow deer parameters
        (0.315,0.32),(0.91,0.93),(0.89,0.91),(0.89,0.91),(0.1,0.13),(0.085,0.11),
        # red deer parameters
        (0.36,0.37),(0.91,0.93),(0.89,0.91),(0.89,0.91),(0.1,0.13),(0.085,0.11),
        # exmoor pony parameters
        (0.89,0.91),(0.88,0.9),(0.88,0.9),(0.08,0.12),(0.075,0.1),
        # cattle parameters
        (0.18,0.19),(0.89,0.91),(0.88,0.9),(0.88,0.9),(0.08,0.12),(0.075,0.1),
        # pig parameters
        (0.15,0.3),(0.85,0.89),(0.9,0.92),(0.9,0.92),(0.08,0.14),(0.075,0.12)]
