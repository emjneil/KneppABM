...
def run_optimizer():
    ...
    bds = [
        ...
        (0.0031,0.0032),(0.0031,0.0035),(0.0135,0.014),(0.0023,0.0024),(0.0086,0.0087),
        ...
        # roe deer parameters
        (0.19,0.20),(0.92,0.94),(0.92,0.94),(0.92,0.94),(0.09,0.12),(0.08,0.1),
        # fallow deer parameters
        (0.31,0.32),(0.9,0.91),(0.9,0.92),(0.9,0.92),(0.08,0.11),(0.075,0.09),
        # red deer parameters
        (0.35,0.36),(0.89,0.91),(0.89,0.92),(0.89,0.92),(0.09,0.1),(0.07,0.09),
        # exmoor pony parameters
        (0.88,0.9),(0.88,0.9),(0.88,0.9),(0.085,0.09),(0.07,0.08),
        # cattle parameters
        (0.19,0.21),(0.87,0.9),(0.87,0.9),(0.87,0.9),(0.085,0.09),(0.065,0.07),
        # pig parameters
        (0.2,0.22),(0.81,0.85),(0.92,0.94),(0.92,0.94),(0.08,0.1),(0.075,0.1)]
