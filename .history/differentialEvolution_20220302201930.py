...
def run_optimizer():
    ...
    bds = [
        ...
        (0.01,0.013),(0.035,0.041),(0.084,0.085),(0.0027,0.0028),(0.014,0.02),
        (0.008,0.01), # mature scrub competition
        (0.17,0.175),(0.17,0.175), # grass
        (0.04,0.06),(0.02,0.05), # saplings
        (0.04,0.05),(0.04,0.06), # young scrub  
        # roe deer parameters
        (0.18,0.2),(0.85,0.93),(0.85,0.93),(0.85,0.93),(0.13,0.16),(0.1,0.12),
        # fallow deer parameters
        (0.33,0.37),(0.89,0.95),(0.85,0.93),(0.85,0.93),(0.08,0.15),(0.05,0.1),
        # red deer parameters
        (0.38,0.405),(0.85,0.94),(0.85,0.93),(0.85,0.93),(0.08,0.15),(0.05,0.12),
        # exmoor pony parameters
        (0.9,0.95),(0.85,0.95),(0.85,0.92),(0.075,0.14),(0.05,0.1),
        # cattle parameters
        (0.17,0.22),(0.88,0.95),(0.85,0.93),(0.85,0.93),(0.1,0.13),(0.08,0.1),
        # pig parameters
        (0.3,0.37),(0.8,0.83),(0.85,0.94),(0.85,0.94),(0.1,0.15),(0.075,0.13)]
