...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.035,0.04],[0.05,0.06],[0.075,0.077],[0.0025,0.003],[0.0085,0.03],
        [0.0075,0.015], # mature scrub competition
        [0.1,0.15],[0.1,0.15], # grass
        [0.1,0.12],[0.02,0.1], # saplings
        [0.05,0.1],[0.075,0.12], # young scrub  
        # roe deer parameters
        [0.18,0.21],[0.8,1],[0.8,1],[0.8,1],[0.09,0.2],[0.07,0.2]
    ])
