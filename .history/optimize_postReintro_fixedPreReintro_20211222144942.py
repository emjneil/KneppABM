...
def objectiveFunction(x):
    ...
    if filtered_result < 750000:
        print("r:", filtered_result)
        with pd.option_context('display.max_columns',None):
            me = results[results['Time'] == 158]  # 140
            just_nodes1 = results[results['Time'] == 134]  # 140
            just_nodes2 = results[results['Time'] == 146] # 165
            just_nodes4 = results[results['Time'] == 170] # 278
            just_nodes = results[results['Time'] == 182] # 247
            print(me)
            print(just_nodes1[["Fallow deer"]])
            print(just_nodes2[["Fallow deer"]])
            print(just_nodes4[["Fallow deer"]])
...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.4,0.5],[0.1,0.25],[0.2,0.5],[0.2,0.5],[0.1,0.5],[0.1,0.5],
        # [0.1,0.5],[0.05,0.25],[0.1,0.2],[0.1,0.2],[0.0075,0.014],[0.0075,0.01],
        # # red deer parameters
