...
def run_optimizer():
    ...
    bds = [
        ...
        # roe deer parameters
        (0.17,0.19),(0.9,0.91),(0.9,0.91),(0.9,0.91),(0.14,0.16),(0.14,0.17),
        # fallow deer parameters
        (0.25,0.35),(0.87,0.9),(0.85,0.9),(0.85,0.9),(0.13,0.15),(0.13,0.15),
        # red deer parameters
        (0.38,0.43),(0.87,0.9),(0.87,0.9),(0.87,0.9),(0.13,0.15),(0.13,0.15),
        # exmoor pony parameters
        (0.83,0.88),(0.85,0.9),(0.83,0.9),(0.12,0.14),(0.12,0.14),
        # cattle parameters
        (0.17,0.21),(0.85,0.88),(0.83,0.87),(0.83,0.87),(0.12,0.14),(0.12,0.14),
        # pig parameters
