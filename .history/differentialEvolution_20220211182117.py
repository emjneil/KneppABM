...
def run_optimizer():
    ...
    bds = [
        ...
        # roe deer parameters
        (0.18,0.21),(0.75,0.8),(0.8,0.83),(0.8,0.83),(0.14,0.2),(0.14,0.2),
        # fallow deer parameters
        (0.36,0.42),(0.7,0.75),(0.75,0.78),(0.75,0.78),(0.1,0.16),(0.1,0.16),
        # red deer parameters
        (0.36,0.42),(0.68,0.73),(0.75,0.78),(0.75,0.78),(0.1,0.16),(0.1,0.16),
