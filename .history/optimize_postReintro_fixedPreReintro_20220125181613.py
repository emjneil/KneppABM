...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.3,0.5],[0.6,0.75],[0.2,0.75],[0.2,0.75],[0.01,0.15],[0.01,0.15],
        # red deer parameters
        [0.3,0.4],[0.5,0.75],[0.2,0.6],[0.2,0.6],[0.01,0.15],[0.01,0.15],
        # exmoor pony parameters
        [0.4,0.7],[0.1,0.6],[0.1,0.6],[0.01,0.15],[0.01,0.15],
        # cattle parameters
        [0.1,0.3],[0.25,0.5],[0.1,0.5],[0.1,0.5],[0.01,0.15],[0.01,0.15],
        # # pig parameters
        [0.01,0.2],[0.05,0.25],[0,0.15],[0,0.15],[0,0.1]
    ])
