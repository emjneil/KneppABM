...
def objectiveFunction(x):
    ...
    with pd.option_context('display.max_columns',None):
        print(results[["Sapling deaths from competition", "Sapling deaths from roe deer", "Scrub deaths from competition", "Scrub deaths from roe deer"]])
...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.05,0.12],[0.5,0.75],[0.5,0.75],
        # habitat competition
        [0.001,0.1],[0.1,0.25],[0.1,0.25],[0.1,0.25],[0,0.25],[0,0.25],[0.1,0.25],     
        # roe deer parameters
        [0.15,0.21],[0.1,0.2],[0.075,0.25],[0.075,0.2],[0.0075,0.015],[0.0075,0.015]
