...
def graph_runs():
    ...
    # grouping variable
    grouping_variable_finaldf = np.repeat(numbers_results['run_number'], 10)
    grouping_variable_counterfactual = np.repeat(counterfactual_results['run_number'], 10)
    ...
    # indices
    indices_finaldf = np.repeat(numbers_results['Time'], 10)
    indices_counterfactual = np.repeat(counterfactual_results['Time'], 10)
