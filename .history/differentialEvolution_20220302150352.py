...
def run_optimizer():
    ...
    bds = [
        ...
        (0.01,0.013),(0.038,0.043),(0.084,0.085),(0.0027,0.0028),(0.014,0.02),
        (0.01,0.015), # mature scrub competition
        (0.17,0.175),(0.17,0.175), # grass
        (0.035,0.06),(0.02,0.05), # saplings
        (0.03,0.05),(0.035,0.06), # young scrub  
        # roe deer parameters
        (0.18,0.2),(0.92,0.95),(0.9,0.93),(0.91,0.93),(0.1,0.23),(0.075,0.15),
        # fallow deer parameters
        (0.37,0.41),(0.89,0.94),(0.88,0.93),(0.89,0.93),(0.08,0.18),(0.05,0.15),
        # red deer parameters
        (0.38,0.405),(0.89,0.94),(0.88,0.93),(0.89,0.93),(0.08,0.18),(0.05,0.15),
