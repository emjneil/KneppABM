...
def run_optimizer():
    ...
    bds = [
        ...
        (0.01,0.013),(0.041,0.045),(0.073,0.076),(0.003,0.0035),(0.014,0.016),
        ...
        (0.37,0.43),(0.7,0.73),(0.75,0.78),(0.75,0.78),(0.1,0.16),(0.1,0.16),
        # red deer parameters
        (0.37,0.43),(0.68,0.7),(0.75,0.78),(0.75,0.78),(0.1,0.16),(0.1,0.16),
        # exmoor pony parameters
        (0.63,0.68),(0.73,0.75),(0.73,0.75),(0.1,0.15),(0.1,0.15),
        # cattle parameters
        (0.19,0.23),(0.62,0.65),(0.72,0.75),(0.72,0.75),(0.1,0.14),(0.1,0.14),
        # # pig parameters
        (0.15,0.19),(0.5,0.6),(0.75,0.83),(0.75,0.83),(0.1,0.14),(0.1,0.14)]
