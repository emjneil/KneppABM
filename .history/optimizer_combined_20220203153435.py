...
def run_optimizer():
    ...
    bds = np.array([
        ...
        # roe deer parameters
        [0.18,0.22],[0.75,0.8],[0.75,0.83],[0.75,0.83],[0.17,0.2],[0.17,0.2],
        # fallow deer parameters
        [0.25,0.45],[0.45,0.75],[0.65,0.8],[0.65,0.8],[0.08,0.12],[0.08,0.12],
        # red deer parameters
        [0.25,0.45],[0.45,0.55],[0.55,0.8],[0.55,0.8],[0.075,0.12],[0.075,0.12],
        # exmoor pony parameters
        [0.4,0.5],[0.45,0.8],[0.45,0.8],[0.05,0.11],[0.05,0.11],
        # cattle parameters
        [0.15,0.3],[0.25,0.5],[0.35,0.75],[0.35,0.75],[0.05,0.11],[0.05,0.11],
        # # pig parameters
        [0.1,0.75],[0.1,0.3],[0.6,0.8],[0.6,0.8],[0.075,0.12],[0.075,0.12]
    ])

#  The best solution found:                                                                           
#  [0.01222025 0.03443591 0.07368939 0.00356907 0.02367133 0.01190954
#  0.0870646  0.08532615 0.04955102 0.03704915 0.04720563 0.04064049
#  0.19985584 0.75996171 0.78934277 0.81990877 0.19564631 0.17762016
#  0.40482969 0.70264806 0.70183582 0.71475555 0.13230459 0.15265042
#  0.28215762 0.64254437 0.72833348 0.74062075 0.13241037 0.12430593
#  0.65838663 0.66086734 0.64433446 0.14361118 0.11941751 0.21850353
#  0.69382658 0.57420521 0.52003706 0.07520333 0.09999108 0.31942907
#  0.39427432 0.82772916 0.81566906 0.12076333 0.1174151 ]
