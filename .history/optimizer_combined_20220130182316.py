...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.5,0.7],[0.45,0.7],[0.45,0.7],[0.075,0.15],[0.075,0.15],
        # cattle parameters
        [0.15,0.3],[0.25,0.75],[0.35,0.5],[0.35,0.5],[0.05,0.2],[0.05,0.2],
        # # pig parameters
        [0.05,0.5],[0.05,0.5],[0.55,0.75],[0.55,0.75],[0.01,0.25],[0.01,0.25]
    ])
