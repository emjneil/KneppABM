...
class KneppModel(Model):
    ...
    def __init__(self,             
        ...
        self.datacollector = DataCollector(
                        ...
                        "Sapling deaths from competition": lambda m: self.count_eaten(m, "tree and scrub competition")
                        "Sapling deaths from roe deer": lambda m: self.count_eaten(m, "tree and scrub competition")
