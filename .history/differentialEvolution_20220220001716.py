...
def run_optimizer():
    ...
    bds = [
        ...
        (0.01,0.012),(0.038,0.042),(0.075,0.076),(0.0025,0.003),(0.015,0.02),
        (0.013,0.017), # mature scrub competition
        (0.17,0.18),(0.17,0.18), # grass
        (0.04,0.075),(0.015,0.03), # saplings
        (0.04,0.048),(0.04,0.06), # young scrub  
        # roe deer parameters
        (0.18,0.2),(0.8,0.82),(0.82,0.83),(0.82,0.83),(0.14,0.15),(0.14,0.15),
        # fallow deer parameters
        (0.33,0.4),(0.77,0.8),(0.8,0.82),(0.8,0.82),(0.12,0.14),(0.12,0.14),
        # red deer parameters
        (0.35,0.41),(0.78,0.8),(0.79,0.82),(0.79,0.82),(0.12,0.14),(0.12,0.14),
