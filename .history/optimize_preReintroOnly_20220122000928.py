...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.01,0.02],[0.015,0.035],[0.075,0.1],[0.0025,0.006],[0.0085,0.02],
        [0.015,0.025], # mature scrub competition
        [0.05,0.075],[0.05,0.075], # grass
        [0.03,0.05],[0.025,0.05], # saplings
        [0.025,0.05],[0.03,0.05], # young scrub  
        # roe deer parameters
        [0.15,0.24],[0.5,0.75],[0.35,0.5],[0.35,0.5],[0.1,0.25],[0.1,0.25]
    ])
