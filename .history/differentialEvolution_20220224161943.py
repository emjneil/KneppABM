...
def run_optimizer():
    ...
    bds = [
        ...
        (0.011,0.014),(0.038,0.042),(0.078,0.085),(0.0025,0.003),(0.015,0.016),
        (0.015,0.018), # mature scrub competition
        (0.17,0.18),(0.17,0.18), # grass
        (0.04,0.06),(0.02,0.03), # saplings
        (0.03,0.05),(0.04,0.06), # young scrub  
        # roe deer parameters
        (0.18,0.19),(0.9,0.95),(0.9,0.95),(0.9,0.95),(0.14,0.16),(0.14,0.16),
        # fallow deer parameters
        (0.3,0.35),(0.87,0.92),(0.85,0.93),(0.85,0.93),(0.13,0.15),(0.13,0.15),
        # red deer parameters
        (0.39,0.41),(0.87,0.92),(0.87,0.93),(0.87,0.93),(0.12,0.15),(0.12,0.15),
        # exmoor pony parameters
        (0.85,0.91),(0.87,0.92),(0.87,0.92),(0.11,0.14),(0.11,0.14),
        # cattle parameters
        (0.17,0.19),(0.85,0.91),(0.87,0.92),(0.87,0.92),(0.11,0.14),(0.11,0.14),
        # pig parameters
        (0.25,0.35),(0.75,0.85),(0.9,0.91),(0.9,0.91),(0.11,0.16),(0.11,0.16)]
