...
def run_all_models():
    ...
    for _ in range(number_simulations):
        ...
        chance_reproduceSapling = 0.012
        chance_reproduceYoungScrub = 0.039
        chance_regrowGrass = 0.085
        ...
        # Fallow deer
        fallowDeer_reproduce = 0.34174276
    ...
    (filtered_preReintro["Roe deer"] <= 40) & (filtered_preReintro["Roe deer"] >= 20) & 
    ...
    accepted_parameters.to_excel('/Users/emilyneil/Desktop/KneppABM/many_outputs/one_perc/1%_accepted_parameters.xlsx')

    accepted_parameters.to_excel('/Users/emilyneil/Desktop/KneppABM/outputs/post_reintro/DE_PostReintro_numbers.png'
        "1%_accepted_parameters.xlsx")
