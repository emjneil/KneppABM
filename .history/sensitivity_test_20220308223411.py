...
for index, row in final_parameters.iteritems():
    for perc_number in perc_aboveBelow:
        ...
        ponies_gain_from_grass = final_parameters_temp.values[22]
        ponies_gain_from_Trees = final_parameters_temp.values[23]
        ponies_gain_from_Scrub = final_parameters_temp.values[24]
        ponies_gain_from_Saplings = final_parameters_temp.values[25]
        ponies_gain_from_YoungScrub = final_parameters_temp.values[26]
        cows_reproduce = final_parameters_temp.values[27]
        cows_gain_from_grass = final_parameters_temp.values[28]
        cows_gain_from_Trees = final_parameters_temp.values[29]
        cows_gain_from_Scrub = final_parameters_temp.values[30]
        cows_gain_from_Saplings = final_parameters_temp.values[31]
        cows_gain_from_YoungScrub = final_parameters_temp.values[32]
        fallowDeer_reproduce = final_parameters_temp.values[33]
        fallowDeer_gain_from_grass = final_parameters_temp.values[34]
        fallowDeer_gain_from_Trees = final_parameters_temp.values[35]
        fallowDeer_gain_from_Scrub = final_parameters_temp.values[36]
        fallowDeer_gain_from_Saplings = final_parameters_temp.values[37]
        fallowDeer_gain_from_YoungScrub = final_parameters_temp.values[38]
        redDeer_reproduce = final_parameters_temp.values[39]
        redDeer_gain_from_grass = final_parameters_temp.values[40]
        redDeer_gain_from_Trees = final_parameters_temp.values[41]
        redDeer_gain_from_Scrub = final_parameters_temp.values[42]
        redDeer_gain_from_Saplings = final_parameters_temp.values[43]
        redDeer_gain_from_YoungScrub = final_parameters_temp.values[44]
        pigs_reproduce = final_parameters_temp.values[45]
        pigs_gain_from_grass = final_parameters_temp.values[46]
        pigs_gain_from_Trees = final_parameters_temp.values[47]
        pigs_gain_from_Scrub = final_parameters_temp.values[48]
        pigs_gain_from_Saplings = final_parameters_temp.values[49]
        pigs_gain_from_YoungScrub = final_parameters_temp.values[50]
