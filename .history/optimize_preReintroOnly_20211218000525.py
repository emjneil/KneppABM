...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.1,0.25],[0.13,0.25],[0.03,0.045],[0.0035,0.005],[0.005,0.01],
        # habitat competition
        [0.0005,0.001],[0.1,0.15],[0.07,0.1],[0.25,0.75],[0.01,0.1],[0.25,0.75],[0.1,0.13],     
        # roe deer parameters
        [0.15,0.20],[0.05,0.1],[0.025,0.25],[0.025,0.25],[0.005,0.025],[0.005,0.025],
        # starting conditions for saplings and young scrub     
        [0.075,0.15],[0.12,0.15]
    ])
