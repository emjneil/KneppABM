...
def run_optimizer():
    ...
    bds = [
        ...
        (0.003,0.004),(0.003,0.004),(0.0135,0.014),(0.0023,0.0024),(0.0086,0.0087),
        (0.001,0.002), # mature scrub competition
        (0.094,0.095),(0.093,0.094), # grass
        (0.025,0.085),(0.015,0.02), # saplings
        (0.025,0.085),(0.025,0.085), # young scrub  
        # roe deer parameters
        (0.18,0.20),(0.91,0.92),(0.91,0.92),(0.91,0.92),(0.1,0.18),(0.08,0.15),
        # fallow deer parameters
        (0.31,0.32),(0.89,0.91),(0.89,0.91),(0.89,0.91),(0.075,0.12),(0.075,0.12),
        # red deer parameters
        (0.35,0.37),(0.89,0.91),(0.89,0.91),(0.89,0.91),(0.075,0.12),(0.075,0.12),
        # exmoor pony parameters
        (0.88,0.9),(0.88,0.9),(0.88,0.9),(0.075,0.11),(0.065,0.11),
        # cattle parameters
        (0.18,0.19),(0.88,0.91),(0.88,0.9),(0.88,0.9),(0.075,0.11),(0.06,0.11),
        # pig parameters
        (0.2,0.3),(0.85,0.9),(0.9,0.92),(0.9,0.92),(0.075,0.15),(0.075,0.15)]
