...
class habitatAgent (Agent):
    def __init__(self, unique_id, pos, model, condition, trees_here, saplings_here, scrub_here, youngscrub_here, perc_grass_here, perc_bareground_here):
        ...
        self.habs_outcompeted = defaultdict(int)
    ...
    def step(self):
        ...
        outcompeted_grass_byScrub = np.random.binomial(n=self.edibles["grass"], p=outcompeted_by_trees)
        ...
        self.habs_outcompeted["grass"] += outcompeted_grass
        ...
        self.habs_outcompeted["scrub"] += mature_scrub_outcompeted
        ...
        self.habs_outcompeted["saplings"] += outcompeted_saplings
