...
def run_optimizer():
    ...
    bds = [
        ...
        (0.001,0.005),(0.001,0.005),(0.01,0.025),(0.002,0.003),(0.006,0.01),
        (0.0005,0.0015), # mature scrub competition
        (0.075,0.1),(0.075,0.1), # grass
        (0.075,0.1),(0.01,0.025), # saplings
        (0.05,0.1),(0.075,0.1), # young scrub  
        # roe deer parameters
