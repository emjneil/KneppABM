...
def objectiveFunction(x):
    ...
    if ((list(results.loc[results['Time'] == 1, 'Saplings'])[0])-23) > max_start_saplings*3000 and ((list(results.loc[results['Time'] == 1, 'Young Scrub'])[0])-23) > round(max_start_youngScrub*3000):
        filtered_result = (
            # pre-reintro model
