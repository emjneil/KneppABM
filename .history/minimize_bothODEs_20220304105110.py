...
def run_optimizer():
    ...
    bds = [
        ...
        # roe deer parameters
        (0.18,0.2),(0.9,0.91),(0.92,0.93),(0.92,0.93),(0.13,0.15),(0.13,0.15),
        # fallow deer parameters
        (0.34,0.38),(0.85,0.91),(0.85,0.92),(0.85,0.92),(0.05,0.15),(0.05,0.14),
        # red deer parameters
        (0.34,0.38),(0.85,0.95),(0.85,0.92),(0.85,0.92),(0.075,0.15),(0.075,0.14),
        # exmoor pony parameters
        (0.8,0.95),(0.88,0.9),(0.82,0.9),(0.05,0.15),(0.05,0.13),
        # cattle parameters
        (0.18,0.2),(0.85,0.9),(0.88,0.9),(0.83,0.88),(0.05,0.15),(0.05,0.13),
        # pig parameters
        (0.25,0.32),(0.7,0.86),(0.8,0.92),(0.8,0.92),(0.05,0.15),(0.05,0.15)]

    
    initial_guess = [
        # habitats reproduction 
        0.01231498, 0.03903877, 0.08479035, 0.00263711, 0.01514143,
        0.01632931, 0.17617216, 0.17476992, 0.05548632, 0.0257358 ,
        0.04560602, 0.05165619, 0.18264644, 0.9342863 , 0.93408981,
