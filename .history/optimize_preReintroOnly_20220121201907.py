...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.015,0.075],[0.015,0.075],[0.075,0.1],[0.002,0.004],[0.005,0.05],
        [0.0075,0.025], # mature scrub competition
        [0.025,0.06],[0.025,0.06], # grass
        [0.01,0.06],[0.01,0.06], # saplings
        [0.01,0.06],[0.01,0.06], # young scrub  
        # roe deer parameters
