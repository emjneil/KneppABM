...
#  4.0
    ...
    optimization =  ga(function = objectiveFunction, dimension = 22, variable_type = 'real',variable_boundaries= bds, algorithm_parameters = algorithm_param, function_timeout=6000)
    optimization.run()
