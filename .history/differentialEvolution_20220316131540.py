...
def run_optimizer():
    ...
    bds = [
        ...
        # roe deer parameters
        (0.16,0.19),(0.93,0.95),(0.91,0.92),(0.91,0.92),(0.11,0.13),(0.08,0.1),
        # fallow deer parameters
        (0.3,0.32),(0.92,0.93),(0.89,0.91),(0.89,0.91),(0.075,0.11),(0.06,0.08),
        # red deer parameters
        (0.35,0.37),(0.91,0.93),(0.89,0.91),(0.89,0.91),(0.075,0.11),(0.06,0.08),
        # exmoor pony parameters
        (0.88,0.91),(0.89,0.9),(0.88,0.9),(0.06,0.1),(0.05,0.075),
        # cattle parameters
        (0.185,0.19),(0.88,0.9),(0.88,0.9),(0.89,0.91),(0.06,0.1),(0.05,0.075),
        # pig parameters
        (0.25,0.32),(0.86,0.88),(0.9,0.94),(0.9,0.94),(0.06,0.11),(0.05,0.1)]
