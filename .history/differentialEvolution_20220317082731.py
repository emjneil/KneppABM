...
def run_optimizer():
    ...
    bds = [
        ...
        # roe deer parameters
        (0.16,0.19),(0.93,0.94),(0.93,0.94),(0.92,0.94),(0.13,0.2),(0.1,0.2),
        # fallow deer parameters
        (0.31,0.32),(0.92,0.93),(0.92,0.93),(0.92,0.93),(0.1,0.2),(0.09,0.2),
        # red deer parameters
        (0.34,0.354),(0.92,0.93),(0.91,0.93),(0.91,0.93),(0.1,0.13),(0.09,0.2),
        # exmoor pony parameters
        (0.91,0.92),(0.9,0.92),(0.9,0.92),(0.1,0.2),(0.085,0.2),
        # cattle parameters
        (0.18,0.2),(0.88,0.95),(0.89,0.95),(0.89,0.95),(0.1,0.2),(0.1,0.2),
        # pig parameters
