...
def run_optimizer():
    ...
    bds = [
        ...
        # roe deer parameters
        (0.18,0.19),(0.9,0.93),(0.9,0.95),(0.9,0.95),(0.1,0.17),(0.13,0.17),
        # fallow deer parameters
        (0.3,0.35),(0.88,0.91),(0.85,0.93),(0.85,0.93),(0.075,0.15),(0.1,0.15),
        # red deer parameters
        (0.39,0.41),(0.88,0.91),(0.87,0.93),(0.87,0.93),(0.075,0.15),(0.1,0.15),
        # exmoor pony parameters
        (0.87,0.88),(0.87,0.92),(0.87,0.92),(0.075,0.14),(0.1,0.14),
        # cattle parameters
        (0.17,0.19),(0.86,0.9),(0.87,0.92),(0.87,0.92),(0.075,0.14),(0.1,0.14),
        # pig parameters
