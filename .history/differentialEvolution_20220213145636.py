...
def run_optimizer():
    ...
    bds = [
        ...
        (0.01,0.015),(0.035,0.042),(0.075,0.078),(0.0027,0.0035),(0.015,0.03),
        (0.015,0.025), # mature scrub competition
        (0.085,0.087),(0.085,0.087), # grass
        (0.03,0.07),(0.01,0.07), # saplings
        (0.03,0.07),(0.03,0.07), # young scrub  

        # roe deer parameters
        (0.18,0.22),(0.75,0.8),(0.8,0.85),(0.8,0.85),(0.1,0.18),(0.1,0.18),
