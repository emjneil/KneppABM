...
def run_all_models():
    ...
    final_results["passed filters"] = 0
    ...
    final_results["passed filters"] = final_results.apply(lambda x: x += 1 if final_results['run_number'].isin(accepted_preReintro['run_number'] else x['A'], axis=1)

    if final_results['run_number'].isin(accepted_preReintro['run_number']):
        final_results["passed filters"].all +=1 
    ...
    # keep track of how many filters are passed
    # if final_results['run_number'].isin(accepted_April2015['run_number']):
    #     final_results["passed filters"] +=1
    # May 2015
    ...
    # if final_results['run_number'].isin(accepted_May2015['run_number']):
    #     final_results["passed filters"] +=1
    ...
    # if final_results['run_number'].isin(filtered_May2015['run_number']):
    #     final_results["passed filters"] +=1
