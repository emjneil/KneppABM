...
print(len(grouping_variable), len(y_values), len(species_list), len(indices))
...
plt.tight_layout()
plt.savefig('/Users/emilyneil/Desktop/KneppABM/many_outputs2/optimizerFails_extended.png')
plt.show()
