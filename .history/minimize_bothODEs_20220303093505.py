...
def run_optimizer():
    ...
    bds = [
        ...
        (0.01,0.012),(0.039,0.043),(0.084,0.085),(0.0027,0.0028),(0.014,0.015),
        (0.0075,0.01), # mature scrub competition
        (0.17,0.175),(0.17,0.175), # grass
        (0.05,0.06),(0.03,0.05), # saplings
        (0.04,0.05),(0.05,0.06), # young scrub  
        # roe deer parameters
        (0.18,0.2),(0.85,0.95),(0.85,0.95),(0.85,0.95),(0.075,0.2),(0.075,0.2),
        # fallow deer parameters
        (0.33,0.5),(0.89,0.95),(0.85,0.95),(0.85,0.95),(0.075,0.2),(0.075,0.2),
        # red deer parameters
        (0.38,0.4),(0.85,0.95),(0.85,0.95),(0.85,0.95),(0.075,0.2),(0.075,0.2),
        # exmoor pony parameters
        (0.85,0.95),(0.86,0.95),(0.86,0.95),(0.075,0.2),(0.075,0.2),
        # cattle parameters
        (0.18,0.21),(0.85,0.95),(0.86,0.95),(0.86,0.95),(0.075,0.15),(0.075,0.2),
        # pig parameters
        (0.25,0.32),(0.8,0.86),(0.85,0.92),(0.85,0.92),(0.075,0.2),(0.075,0.2)]

    
    initial_guess = [
        # habitats reproduction 
        0.01073041, 0.04140977, 0.08441684, 0.00271658, 0.01428562,
        0.00778636, 0.17455781, 0.17411044, 0.05211762, 0.04435455,
        0.04596607, 0.05477629, 0.18447707, 0.88989671, 0.88819196,
        0.88507775, 0.14035626, 0.11391544, 0.35522795, 0.92589854,
        0.88009856, 0.90820962, 0.13318456, 0.10488256, 0.3904458 ,
        0.90779618, 0.93728913, 0.86166375, 0.17250793, 0.08955753,
        0.90672876, 0.91844543, 0.91749455, 0.15351035, 0.16118049,
        0.20179323, 0.85920255, 0.88997082, 0.86233608, 0.10143215,
        0.16003729, 0.28063544, 0.82210645, 0.852313  , 0.86349537,
        0.15369704, 0.14603547]

    
    res = minimize(objectiveFunction, initial_guess, method='SLSQP', bounds=bds)
