...
def run_optimizer():
    ...
    bds = [
        ...
        (0.011,0.013),(0.038,0.042),(0.084,0.085),(0.0027,0.0028),(0.014,0.02),
        ...
        # roe deer parameters
        (0.18,0.2),(0.85,0.91),(0.88,0.93),(0.88,0.93),(0.1,0.15),(0.1,0.15),
        # fallow deer parameters
        (0.39,0.41),(0.85,0.95),(0.85,0.93),(0.85,0.93),(0.05,0.2),(0.05,0.2),
        # red deer parameters
        (0.38,0.41),(0.85,0.95),(0.85,0.93),(0.85,0.93),(0.075,0.2),(0.075,0.2),
        # exmoor pony parameters
        (0.8,0.95),(0.88,0.9),(0.82,0.9),(0.05,0.2),(0.05,0.2),
        # cattle parameters
        (0.17,0.21),(0.8,0.95),(0.88,0.9),(0.82,0.9),(0.05,0.15),(0.05,0.2),
        # pig parameters
        (0.25,0.32),(0.7,0.86),(0.8,0.92),(0.8,0.92),(0.05,0.2),(0.05,0.2)]

    
    initial_guess = [
        # habitats reproduction 
        0.01100047, 0.04142572, 0.08441381, 0.00271752, 0.01427433,
        0.00800094, 0.17456271, 0.17410803, 0.0521456 , 0.02434931,
        0.04595896, 0.05480795, 0.18457477, 0.8901307 , 0.91086272,
        0.88540693, 0.14043467, 0.11396921, 0.39001701, 0.92575528,
        0.88057185, 0.90815572, 0.13326155, 0.1049432 , 0.39037853,
        0.90821656, 0.93      , 0.85648308, 0.17260765, 0.08955241,
        0.90634856, 0.9       , 0.9       , 0.15349152, 0.16113817,
        0.20188096, 0.85967084, 0.89044484, 0.86284353, 0.10149078,
        0.16012376, 0.28079767, 0.82198437, 0.85279715, 0.86404163,
        0.15363298, 0.14611988]
