...
def run_optimizer():
    ...
    bds = [
        ...
        (0.084,0.085),(0.028,0.03), # saplings
        (0.084,0.085),(0.084,0.085), # young scrub  
        # roe deer parameters
        (0.19,0.20),(0.92,0.94),(0.92,0.94),(0.92,0.94),(0.09,0.1),(0.08,0.09),
        # fallow deer parameters
        (0.305,0.32),(0.9,0.91),(0.9,0.92),(0.9,0.92),(0.08,0.09),(0.075,0.08),
        # red deer parameters
        (0.33,0.38),(0.89,0.91),(0.89,0.92),(0.89,0.92),(0.075,0.09),(0.07,0.08),
        # exmoor pony parameters
        (0.88,0.9),(0.88,0.9),(0.88,0.9),(0.065,0.08),(0.06,0.075),
        # cattle parameters
        (0.18,0.21),(0.87,0.9),(0.87,0.9),(0.87,0.9),(0.06,0.08),(0.05,0.075),
        # pig parameters
        (0.15,0.22),(0.8,0.85),(0.92,0.94),(0.92,0.94),(0.075,0.1),(0.065,0.09)]
