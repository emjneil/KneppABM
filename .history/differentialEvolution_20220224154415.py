...
def run_optimizer():
    ...
    bds = [
        ...
        # roe deer parameters
        (0.18,0.19),(0.9,0.92),(0.9,0.91),(0.9,0.91),(0.075,0.17),(0.12,0.17),
        # fallow deer parameters
        (0.3,0.35),(0.88,0.91),(0.85,0.9),(0.85,0.9),(0.05,0.15),(0.1,0.15),
        # red deer parameters
        (0.39,0.41),(0.88,0.9),(0.87,0.9),(0.87,0.9),(0.05,0.15),(0.1,0.15),
        # exmoor pony parameters
        (0.87,0.88),(0.86,0.88),(0.86,0.88),(0.05,0.14),(0.1,0.14),
        # cattle parameters
        (0.17,0.19),(0.86,0.88),(0.85,0.87),(0.85,0.87),(0.05,0.14),(0.1,0.14),
        # pig parameters
        (0.25,0.35),(0.75,0.8),(0.9,0.91),(0.9,0.91),(0.05,0.16),(0.1,0.16)]
