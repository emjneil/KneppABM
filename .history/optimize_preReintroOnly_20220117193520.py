...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.03,0.04],[0.07,0.075],[0.1,0.12],[0.0015,0.003],[0.0085,0.02],
        # habitat competition
        [0.18,0.21], # mature scrub
        [0.2,0.22],[0.16,0.2], # grass
        [0.22,0.25],[0.04,0.075], # saplings
        [0.075,0.12],[0.21,0.23], # young scrub  
        # roe deer parameters
...
#  [0.0332531  0.07155709 0.11173526 0.0016912  0.00859447 0.02213277
#  0.21562342 0.17829962 0.153539   0.05997171 0.17267196 0.22820308
#  0.1601169  0.12175898 0.1362421  0.07341313 0.10423367 0.08319944]
