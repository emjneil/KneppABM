...
def run_optimizer():
    ...
    bds = [
        ...
        (0.012,0.02),(0.039,0.045),(0.084,0.085),(0.0026,0.0035),(0.015,0.025),
        (0.015,0.017), # mature scrub competition
        (0.17,0.18),(0.17,0.18), # grass
        (0.05,0.075),(0.025,0.05), # saplings
        (0.045,0.075),(0.05,0.075), # young scrub  

                (0.01,0.03),(0.035,0.065),(0.084,0.085),(0.0021,0.004),(0.0075,0.02),

        # roe deer parameters
        (0.18,0.2),(0.9,0.95),(0.9,0.95),(0.9,0.95),(0.13,0.15),(0.13,0.15),
        # fallow deer parameters
        (0.33,0.35),(0.89,0.93),(0.89,0.93),(0.89,0.93),(0.11,0.13),(0.11,0.13),
        # red deer parameters
        (0.34,0.37),(0.89,0.93),(0.89,0.93),(0.89,0.93),(0.11,0.13),(0.11,0.13),
        # exmoor pony parameters
        (0.88,0.9),(0.88,0.92),(0.88,0.92),(0.1,0.12),(0.1,0.12),
        # cattle parameters
        (0.18,0.21),(0.87,0.92),(0.87,0.92),(0.87,0.92),(0.1,0.12),(0.1,0.12),
        # pig parameters
        (0.25,0.3),(0.75,0.8),(0.9,0.95),(0.9,0.95),(0.1,0.15),(0.1,0.15)]

    initial_guess = [
        # habitats reproduction 
        0.01904011, 0.05846216, 0.08409305, 0.00211964, 0.01124551,
        0.00883846, 0.17400906, 0.17023544, 0.05413571, 0.02130572,
        0.05925703, 0.0695302 , 0.19545241, 0.87421173, 0.92982725,
        0.93318904, 0.13771653, 0.12133547, 0.37196559, 0.91478307,
        0.88575883, 0.86671821, 0.05113365, 0.08469595, 0.39782506,
        0.87500282, 0.89314289, 0.89622813, 0.09612833, 0.0552479 ,
        0.91972799, 0.86939715, 0.88275425, 0.06378193, 0.06650231,
        0.19655936, 0.89484363, 0.86961076, 0.8991352 , 0.084711  ,
        0.119615  , 0.29298422, 0.85842802, 0.91881744, 0.85694671,
        0.11616783, 0.08690592]

    
    res = minimize(objectiveFunction, initial_guess, method='Nelder-Mead', bounds=bds, options={'maxiter': 150})
