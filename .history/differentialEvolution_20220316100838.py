...
def run_optimizer():
    ...
    bds = [
        ...
        (0.0019,0.0021),(0.0025,0.0027),(0.0135,0.014),(0.0021,0.0022),(0.0063,0.0065),
        (0.003,0.0032), # mature scrub competition
        (0.094,0.095),(0.093,0.094), # grass
        (0.0071,0.0075),(0.0015,0.0025), # saplings
        (0.0065,0.007),(0.0065,0.0075), # young scrub  
        # roe deer parameters
        (0.16,0.19),(0.92,0.94),(0.91,0.92),(0.91,0.92),(0.09,0.11),(0.075,0.11),
        # fallow deer parameters
        (0.3,0.32),(0.91,0.93),(0.89,0.91),(0.89,0.91),(0.05,0.1),(0.05,0.075),
        # red deer parameters
        (0.35,0.37),(0.91,0.93),(0.89,0.91),(0.89,0.91),(0.05,0.1),(0.05,0.075),
        # exmoor pony parameters
        (0.88,0.91),(0.89,0.9),(0.88,0.9),(0.025,0.1),(0.025,0.075),
        # cattle parameters
        (0.185,0.19),(0.88,0.9),(0.88,0.9),(0.89,0.91),(0.025,0.1),(0.025,0.075),
        # pig parameters
        (0.25,0.32),(0.86,0.88),(0.9,0.94),(0.9,0.94),(0.025,0.1),(0.025,0.075)]
