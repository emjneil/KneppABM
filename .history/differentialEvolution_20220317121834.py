...
def run_optimizer():
    ...
    bds = [
        ...
        (0.31,0.32),(0.85,0.95),(0.85,0.95),(0.82,0.95),(0.1,0.2),(0.1,0.2),
        # red deer parameters
        (0.34,0.354),(0.75,0.95),(0.75,0.95),(0.75,0.95),(0.1,0.2),(0.1,0.2),
        # exmoor pony parameters
        (0.75,0.95),(0.75,0.95),(0.75,0.95),(0.1,0.2),(0.1,0.2),
        # cattle parameters
        (0.18,0.21),(0.75,0.95),(0.75,0.95),(0.75,0.95),(0.1,0.2),(0.1,0.2),
        # pig parameters
        (0.29,0.31),(0.75,0.95),(0.75,0.95),(0.75,0.95),(0.12,0.2),(0.12,0.2)]
