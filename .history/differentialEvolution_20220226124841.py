...
def run_optimizer():
    ...
    bds = [
        ...
        (0.011,0.013),(0.039,0.042),(0.083,0.085),(0.0026,0.0028),(0.014,0.016),
        ...
        # roe deer parameters
        (0.18,0.2),(0.93,0.94),(0.92,0.94),(0.92,0.94),(0.13,0.15),(0.13,0.15),
        # fallow deer parameters
        (0.35,0.41),(0.9,0.93),(0.9,0.93),(0.9,0.93),(0.12,0.14),(0.12,0.14),
        # red deer parameters
        (0.41,0.45),(0.89,0.93),(0.89,0.93),(0.89,0.93),(0.12,0.14),(0.12,0.14),
        # exmoor pony parameters
        (0.87,0.91),(0.88,0.92),(0.88,0.92),(0.11,0.13),(0.11,0.13),
        # cattle parameters
        (0.18,0.25),(0.88,0.91),(0.88,0.92),(0.88,0.92),(0.1,0.13),(0.1,0.13),
        # pig parameters
        (0.15,0.3),(0.75,0.85),(0.93,0.94),(0.93,0.94),(0.11,0.15),(0.11,0.15)]
