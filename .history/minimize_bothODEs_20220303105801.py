...
def run_optimizer():
    ...
    bds = [
        ...
        (0.01,0.014),(0.039,0.043),(0.084,0.085),(0.0027,0.0028),(0.014,0.015),
        (0.0075,0.015), # mature scrub competition
        ...
        # red deer parameters
        (0.37,0.41),(0.85,0.95),(0.85,0.95),(0.85,0.95),(0.075,0.2),(0.075,0.2),
        # exmoor pony parameters
        (0.85,0.95),(0.8,0.95),(0.8,0.95),(0.075,0.2),(0.075,0.2),
        # cattle parameters
        (0.17,0.21),(0.85,0.95),(0.8,0.95),(0.8,0.95),(0.075,0.15),(0.075,0.2),
        # pig parameters
        (0.25,0.32),(0.8,0.86),(0.8,0.92),(0.8,0.92),(0.075,0.2),(0.075,0.2)]
    ...
    initial_guess = [
        ...
        0.04596607, 0.05477629, 
        # roe, fallow, red deer
        0.18447707, 0.88989671, 0.88819196,
    ...
    res = minimize(objectiveFunction, initial_guess, method='Nelder-Mead', bounds=bds, options={'maxiter': 100, 'maxfev': 50})
