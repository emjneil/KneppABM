...
def run_optimizer():
    ...
    bds = [
        ...
        (0.0025,0.003), # mature scrub competition
        (0.094,0.095),(0.093,0.094), # grass
        (0.005,0.0075),(0.001,0.0025), # saplings
        (0.0025,0.007),(0.005,0.0075), # young scrub  
        # roe deer parameters
        (0.16,0.19),(0.93,0.95),(0.91,0.92),(0.91,0.92),(0.09,0.11),(0.075,0.1),
        # fallow deer parameters
        (0.3,0.32),(0.92,0.93),(0.89,0.91),(0.89,0.91),(0.05,0.1),(0.05,0.085),
        # red deer parameters
