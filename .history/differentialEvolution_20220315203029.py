...
def run_optimizer():
    ...
    bds = [
        ...
        (0.003,0.005),(0.003,0.005),(0.0135,0.014),(0.0023,0.0024),(0.0086,0.0087),
        (0.0019,0.002), # mature scrub competition
        (0.094,0.095),(0.093,0.094), # grass
        (0.075,0.085),(0.015,0.02), # saplings
        (0.075,0.085),(0.075,0.085), # young scrub  
        # roe deer parameters
        (0.16,0.20),(0.93,0.94),(0.91,0.92),(0.91,0.92),(0.11,0.15),(0.08,0.12),
