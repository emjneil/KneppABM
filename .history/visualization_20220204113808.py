...
import sys
sys.path.append('Users/emilyneil/Desktop/KneppABM/visualization')
import visualization.py, roeDeer_agent, habitatAgent, fallowDeer, redDeer, tamworthPigs, exmoorPony, longhornCattle
