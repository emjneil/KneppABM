...
def run_optimizer():
    ...
    (0.04,0.075),(0.01,0.05), # saplings
    (0.02,0.075),(0.04,0.075), # young scrub  
    # roe deer parameters
    (0.15,0.22),(0.8,1),(0.85,1),(0.85,1),(0,0.3),(0,0.3),
    # fallow deer parameters
    (0.3,0.5),(0.8,1),(0.8,0.95),(0.8,0.95),(0.01,0.3),(0.01,0.3),
    # red deer parameters
    (0.3,0.5),(0.8,1),(0.8,1),(0.8,1),(0.01,0.3),(0.01,0.3),
    # exmoor pony parameters
    (0.75,1),(0.75,1),(0.75,1),(0.01,0.25),(0.01,0.25),
    # cattle parameters
    (0.15,0.3),(0.75,1),(0.75,1),(0.75,1),(0.01,0.25),(0.01,0.25),
    # pig parameters
