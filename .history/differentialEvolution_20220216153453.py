...
def run_optimizer():
    ...
    bds = [
        ...
        (0.011,0.015),(0.035,0.048),(0.075,0.076),(0.0025,0.003),(0.01,0.016),
        (0.01,0.017), # mature scrub competition
        (0.17,0.2),(0.17,0.2), # grass
        (0.075,0.15),(0.05,0.15), # saplings
        (0.075,0.15),(0.075,0.15), # young scrub  

        # roe deer parameters
        (0.18,0.21),(0.8,0.85),(0.8,0.85),(0.8,0.85),(0.1,0.15),(0.1,0.15),
        # fallow deer parameters
        (0.33,0.42),(0.7,0.85),(0.75,0.8),(0.75,0.8),(0.075,0.15),(0.075,0.15),
        # red deer parameters
