...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.01,0.1],[0.1,0.15],[0.1,0.3],[0.0015,0.006],[0.004,0.08],
        # habitat competition
        [0,0.025], # mature scrub
        [0.01,0.1],[0.01,0.1], # grass
        [0.01,0.025],[0.01,0.025], # saplings
        [0.01,0.1],[0.01,0.1], # young scrub  
        # roe deer parameters
        [0.2,0.25],[0.1,0.2],[0.075,0.15],[0.075,0.15],[0.01,0.15],[0.01,0.15]
    ])
...
#  The best solution found:
#  [0.0190296  0.11962779 0.2655182  0.00155422 0.00535166 0.01066207
#  0.03942384 0.01618139 0.02585713 0.0238677  0.07401161 0.09436752
#  0.16795604 0.11529024 0.17973068 0.08616223 0.133828   0.12129398]
