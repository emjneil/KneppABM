...
def objectiveFunction(x):
    ...
    if ((list(results.loc[results['Time'] == 1, 'Saplings'])[0])-23) > max_start_saplings and ((list(results.loc[results['Time'] == 1, 'Young Scrub'])[0])-23) > max_start_youngScrub:
        filtered_result = (
