...
def run_all_models(run_number):
    output_parameters = graph_results(run_number)
    ...
    with pd.option_context('display.max_rows',None, 'display.max_columns',None):
        print('run_number' + str(run_number) + "accepted_years: \n", all_accepted_runs)

    plt.savefig('run_number' + str(run_number) + 'rejected_accepted_runs.png')
