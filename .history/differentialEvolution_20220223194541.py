...
def run_optimizer():
    ...
    bds = [
        ...
        (0.01,0.012),(0.032,0.045),(0.075,0.076),(0.0025,0.003),(0.018,0.025),
        ...
        # fallow deer parameters
        (0.25,0.35),(0.87,0.9),(0.85,0.9),(0.85,0.9),(0.13,0.15),(0.13,0.15),
        # red deer parameters
        (0.38,0.41),(0.86,0.9),(0.87,0.9),(0.87,0.9),(0.13,0.15),(0.13,0.15),
        # exmoor pony parameters
        (0.83,0.88),(0.85,0.9),(0.83,0.9),(0.13,0.15),(0.13,0.15),
        # cattle parameters
        (0.17,0.21),(0.85,0.88),(0.83,0.85),(0.83,0.85),(0.12,0.15),(0.12,0.15),
        # pig parameters
