...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0,0.5],[0.45,0.75],[0.65,1],[0.65,1],[0.08,0.25],[0.08,0.25],
        # red deer parameters
        [0,0.5],[0.45,0.75],[0.55,1],[0.55,1],[0.075,0.25],[0.075,0.25],
        # exmoor pony parameters
        [0.25,0.75],[0.45,1],[0.45,1],[0.05,0.25],[0.05,0.25],
        # cattle parameters
        [0,0.5],[0.25,0.75],[0.35,1],[0.35,1],[0.05,0.25],[0.05,0.25],
        # # pig parameters
        [0,0.5],[0.05,0.7],[0.4,1],[0.4,1],[0.01,0.25],[0.01,0.25]
    ])
