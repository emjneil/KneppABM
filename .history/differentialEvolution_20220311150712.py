...
def run_optimizer():
    ...
    bds = [
        ...
        (0.0012,0.0013), # mature scrub competition
        (0.09,0.095),(0.09,0.095), # grass
        (0.075,0.08),(0.025,0.03), # saplings
        (0.075,0.08),(0.075,0.08), # young scrub  
        # roe deer parameters
        (0.17,0.22),(0.9,0.94),(0.92,0.94),(0.92,0.94),(0.09,0.095),(0.075,0.08),
