...
def graph_runs():
    ...
    accepted_parameters["ponies_gain_from_YoungScrub"].hist()
    plt.title("Histogram of ponies_gain_from_YoungScrub")
    plt.show()
    ...
    plt.show()
    plt.savefig('/Users/emilyneil/Desktop/KneppABM/many_outputs2/fifty_perc/hist_parameter6.png')
