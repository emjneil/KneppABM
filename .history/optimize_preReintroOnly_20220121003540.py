...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.076,0.079],[0.079,0.1],[0.1,0.13],[0.0015,0.006],[0.01,0.06],
        # habitat competition
        [0.010168,0.019], # mature scrub
        [0.65,0.7],[0.65,0.7], # grassZ
        [0.4,0.75],[0.25,0.5], # saplings
        [0.25,0.5],[0.4,0.75], # young scrub  
        # roe deer parameters
        [0.17,0.21],[0.1,0.25],[0.12,0.25],[0.12,0.25],[0.075,0.25],[0.075,0.25]
    ])
