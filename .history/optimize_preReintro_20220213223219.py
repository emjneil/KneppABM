...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.02,0.075],[0.05,0.075],[0.075,0.077],[0.0025,0.0035],[0.0085,0.03],
        [0.0075,0.015], # mature scrub competition
        [0.1,0.15],[0.1,0.15], # grass
        [0.075,0.15],[0.02,0.1], # saplings
        [0.05,0.1],[0.075,0.15], # young scrub  
        # roe deer parameters
        [0.18,0.21],[0.8,1],[0.8,1],[0.8,1],[0.05,0.2],[0.01,0.2]
    ])
