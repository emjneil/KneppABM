...
def run_optimizer():
    ...
    bds = np.array([
        ...
        # habitat repro & growth
        (0.01,0.012),(0.025,0.03),(0.073,0.074),(0.0025,0.003),(0.01,0.025),
        (0.01,0.015), # mature scrub competition
        (0.085,0.087),(0.085,0.087), # grass
        (0.05,0.09),(0.01,0.09), # saplings
        (0.05,0.09),(0.05,0.09), # young scrub  
        # roe deer parameters
        (0.15,0.22),(0.75,0.8),(0.8,0.85),(0.8,0.85),(0.18,0.2),(0.18,0.2),
        # fallow deer parameters
        (0.33,0.42),(0.7,0.75),(0.75,0.8),(0.75,0.8),(0.15,0.18),(0.15,0.18),
        # red deer parameters
        (0.33,0.42),(0.68,0.73),(0.75,0.8),(0.75,0.8),(0.14,0.18),(0.14,0.18),
        # exmoor pony parameters
        (0.63,0.71),(0.73,0.78),(0.73,0.78),(0.13,0.16),(0.13,0.16),
        # cattle parameters
        (0.18,0.25),(0.65,0.7),(0.72,0.76),(0.72,0.76),(0.11,0.15),(0.11,0.15),
        # # pig parameters
        (0.17,0.25),(0.5,0.65),(0.75,0.85),(0.75,0.85),(0.11,0.18),(0.11,0.18)]
