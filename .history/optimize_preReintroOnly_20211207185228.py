...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.01,0.075],[0.01,0.075],[0.01,0.025],[0.0025,0.005],[0.005,0.01],
        # habitat competition
        [0.01,0.05],[0.075,0.15],[0.075,0.15],[0.025,0.05],[0.0001,0.01],[0.001,0.025],[0.005,0.025],     
        # roe deer parameters
        [0.1,0.25],[0.1,0.75],[0.1,0.75],[0.1,0.75],[0.0025,0.01],[0.0025,0.01]
    ])
