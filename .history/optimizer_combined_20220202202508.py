...
def run_optimizer():
    ...
    bds = np.array([
        ...
        # roe deer parameters
        [0.17,0.25],[0.7,0.85],[0.75,0.85],[0.75,0.85],[0.17,0.2],[0.17,0.2],

        # fallow deer parameters
        [0.39,0.45],[0.65,0.75],[0.7,0.75],[0.7,0.75],[0.13,0.17],[0.13,0.17],
        # red deer parameters
        [0.28,0.4],[0.63,0.75],[0.65,0.75],[0.65,0.75],[0.12,0.17],[0.12,0.17],
        # exmoor pony parameters
        [0.6,0.7],[0.6,0.7],[0.6,0.7],[0.1,0.15],[0.1,0.15],
        # cattle parameters
        [0.2,0.25],[0.6,0.7],[0.5,0.65],[0.5,0.65],[0.075,0.15],[0.075,0.15],
        # # pig parameters
        [0.25,0.75],[0.1,0.5],[0.8,0.85],[0.8,0.85],[0.1,0.15],[0.1,0.15]
    ])

#  The best solution found:                                                                           
#  [0.01662313 0.03566534 0.0775139  0.0033247  0.0198269  0.01468016
#  0.08684722 0.0898739  0.03175626 0.03292135 0.04366891 0.04584093
#  0.18075902 0.71591103 0.71161443 0.7064674  0.19456935 0.18659891
#  0.41517234 0.65906882 0.62654363 0.76201089 0.17464777 0.15791646
#  0.30295016 0.58828249 0.70723523 0.67921338 0.1424507  0.11794736
#  0.66859162 0.63165129 0.59537704 0.0761464  0.07873886 0.22088956
#  0.69317019 0.65181548 0.41542948 0.11666986 0.13521907 0.51898619
#  0.24953479 0.65470614 0.77443782 0.19650065 0.1072202 ]
