...
class KneppModel(Model):
    ...
    def __init__(self,             
        ...
        for cell, condit, in zip(self.grid.coord_iter(), condition):
            ...
            elif my_condition == 'grassland' and self.RC1_noFood == True or self.RC2_noTreesScrub == True or self.RC3_noTrees == True or self.RC4_noScrub == False: # more than 50% grassland, no more than 10 mature trees/shrubs
                trees_here = 0
                saplings_here = 0
                scrub_here = 0
                youngscrub_here = 0
