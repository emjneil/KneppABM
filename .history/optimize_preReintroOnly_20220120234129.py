...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.05,0.08],[0.05,0.075],[0.15,0.156],[0.0015,0.0019],[0.01,0.08],
        # habitat competition
        [0.02,0.03], # mature scrub
        [0.65,0.7],[0.65,0.7], # grassZ
        [0.15,0.75],[0.15,0.4], # saplings
        [0,0.2],[0,0.75], # young scrub  
        # roe deer parameters
        [0.17,0.21],[0.1,0.15],[0.12,0.2],[0.12,0.2],[0.075,0.13],[0.075,0.13]
    ])
    # chance_saplingBecomingTree = 0.0042
    # chance_youngScrubMatures = 0.0075 [0.0015,0.006],[0.004,0.08],

#  The best solution found:                                                                           
#  [0.07760384 0.09119465 0.15405254 0.00160228 0.00593515 0.02057989
#  0.67930445 0.64688858 0.71336392 0.42490864 0.35821941 0.79106452
#  0.19328389 0.11090359 0.18178156 0.13603919 0.11969937 0.11322725]
