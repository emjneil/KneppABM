...
def graph_results():
 ...
 # stacked_competition = np.tile(["Outcompeted Saplings", "Outcompeted Young Scrub", "Outcompeted Grass-Scrub", "Outcompeted Young Scrub-Scrub", "Outcompeted Saplings-Scrub", "Eaten Grass", "Eaten Trees", "Eaten Mature Scrub", "Eaten Saplings", "Eaten Young Scrub"], 51) 
    ...
    {'Time': stacked_time, 'Ecosystem Element': stacked_eco_element, 'Abundance': stacked_habitats, 'Grown saplings': grown_saplings_tiled, 'Grown Young Scrub': grown_youngScrub_tiled, 'Grass Outcompeted by Tree': outcompeted_grass_tiled, 'Scrub Outcompeted by Tree': outcompeted_scrub, })
