...
def graph_results():
    ...
    grown_saplings_tiled = np.tile(["Grass", "Trees", "Mature Scrub", "Saplings", "Young Scrub", "Bare Areas"], 51)
    ...
    {'Time': stacked_time, 'Ecosystem Element': stacked_eco_element, 'Abundance': stacked_habitats, 'Grown saplings': grown_saplings})
