...
def run_optimizer():
    ...
    bds = [
        ...
        (0.01,0.013),(0.038,0.041),(0.084,0.085),(0.0027,0.0028),(0.014,0.016),
        ...
        # roe deer parameters
        (0.18,0.2),(0.9,0.91),(0.92,0.93),(0.92,0.93),(0.13,0.15),(0.1,0.15),
        # fallow deer parameters
        (0.33,0.35),(0.85,0.91),(0.85,0.92),(0.85,0.92),(0.1,0.14),(0.09,0.14),
        # red deer parameters
        (0.37,0.38),(0.85,0.95),(0.85,0.92),(0.85,0.92),(0.1,0.14),(0.09,0.14),
        # exmoor pony parameters
        (0.8,0.95),(0.88,0.9),(0.82,0.9),(0.1,0.14),(0.08,0.14),
        # cattle parameters
        (0.18,0.22),(0.85,0.9),(0.88,0.9),(0.83,0.88),(0.1,0.13),(0.08,0.13),
        # pig parameters
