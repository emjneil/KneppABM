...
def graph_runs():
    ...
    plt.show()
    plt.savefig('/Users/emilyneil/Desktop/KneppABM/many_outputs2/one_perc/hist_parameter1.png')

    accepted_parameters["chance_scrubOutcompetedByTree"].hist()
    plt.title("Histogram of chance_scrubOutcompetedByTree")
    plt.show()
    plt.savefig('/Users/emilyneil/Desktop/KneppABM/many_outputs2/one_perc/hist_parameter2.png')

    accepted_parameters["chance_youngScrubMatures"].hist()
    plt.title("Histogram of chance_youngScrubMatures")
    plt.show()
    plt.savefig('/Users/emilyneil/Desktop/KneppABM/many_outputs2/one_perc/hist_parameter3.png')

    accepted_parameters["ponies_gain_from_YoungScrub"].hist()
    plt.title("Histogram of ponies_gain_from_YoungScrub")
    plt.show()
    plt.savefig('/Users/emilyneil/Desktop/KneppABM/many_outputs2/one_perc/hist_parameter4.png')

    accepted_parameters["chance_saplingOutcompetedByScrub"].hist()
    plt.title("Histogram of [chance_saplingOutcompetedByScrub")
    plt.show()
    plt.savefig('/Users/emilyneil/Desktop/KneppABM/many_outputs2/one_perc/hist_parameter5.png')

    accepted_parameters["ponies_gain_from_Saplings"].hist()
    plt.title("Histogram of ponies_gain_from_Saplings")
    plt.show()
    plt.savefig('/Users/emilyneil/Desktop/KneppABM/many_outputs2/one_perc/hist_parameter6.png')
    ...
    final_df.to_csv("/Users/emilyneil/Desktop/KneppABM/many_outputs2/one_perc/combined_df.csv")
    ...
    plt.savefig('/Users/emilyneil/Desktop/KneppABM/many_outputs2/one_perc/counterfactual.png')
    plt.show()
    ...
    plt.savefig('/Users/emilyneil/Desktop/KneppABM/many_outputs2/one_perc/rejected_accepted_runs.png')
    plt.show()
