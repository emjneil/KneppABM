...
def run_optimizer():
    ...
    bds = [
        ...
        (0.0022,0.0035),(0.0022,0.0035),(0.0135,0.014),(0.0021,0.0022),(0.0067,0.007),
        (0.0025,0.0027), # mature scrub competition
        (0.094,0.095),(0.093,0.094), # grass
        (0.005,0.0075),(0.0015,0.005), # saplings
        (0.005,0.0075),(0.005,0.0075), # young scrub  
        # roe deer parameters
        (0.16,0.19),(0.93,0.95),(0.91,0.95),(0.91,0.95),(0.1,0.15),(0.09,0.13),
        # fallow deer parameters
        (0.31,0.32),(0.89,0.93),(0.89,0.93),(0.89,0.93),(0.075,0.14),(0.075,0.12),
        # red deer parameters
        (0.35,0.36),(0.89,0.93),(0.89,0.93),(0.89,0.93),(0.075,0.14),(0.075,0.12),
        # exmoor pony parameters
        (0.88,0.92),(0.88,0.92),(0.88,0.92),(0.05,0.13),(0.05,0.11),
        # cattle parameters
        (0.18,0.2),(0.88,0.92),(0.88,0.92),(0.88,0.92),(0.05,0.13),(0.05,0.11),
        # pig parameters
        (0.29,0.31),(0.86,0.88),(0.9,0.95),(0.9,0.95),(0.075,0.15),(0.05,0.13)]
