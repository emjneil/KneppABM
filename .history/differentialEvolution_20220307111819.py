...
def run_optimizer():
    ...
    bds = [
        ...
        (0.33,0.5),(0.89,0.95),(0.85,0.95),(0.85,0.95),(0.075,0.14),(0.075,0.14),
        # red deer parameters
        (0.38,0.4),(0.85,0.95),(0.85,0.95),(0.85,0.95),(0.075,0.14),(0.075,0.14),
        # exmoor pony parameters
        (0.85,0.95),(0.86,0.95),(0.86,0.95),(0.05,0.2),(0.05,0.13),
        # cattle parameters
        (0.18,0.21),(0.85,0.95),(0.86,0.95),(0.86,0.95),(0.05,0.13),(0.05,0.13),
        # pig parameters
