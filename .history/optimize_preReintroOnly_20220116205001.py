...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.05,0.055],[0.08,0.09],[0.1,0.12],[0.0015,0.0018],[0.005,0.006],
        # habitat competition
        [0.02,0.025], # mature scrub
        [0.1,0.15],[0.09,0.15], # grass
        [0.13,0.18],[0.065,0.09], # saplings
        [0.07,0.1],[0.075,0.2], # young scrub  
        # roe deer parameters
        [0.15,0.22],[0.1,0.2],[0.075,0.25],[0.075,0.25],[0.075,0.2],[0.075,0.2]
    ])
