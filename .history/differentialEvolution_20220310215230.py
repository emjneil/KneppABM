...
def run_optimizer():
    ...
    bds = [
        ...
        (0.3,0.31),(0.9,0.93),(0.85,0.93),(0.85,0.93),(0.1,0.12),(0.09,0.11),
        # red deer parameters
        (0.35,0.41),(0.9,0.93),(0.85,0.93),(0.85,0.93),(0.1,0.12),(0.09,0.11),
        # exmoor pony parameters
        (0.9,0.92),(0.88,0.92),(0.87,0.92),(0.09,0.12),(0.08,0.1),
        # cattle parameters
        (0.19,0.2),(0.89,0.91),(0.88,0.92),(0.87,0.92),(0.09,0.1),(0.07,0.1),
        # pig parameters
