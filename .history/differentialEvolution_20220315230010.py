...
def run_optimizer():
    ...
    bds = [
        ...
        (0.00135,0.00145), # mature scrub competition
        (0.094,0.095),(0.093,0.094), # grass
        (0.081,0.082),(0.016,0.017), # saplings
        (0.077,0.078),(0.078,0.079), # young scrub  
        # roe deer parameters
        (0.17,0.20),(0.93,0.95),(0.91,0.94),(0.91,0.94),(0.11,0.14),(0.09,0.13),
        # fallow deer parameters
        (0.315,0.32),(0.92,0.93),(0.89,0.91),(0.89,0.91),(0.09,0.13),(0.08,0.12),
        # red deer parameters
        (0.36,0.37),(0.92,0.93),(0.89,0.91),(0.89,0.91),(0.09,0.13),(0.07,0.11),
        # exmoor pony parameters
        (0.9,0.91),(0.89,0.9),(0.88,0.9),(0.08,0.12),(0.05,0.09),
        # cattle parameters
        (0.185,0.19),(0.88,0.9),(0.88,0.9),(0.89,0.91),(0.08,0.12),(0.05,0.09),
        # pig parameters
        (0.23,0.27),(0.86,0.88),(0.9,0.94),(0.9,0.94),(0.09,0.14),(0.06,0.13)]
