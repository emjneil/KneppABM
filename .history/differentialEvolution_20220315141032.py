...
def run_optimizer():
    ...
    bds = [
        ...
        (0.0011,0.0013), # mature scrub competition
        (0.094,0.095),(0.093,0.094), # grass
        (0.075,0.09),(0.015,0.02), # saplings
        (0.075,0.09),(0.075,0.09), # young scrub  
        # roe deer parameters
        (0.16,0.20),(0.92,0.94),(0.91,0.92),(0.91,0.92),(0.1,0.135),(0.09,0.12),
        # fallow deer parameters
        (0.3,0.32),(0.9,0.93),(0.89,0.91),(0.89,0.91),(0.09,0.12),(0.085,0.095),
        # red deer parameters
        (0.36,0.37),(0.9,0.93),(0.89,0.91),(0.89,0.91),(0.09,0.12),(0.085,0.095),
        # exmoor pony parameters
        (0.88,0.91),(0.88,0.9),(0.88,0.9),(0.075,0.11),(0.075,0.085),
        # cattle parameters
