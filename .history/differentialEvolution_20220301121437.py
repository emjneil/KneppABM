...
def run_optimizer():
    ...
    bds = [
        ...
        (0.01,0.012),(0.041,0.042),(0.084,0.085),(0.0027,0.0028),(0.014,0.0145),
        (0.016,0.017), # mature scrub competition
        (0.17,0.175),(0.17,0.175), # grass
        (0.05,0.06),(0.04,0.06), # saplings
        (0.04,0.06),(0.05,0.06), # young scrub  
        # roe deer parameters
        (0.18,0.2),(0.94,0.95),(0.92,0.93),(0.92,0.93),(0.14,0.15),(0.14,0.15),
        # fallow deer parameters
        (0.38,0.4),(0.9,0.94),(0.9,0.93),(0.9,0.93),(0.13,0.14),(0.13,0.14),
        # red deer parameters
        (0.38,0.405),(0.9,0.94),(0.9,0.93),(0.9,0.93),(0.13,0.14),(0.13,0.14),
        # exmoor pony parameters
        (0.9,0.93),(0.88,0.92),(0.88,0.92),(0.12,0.14),(0.12,0.14),
        # cattle parameters
        (0.19,0.22),(0.9,0.93),(0.88,0.92),(0.88,0.92),(0.12,0.14),(0.12,0.14),
        # pig parameters
        (0.3,0.45),(0.8,0.83),(0.93,0.94),(0.93,0.94),(0.13,0.15),(0.13,0.15)]
...
# Differential Evolution Outputs:      fun: 33.17123194468846
#  message: 'Maximum number of iterations has been exceeded.'
#     nfev: 282
#      nit: 1
#  success: False
#        x: array([0.01124799, 0.04173093, 0.08469335, 0.00277297, 0.01404013,
#        0.01629763, 0.17127696, 0.17831746, 0.05088203, 0.04417979,
#        0.04648707, 0.05279326, 0.19590987, 0.93143907, 0.93087208,
#        0.93260982, 0.14959832, 0.1980483 , 0.36788411, 0.92110529,
#        0.90868632, 0.91585989, 0.12594613, 0.13972965, 0.44989384,
#        0.91136879, 0.89229776, 0.90069522, 0.12212596, 0.14233227,
#        0.88451993, 0.9070696 , 0.91819542, 0.12569979, 0.12114955,
#        0.21529601, 0.90061774, 0.90945302, 0.91478137, 0.12894464,
#        0.12267849, 0.27980367, 0.82487891, 0.93834427, 0.93116254,
#        0.13296783, 0.13625295])
...
def graph_results():
    ...
    max_start_youngScrub = 0.1
        ...
        # define the parameters
    chance_reproduceSapling = 0.01124799
    chance_reproduceYoungScrub = 0.04173093
    chance_regrowGrass = 0.08469335
    chance_saplingBecomingTree = 0.00277297
    chance_youngScrubMatures = 0.01404013
    chance_scrubOutcompetedByTree = 0.01629763
    chance_grassOutcompetedByTree = 0.17127696
    chance_grassOutcompetedByScrub = 0.17831746
    chance_saplingOutcompetedByTree = 0.05088203
    chance_saplingOutcompetedByScrub = 0.04417979
    chance_youngScrubOutcompetedByScrub = 0.04248707
    chance_youngScrubOutcompetedByTree = 0.05079326
    ...
    # roe deer
    roeDeer_reproduce = 0.19590987
    roeDeer_gain_from_grass = 0.93143907
    roeDeer_gain_from_Trees = 0.93087208
    roeDeer_gain_from_Scrub = 0.93260982
    roeDeer_gain_from_Saplings = 0.14959832
    roeDeer_gain_from_YoungScrub = 0.1980483
    # Fallow deer
    fallowDeer_reproduce = 0.36788411
    fallowDeer_gain_from_grass = 0.92110529
    fallowDeer_gain_from_Trees = 0.90868632
    fallowDeer_gain_from_Scrub = 0.91585989
    fallowDeer_gain_from_Saplings = 0.12594613
    fallowDeer_gain_from_YoungScrub = 0.13972965
    # Red deer
    redDeer_reproduce = 0.44989384
    redDeer_gain_from_grass = 0.91136879
    redDeer_gain_from_Trees = 0.89229776
    redDeer_gain_from_Scrub = 0.90069522
    redDeer_gain_from_Saplings = 0.12212596
    redDeer_gain_from_YoungScrub = 0.13233227
    # Exmoor ponies
    ponies_gain_from_grass = 0.88451993
    ponies_gain_from_Trees = 0.9070696
    ponies_gain_from_Scrub = 0.91819542
    ponies_gain_from_Saplings = 0.12569979
    ponies_gain_from_YoungScrub = 0.12114955
    # Longhorn cattle
    cows_reproduce = 0.21529601
    cows_gain_from_grass = 0.90061774
    cows_gain_from_Trees = 0.90945302
    cows_gain_from_Scrub = 0.91478137
    cows_gain_from_Saplings = 0.12894464
    cows_gain_from_YoungScrub = 0.12267849
    # Tamworth pigs
    pigs_reproduce = 0.27980367
    pigs_gain_from_grass = 0.82487891
    pigs_gain_from_Trees = 0.93834427
    pigs_gain_from_Scrub = 0.93116254
    pigs_gain_from_Saplings = 0.13296783
    pigs_gain_from_YoungScrub = 0.13625295
