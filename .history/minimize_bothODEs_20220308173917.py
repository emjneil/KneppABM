...
def run_optimizer():
    ...
    bds = [
        ...
        (0.0155,0.0165),(0.055,0.056),(0.084,0.085),(0.0021,0.0022),(0.011,0.012),
        (0.0087,0.0089), # mature scrub competition
        (0.17,0.175),(0.17,0.175), # grass
        (0.065,0.07),(0.021,0.025), # saplings
        (0.065,0.07),(0.065,0.07), # young scrub  
        # roe deer parameters
        (0.18,0.2),(0.9,0.95),(0.85,0.95),(0.85,0.95),(0.13,0.14),(0.11,0.12),
        # fallow deer parameters
        (0.35,0.37),(0.9,0.93),(0.85,0.93),(0.85,0.93),(0.09,0.11),(0.07,0.11),
        # red deer parameters
        (0.39,0.4),(0.9,0.93),(0.85,0.93),(0.85,0.93),(0.09,0.12),(0.07,0.11),
        # exmoor pony parameters
        (0.9,0.92),(0.86,0.92),(0.86,0.92),(0.07,0.12),(0.07,0.11),
        # cattle parameters
        (0.18,0.2),(0.89,0.91),(0.86,0.92),(0.86,0.92),(0.07,0.1),(0.06,0.1),
        # pig parameters
        (0.25,0.28),(0.8,0.86),(0.87,0.92),(0.87,0.92),(0.07,0.12),(0.07,0.13)]

    initial_guess = [
        # habitats reproduction 
        0.01599409, 0.05597014, 0.08413071, 0.00212398, 0.0118672 ,
        0.00880211, 0.17035931, 0.17482826, 0.06540696, 0.02307298,
        0.06625143, 0.0685533 , 0.18322981, 0.91338894, 0.86943736,
        0.93492063, 0.13494042, 0.11027697, 0.37      , 0.92790979,
        0.87155163, 0.86735967, 0.10745148, 0.10071824, 0.39483409,
        0.9284888 , 0.92351267, 0.91629648, 0.11781382, 0.09443591,
        0.90082304, 0.87805802, 0.87619325, 0.0738413 , 0.09840121,
        0.19459544, 0.8976995 , 0.89244497, 0.87567292, 0.09951781,
        0.06804002, 0.26231426, 0.81549655, 0.87262092, 0.89324943,
        0.11725207, 0.08837545]

    
    res = minimize(objectiveFunction, initial_guess, method='Nelder-Mead', bounds=bds, options={'maxiter': 100})
    
    # save the results to a txt file
    with open('/Users/emilyneil/Desktop/KneppABM/outputs/post_reintro/minimization_outputs.txt', 'w') as f:
        print('MinimizationOutputs:', res, file=f)
    print(res)
    return res.x
...
def graph_results():
    ...
    plt.tight_layout()
    plt.savefig('/Users/emilyneil/Desktop/KneppABM/outputs/post_reintro/minimize_PostReintro_numbers.png')
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig('/Users/emilyneil/Desktop/KneppABM/outputs/post_reintro/minimize_PostReintro_conditions.png')
    plt.show()
    ...
    plt.savefig('/Users/emilyneil/Desktop/KneppABM/outputs/post_reintro/minimize_Eaten_Saplings_PostReintro.png')
    plt.show()
    ...
    plt.savefig('/Users/emilyneil/Desktop/KneppABM/outputs/post_reintro/minimize_Eaten_YoungScrub_PostReintro.png')
    plt.show()
    ...
    plt.savefig('/Users/emilyneil/Desktop/KneppABM/outputs/post_reintro/minimize_Eaten_Grass_PostReintro.png')
    plt.show()
    ...
    plt.savefig('/Users/emilyneil/Desktop/KneppABM/outputs/post_reintro/minimize_Eaten_Scrub_PostReintro.png')
    plt.show()
    ...
    plt.savefig('/Users/emilyneil/Desktop/KneppABM/outputs/post_reintro/minimize_Eaten_Trees_PostReintro.png')
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig('/Users/emilyneil/Desktop/KneppABM/outputs/post_reintro/minimize_RealityCheck_noHerbivores_preReintro_conditions.png')
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig('/Users/emilyneil/Desktop/KneppABM/outputs/post_reintro/minimize_RealityCheck_noHerbivores_preReintro.png')
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig('/Users/emilyneil/Desktop/KneppABM/outputs/post_reintro/minimize_RealityCheck_noReintro_long.png')
    plt.show()
