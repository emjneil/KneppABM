...
def run_optimizer():
    # Define the bounds
    bds = [
        (0.032,0.033),(0.073,0.075),(0.22,0.23),(0.0035,0.005),(0.0076,0.0083),
        (0.03,0.043), # mature scrub competition
        (0.15,0.2),(0.15,0.2), # grass
        (0.25,0.33),(0.25,0.33), # saplings
        (0.25,0.33),(0.25,0.33), # young scrub 
        # roe deer parameters
        (0.17,0.18),(0.85,0.86),(0.8,0.85),(0.75,0.85),(0.39,0.4),(0.19,0.22),
        # fallow deer parameters
        (0.28,0.29),(0.82,0.83),(0.74,0.76),(0.73,0.74),(0.35,0.37),(0.17,0.19),
        # red deer parameters
        (0.29,0.32),(0.79,0.82),(0.72,0.73),(0.67,0.72),(0.32,0.35),(0.14,0.17),
        # exmoor pony parameters
                    (0.72,0.73),(0.69,0.7),(0.63,0.64),(0.29,0.32),(0.12,0.15),
        # cattle parameters
        (0.18,0.21),(0.66,0.71),(0.61,0.68),(0.59,0.6),(0.25,0.29),(0.09,0.13),
        # pig parameters
        (0.3,0.5),(0.45,0.6),(0.7,0.85),(0.6,0.85),(0.29,0.4),(0.13,0.22)]
