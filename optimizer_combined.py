...
def run_optimizer():
    ...
    bds = np.array([
        ...
        [0.01,0.02],[0.025,0.04],[0.07,0.08],[0.002,0.004],[0.01,0.025],
        [0.01,0.025], # mature scrub competition
        [0.085,0.09],[0.085,0.09], # grass
        [0.03,0.05],[0.03,0.05], # saplings
        [0.03,0.05],[0.03,0.05], # young scrub  
        # roe deer parameters
        [0.18,0.22],[0.75,0.8],[0.8,0.83],[0.8,0.83],[0.15,0.2],[0.15,0.2],
        # fallow deer parameters
        [0.3,0.45],[0.7,0.75],[0.75,0.8],[0.75,0.8],[0.1,0.2],[0.1,0.2],
        # red deer parameters
        [0.3,0.45],[0.65,0.7],[0.75,0.8],[0.75,0.8],[0.1,0.2],[0.1,0.2],
        # exmoor pony parameters
        [0.6,0.7],[0.7,0.75],[0.7,0.75],[0.05,0.15],[0.05,0.15],
        # cattle parameters
        [0.15,0.3],[0.6,0.65],[0.6,0.7],[0.6,0.7],[0.05,0.15],[0.05,0.15],
        # # pig parameters
        [0.15,0.35],[0.5,0.6],[0.7,0.8],[0.7,0.8],[0.05,0.15],[0.05,0.15]
    ])

# The best solution found:
#  [0.01478067 0.03644526 0.0795359  0.00384821 0.0180218  0.01594256
#  0.08857883 0.08857427 0.03723684 0.03892212 0.0302559  0.03385835
#  0.1909517  0.76689369 0.78197733 0.79282971 0.15807516 0.15744597
#  0.36239368 0.7362447  0.78042701 0.78505611 0.16783473 0.18562109
#  0.42764312 0.69036557 0.78551399 0.78065999 0.10827526 0.13125142
#  0.67429932 0.723777   0.73371429 0.14889999 0.11113702 0.21569936
#  0.61220102 0.69759143 0.66784593 0.12721302 0.08403679 0.17061076
#  0.55992353 0.7973088  0.72791944 0.10553085 0.09772222]
...
#  8367.0
    ...
    optimization.run()
    with open('/Users/emilyneil/Desktop/KneppABM/outputs/post_reintro/optim_outputs_postReintro.txt', 'w') as f:
...
# y values - number of trees, scrub, etc. 
    ...
    plt.savefig('/Users/emilyneil/Desktop/KneppABM/outputs/post_reintro/Eaten_Saplings_PostReintro.png')
    plt.show()
    ...
    plt.savefig('/Users/emilyneil/Desktop/KneppABM/outputs/post_reintro/Eaten_YoungScrub_PostReintro.png')
    plt.show()
    ...
    plt.savefig('/Users/emilyneil/Desktop/KneppABM/outputs/post_reintro/Eaten_Scrub_PostReintro.png')
    plt.show()
    ...
    plt.savefig('/Users/emilyneil/Desktop/KneppABM/outputs/post_reintro/Eaten_Trees_PostReintro.png')
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig('/Users/emilyneil/Desktop/KneppABM/outputs/post_reintro/RealityCheck_noHerbivores_preReintro_conditions.png')
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig('/Users/emilyneil/Desktop/KneppABM/outputs/post_reintro/RealityCheck_noHerbivores_preReintro.png')
    plt.show()
